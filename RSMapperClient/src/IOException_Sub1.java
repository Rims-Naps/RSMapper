...
public class IOException_Sub1 extends IOException {
   ...
   static final boolean method131(boolean bool, byte b) {
      ...
      if (~i == -1) {
         ...
         return i < 128 || ~i <= -161 || Class204.aCharArray2455[-128 + i] != 0;
      }
   }
      ...
      if (i == 255) {
         if (!Class223.aString2660.startsWith("win")) {
            if (!Class223.aString2660.startsWith("linux")) {
               if (Class223.aString2660.startsWith("mac")) {
                  Class117_Sub1.aString4931 = Class117_Sub1.aString4931 + "macos/";
               }
            } else {
               Class117_Sub1.aString4931 = Class117_Sub1.aString4931 + "linux/";
            }
         } else {
            Class117_Sub1.aString4931 = Class117_Sub1.aString4931 + "windows/";
         }
         ...
         if (!Animable_Sub1_Sub1.aSignLink10616.aBoolean3985) {
            if (Class223.aString2656.startsWith("amd64") || Class223.aString2656.startsWith("x86_64")) {
               Class117_Sub1.aString4931 = Class117_Sub1.aString4931 + "x86_64/";
            } else if (Class223.aString2656.startsWith("i386")
               || Class223.aString2656.startsWith("i486")
               || Class223.aString2656.startsWith("i586")
               || Class223.aString2656.startsWith("x86")) {
               Class117_Sub1.aString4931 = Class117_Sub1.aString4931 + "x86/";
            } else if (Class223.aString2656.startsWith("ppc")) {
               Class117_Sub1.aString4931 = Class117_Sub1.aString4931 + "ppc/";
            } else {
               Class117_Sub1.aString4931 = Class117_Sub1.aString4931 + "universal/";
            }
         } else {
            Class117_Sub1.aString4931 = Class117_Sub1.aString4931 + "msjava/";
         }
      }
   }
}
