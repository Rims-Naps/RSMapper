public class Class105 implements Interface10 {
   ...
   public final void method26(int i) {
      ...
      ++anInt5195;
      Class357 class357 = Class129.method1553(-1, this.aClass98_5192.anInt5054, this.aClass302_5196);
      this.aClass52_5201 = Class93.aGraphicsToolkit1241.a(class357, Class383.method4199(this.aClass302_5200, this.aClass98_5192.anInt5054), true);
   }

   static final void method1116(int i, int i_0_, int i_1_, byte b, int i_2_, int i_3_, boolean voice) {
      System.out.println("method1116 (sound): " + i + " - " + i_0_ + " - " + i_1_ + " - " + i_2_ + " - " + i_3_);
      if ((voice ? Class213.aNode_Sub27_2512.aClass320_Sub25_7276.method3776(false) : Class213.aNode_Sub27_2512.aClass320_Sub25_7295.method3776(false)) != 0
         && i_0_ != 0
         && Class23.anInt434 < 50
         && ~i != 0) {
         Node_Sub38_Sub19.aClass78Array10284[Class23.anInt434++] = new Class78((byte)(voice ? 3 : 2), i, i_0_, i_2_, i_3_, 0, i_1_, null);
      }

      ++anInt5198;
   }

   static final WorldmapAreaDetail method1117(int i) {
      if (i < 104) {
         aGLSpriteArray5194 = null;
      }

      ++anInt5193;
      return WorldmapDefinitions.currentWorldmapArea;
   }
   ...
   public final void method27(boolean bool, int i) {
      ++anInt5197;
      if (bool) {
         int i_6_ = this.aClass98_5192.aClass379_5066.method4160(-108, Node_Sub38_Sub12.anInt10225, this.aClass98_5192.anInt5062)
            + this.aClass98_5192.anInt5065;
         int i_7_ = this.aClass98_5192.aClass77_5069.method775(Class257.anInt3244, false, this.aClass98_5192.anInt5055) + this.aClass98_5192.anInt5067;
         this.aClass52_5201
            .method535(
               0,
               null,
               this.aClass98_5192.anInt5064,
               this.aClass98_5192.aString5057,
               null,
               null,
               i_7_,
               this.aClass98_5192.anInt5059,
               83,
               0,
               this.aClass98_5192.anInt5056,
               i_6_,
               this.aClass98_5192.anInt5068,
               this.aClass98_5192.anInt5063,
               this.aClass98_5192.anInt5062,
               this.aClass98_5192.anInt5055
            );
      }
   }
   ...
   public final boolean method25(int i) {
      ...
      if (i != 421) {
         ...
         boolean bool = true;
         if (!this.aClass302_5200.method3510(this.aClass98_5192.anInt5054, (byte)63)) {
            bool = false;
         }

         if (!this.aClass302_5196.method3510(this.aClass98_5192.anInt5054, (byte)63)) {
            bool = false;
         }
   ...
   Class105(Index class302, Index class302_8_, Class98 class98) {
      this.aClass98_5192 = class98;
      this.aClass302_5196 = class302_8_;
      this.aClass302_5200 = class302;
   }
