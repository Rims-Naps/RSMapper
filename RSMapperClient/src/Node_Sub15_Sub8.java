public class Node_Sub15_Sub8 extends Node_Sub15 {
   ...
   final void method2556(ClanChat clanchat, int i) {
      ++anInt9830;
      clanchat.method496(this.anInt9831, i ^ i);
   }

   @Override
   final void method2554(int i, Buffer buffer) {
      this.anInt9831 = buffer.readUnsignedShort();
      ++anInt9829;
      if (i != 29147) {
      ...
      if (Class44.aGraphicsToolkit668 != null) {
         ...
         if (i_1_ >= 82) {
            ...
            if (~Class320_Sub20.anInt8397 == -1) {
               ...
               Node_Sub15_Sub9.anInterface6_9843 = Class44.aGraphicsToolkit668
                  .a(
                     Class44.aGraphicsToolkit668.a(CacheNode_Sub15.anInt9589, Class303.anInt3831),
                     Class44.aGraphicsToolkit668.d(CacheNode_Sub15.anInt9589, Class303.anInt3831)
                  );
            } else if (~Class320_Sub20.anInt8397 == -2
               && (Class352.anInterface6Array4332 == null || ~i_2_ != ~Class117.anInt1479 || ~i_3_ != ~Class290_Sub11.anInt8181)) {
               ...
               for(int i_4_ = 0; i_4_ < Class352.anInterface6Array4332.length; ++i_4_) {
                  Class352.anInterface6Array4332[i_4_] = Class44.aGraphicsToolkit668
                     .a(
                        Class44.aGraphicsToolkit668.a(StandardSprite.anInt8946, aa_Sub3.anInt5493),
                        Class44.aGraphicsToolkit668.d(StandardSprite.anInt8946, aa_Sub3.anInt5493)
                     );
               }
