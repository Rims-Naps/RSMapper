...
public class Class262_Sub10 extends Class262 {
   ...
   static final void method3173(boolean bool) {
      ...
      if (~i < ~Node_Sub25_Sub3.localNPCsCount) {
   ...
   Class262_Sub10(Buffer buffer) {
      super(buffer);
      this.anInt7772 = buffer.readUnsignedShort();
      this.anInt7771 = buffer.readUnsignedShort();
      this.anInt7770 = buffer.readUnsignedShort();
      this.anInt7768 = buffer.readUnsignedShort();
      this.anInt7769 = buffer.readUnsignedShort();
   }

   @Override
   final void method3148(int i) {
      Class188_Sub1_Sub1.method1895(this.anInt7772, false, 100, (byte)21, this.anInt7771, this.anInt7770, 100);
      if (i < -102) {
         ++anInt7767;
         Node_Sub38_Sub24.setCameraRotation(3, 0, this.anInt7769, this.anInt7768);
