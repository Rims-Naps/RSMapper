...
public class Class287 {
   ...
   final void method3396(byte b) {
      ++anInt3612;
      if (b != -74) {
         this.anIntArray3619 = null;
      }

      this.anInterface15_Impl2_3605.method38(false);
   }
   ...
   final void method3397(Class198 class198, int i, int i_0_, AbstractToolkit abstracttoolkit) {
      ...
      if (abstracttoolkit.aClass336_Sub1_6267 != null) {
         if (i < 0) {
            this.method3402((byte)-45, abstracttoolkit);
         } else {
            this.method3400(i, (byte)-107, abstracttoolkit);
         }
         ...
         try {
            int i_4_ = 0;
            int i_5_ = Integer.MAX_VALUE;
            int i_6_ = 0;
            EntityNode_Sub3 entitynode_sub3 = class198.aClass87_2429.anEntityNode_Sub3_1186;

            for(EntityNode_Sub3 entitynode_sub3_7_ = entitynode_sub3.anEntityNode_Sub3_5961;
               entitynode_sub3 != entitynode_sub3_7_;
               entitynode_sub3_7_ = entitynode_sub3_7_.anEntityNode_Sub3_5961
            ) {
               EntityNode_Sub3_Sub2 entitynode_sub3_sub2 = (EntityNode_Sub3_Sub2)entitynode_sub3_7_;
               int i_8_ = (int)(
                  f_1_ * (float)(entitynode_sub3_sub2.anInt9171 >> 12)
                     + f * (float)(entitynode_sub3_sub2.anInt9174 >> 12)
                     + f_2_ * (float)(entitynode_sub3_sub2.anInt9173 >> 12)
                     + f_3_
               );
               if (~i_8_ > ~i_5_) {
                  i_5_ = i_8_;
            ...
            for(boolean bool_13_ = true; entitynode_sub3_11_ != entitynode_sub3; this.method3403(i_9_, false, abstracttoolkit)) {
               this.anInt3614 = 0;

               for(int i_14_ = 0; i_14_ < i_9_; ++i_14_) {
                  this.anIntArray3619[i_14_] = 0;
               }

               for(int i_15_ = 0; i_15_ < 64; ++i_15_) {
                  this.anIntArray3616[i_15_] = 0;
               }
               ...
               for(; entitynode_sub3 != entitynode_sub3_11_; entitynode_sub3_11_ = entitynode_sub3_11_.anEntityNode_Sub3_5961) {
                  ...
                  int i_16_ = this.anIntArray3623[i_4_++] + -i_5_ >> i_10_;
                  if (i_16_ < 1600) {
                     if (this.anIntArray3619[i_16_] >= 64) {
                        if (this.anIntArray3619[i_16_] == 64) {
                           if (this.anInt3614 == 64) {
                              continue;
                           }

                           this.anIntArray3619[i_16_] += this.anInt3614++ + 1;
                        }

                        this.anEntityNode_Sub3_Sub2ArrayArray3615[-1 + this.anIntArray3619[i_16_] - 64][this.anIntArray3616[this.anIntArray3619[i_16_]
                           + -64
                           - 1]++] = entitynode_sub3_sub2;
                     } else {
                        this.anEntityNode_Sub3_Sub2ArrayArray3608[i_16_][this.anIntArray3619[i_16_]++] = entitynode_sub3_sub2;
                     }
                  }
               }

               abstracttoolkit.method1332(i_0_ ^ 3, false, i_12_ < 0 ? -1 : i_12_, false);
   ...
   final void method3399(AbstractToolkit abstracttoolkit, int i) {
      ++anInt3617;
      this.anInterface15_Impl2_3605.method37(24, 786336, -12093);
      if (i != -1) {
         this.method3397(null, -47, 119, null);
      }
   }
   ...
   static final void method3401(Node_Sub19 node_sub19, boolean bool, int i) {
      if (!node_sub19.aBoolean7156) {
         if (node_sub19.aBoolean7159
            && node_sub19.x >= 1
            && node_sub19.y >= 1
            && -2 + Node_Sub54.GAME_SCENE_WDITH >= node_sub19.x
            && ~(-2 + Class377_Sub1.GAME_SCENE_HEIGHT) <= ~node_sub19.y
            && (node_sub19.id > 0 || Class128.method1547(node_sub19.id, 1, node_sub19.type))) {
            if (bool) {
               Node_Sub38_Sub37.method2907(node_sub19.typeFlag, -14347, node_sub19.aClass121_7160, node_sub19.y, node_sub19.plane, node_sub19.x);
            } else {
               Class128.method1544(
                  node_sub19.y, node_sub19.type, node_sub19.rotation, node_sub19.x, -1, node_sub19.typeFlag, node_sub19.plane, -128, node_sub19.id
               );
            }

            node_sub19.aBoolean7159 = false;
            if (!bool && node_sub19.anInt7154 == node_sub19.id && ~node_sub19.anInt7154 == 0) {
               node_sub19.method2160((byte)79);
            } else if (!bool
               && node_sub19.anInt7154 == node_sub19.id
               && node_sub19.rotation == node_sub19.anInt7170
               && node_sub19.type == node_sub19.anInt7164) {
         ...
         if (bool) {
            Node_Sub38_Sub37.method2907(node_sub19.typeFlag, i ^ 14346, null, node_sub19.y, node_sub19.plane, node_sub19.x);
         } else {
            Class128.method1544(
               node_sub19.y, node_sub19.anInt7164, node_sub19.anInt7170, node_sub19.x, -1, node_sub19.typeFlag, node_sub19.plane, -39, node_sub19.anInt7154
            );
         }
   ...
   private final void method3402(byte b, AbstractToolkit abstracttoolkit) {
      ++anInt3611;
      if (b != -45) {
         this.method3400(-87, (byte)-86, null);
      }
   ...
   private final void method3403(int i, boolean bool, AbstractToolkit abstracttoolkit) {
      ...
      if (!bool) {
         ...
         jaclib.memory.Buffer buffer = this.anInterface15_Impl2_3605.method40(-87, true);
         if (buffer != null) {
            Stream stream = abstracttoolkit.method1324(!bool, buffer);
            if (Stream.b()) {
               for(int i_33_ = i - 1; ~i_33_ <= -1; --i_33_) {
                  int i_34_ = ~this.anIntArray3619[i_33_] < -65 ? 64 : this.anIntArray3619[i_33_];
                  if (~i_34_ < -1) {
                     for(int i_35_ = -1 + i_34_; i_35_ >= 0; --i_35_) {
                        EntityNode_Sub3_Sub2 entitynode_sub3_sub2 = this.anEntityNode_Sub3_Sub2ArrayArray3608[i_33_][i_35_];
                     ...
                     if (~this.anIntArray3619[i_33_] < -65) {
                        int i_44_ = -1 + this.anIntArray3619[i_33_] - 64;

                        for(int i_45_ = -1 + this.anIntArray3616[i_44_]; ~i_45_ <= -1; --i_45_) {
                           EntityNode_Sub3_Sub2 entitynode_sub3_sub2 = this.anEntityNode_Sub3_Sub2ArrayArray3615[i_44_][i_45_];
               ...
               for(int i_54_ = i + -1; i_54_ >= 0; --i_54_) {
                  int i_55_ = this.anIntArray3619[i_54_] > 64 ? 64 : this.anIntArray3619[i_54_];
                  if (~i_55_ < -1) {
                     for(int i_56_ = i_55_ - 1; i_56_ >= 0; --i_56_) {
                        EntityNode_Sub3_Sub2 entitynode_sub3_sub2 = this.anEntityNode_Sub3_Sub2ArrayArray3608[i_54_][i_56_];
                     ...
                     if (~this.anIntArray3619[i_54_] < -65) {
                        int i_65_ = -65 + this.anIntArray3619[i_54_];

                        for(int i_66_ = this.anIntArray3616[i_65_] + -1; ~i_66_ <= -1; --i_66_) {
                           EntityNode_Sub3_Sub2 entitynode_sub3_sub2 = this.anEntityNode_Sub3_Sub2ArrayArray3615[i_65_][i_66_];
            ...
            stream.c();
            if (this.anInterface15_Impl2_3605.method39(124)) {
               abstracttoolkit.method1354(0, 32011, this.anInterface15_Impl2_3605);
               abstracttoolkit.method1354(1, 32011, this.anInterface15_Impl2_3618);
               abstracttoolkit.method1338(this.aClass213_3620, 9422);
               abstracttoolkit.method1276(0, (byte)-76, 0, this.anInterface15_Impl1_3622, 4 * i_18_, Class55.aClass104_833, 2 * i_18_);
            }
         }
      }
   }
   ...
   Class287(AbstractToolkit abstracttoolkit) {
      this.anEntityNode_Sub3_Sub2ArrayArray3615 = new EntityNode_Sub3_Sub2[64][768];
      this.anInt3614 = 0;
      this.anIntArray3619 = new int[1600];
      this.anIntArray3623 = new int[8191];
      this.aClass213_3620 = abstracttoolkit.method1372(
         (byte)-128,
         new Class207[]{
            new Class207(new Class126[]{Class126.aClass126_1620, Class126.aClass126_1626, Class126.aClass126_1628}), new Class207(Class126.aClass126_1625)
         }
      );
      this.anInterface15_Impl2_3605 = abstracttoolkit.method1380(2, true);
      this.anInterface15_Impl2_3618 = abstracttoolkit.method1380(2, false);
      this.anInterface15_Impl2_3618.method37(12, 393168, -12093);
      this.anInterface15_Impl1_3622 = abstracttoolkit.method1346(false, (byte)102);
      this.anInterface15_Impl1_3622.method56(-1696, 49146);
      jaclib.memory.Buffer buffer = this.anInterface15_Impl1_3622.method54(true, (byte)74);
      if (buffer != null) {
         ...
         stream.c();
         this.anInterface15_Impl1_3622.method53(-3308);
      }

      jaclib.memory.Buffer buffer_77_ = this.anInterface15_Impl2_3618.method40(112, true);
      if (buffer_77_ != null) {
         ...
         stream.c();
         this.anInterface15_Impl2_3618.method39(127);
      }
   }
}
