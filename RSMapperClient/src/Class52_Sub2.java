...
public class Class52_Sub2 extends Class52 {
   ...
   final void fa(char c, int i, int i_0_, int i_1_, boolean bool) {
      this.aGLToolkit5563.method1417(21447);
      this.aGLToolkit5563.method1444(-2, this.aClass169_Sub2_Sub1_5565);
      if (!this.aBoolean5564 && !bool) {
         this.aGLToolkit5563.method1474(127, 7681, 7681);
      } else {
         this.aGLToolkit5563.method1474(126, 8448, 7681);
         this.aGLToolkit5563.method1464(34168, 768, 0, (byte)-51);
      }

      OpenGL.glColor4ub((byte)(i_1_ >> 16), (byte)(i_1_ >> 8), (byte)i_1_, (byte)(i_1_ >> 24));
      OpenGL.glTranslatef((float)i, (float)i_0_, 0.0F);
      this.aClass25_5566.method310(c, (byte)-22);
      OpenGL.glLoadIdentity();
      if (this.aBoolean5564 || bool) {
         this.aGLToolkit5563.method1464(5890, 768, 0, (byte)-51);
      }
   }
   ...
   final void method526(char c, int i, int i_2_, int i_3_, boolean bool, aa var_aa, int i_4_, int i_5_) {
      ...
      if (!this.aBoolean5564 && !bool) {
         ...
         this.aGLToolkit5563.method1474(-122, 8448, 7681);
         this.aGLToolkit5563.method1464(34168, 768, 0, (byte)-51);
      }

      this.aGLToolkit5563.method1457(33984, 1);
      this.aGLToolkit5563.method1444(-2, class169_sub2_sub1);
      this.aGLToolkit5563.method1474(126, 8448, 7681);
      this.aGLToolkit5563.method1464(34168, 768, 0, (byte)-51);
      ...
      this.aClass25_5566.method310(c, (byte)-126);
      OpenGL.glLoadIdentity();
      OpenGL.glDisable(3168);
      OpenGL.glDisable(3169);
      this.aGLToolkit5563.method1464(5890, 768, 0, (byte)-51);
      this.aGLToolkit5563.method1474(-95, 8448, 8448);
      this.aGLToolkit5563.method1444(-2, null);
      this.aGLToolkit5563.method1457(33984, 0);
      if (this.aBoolean5564 || bool) {
         this.aGLToolkit5563.method1464(5890, 768, 0, (byte)-51);
      }
   }
   ...
   Class52_Sub2(GLToolkit gltoolkit, Class357 class357, Class383[] class383s, boolean bool) {
      ...
      if (bool) {
         ...
         this.aClass169_Sub2_Sub1_5565 = Class320_Sub21.method3761(i_8_, 6406, 8222, bs, 6406, gltoolkit, i_8_, false);
         this.aBoolean5564 = true;
      } else {
            ...
            if (bs != null) {
               for(int i_31_ = 0; i_31_ < i_25_; ++i_31_) {
                  for(int i_32_ = 0; i_32_ < i_26_; ++i_32_) {
                     is[i_29_++] = bs[i_30_] << 24 | is_23_[bs_24_[i_30_] & 255];
                     ++i_30_;
                  }
               ...
               for(int i_33_ = 0; i_33_ < i_25_; ++i_33_) {
                  for(int i_34_ = 0; i_34_ < i_26_; ++i_34_) {
                     ...
                     if ((i_35_ = bs_24_[i_30_++]) != 0) {
                        is[i_29_++] = 0xFF000000 | is_23_[i_35_ & 0xFF];
                     } else {
                        ++i_29_;
                     }
                  }
         ...
         this.aClass169_Sub2_Sub1_5565 = CacheNode_Sub5.method2308(gltoolkit, 25448, i_8_, false, 0, is, i_8_, 0);
         this.aBoolean5564 = false;
      }

      this.aClass169_Sub2_Sub1_5565.method1757(false, false);
      this.aClass25_5566 = new Class25(gltoolkit, 256);
      float f = this.aClass169_Sub2_Sub1_5565.aFloat10567 / (float)this.aClass169_Sub2_Sub1_5565.anInt10566;
      float f_36_ = this.aClass169_Sub2_Sub1_5565.aFloat10568 / (float)this.aClass169_Sub2_Sub1_5565.anInt10564;
      ...
      for(int i_37_ = 0; i_37_ < 256; ++i_37_) {
         ...
         this.aClass25_5566.method307(i_37_, 4864);
         OpenGL.glBegin(7);
         OpenGL.glTexCoord2f(f_44_, this.aClass169_Sub2_Sub1_5565.aFloat10568 - f_45_);
         OpenGL.glVertex2i(i_41_, i_40_);
         OpenGL.glTexCoord2f(f_44_, this.aClass169_Sub2_Sub1_5565.aFloat10568 - f_47_);
         OpenGL.glVertex2i(i_41_, i_40_ + i_38_);
         OpenGL.glTexCoord2f(f_46_, this.aClass169_Sub2_Sub1_5565.aFloat10568 - f_47_);
         OpenGL.glVertex2i(i_41_ + i_39_, i_40_ + i_38_);
         OpenGL.glTexCoord2f(f_46_, this.aClass169_Sub2_Sub1_5565.aFloat10568 - f_45_);
         OpenGL.glVertex2i(i_41_ + i_39_, i_40_);
         OpenGL.glEnd();
         this.aClass25_5566.method309(false);
      }
   }
}
