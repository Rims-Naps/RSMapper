...
public class InputStream_Sub2 extends InputStream {
   ...
   static final void method128(int i) {
      if (!Class93.aGraphicsToolkit1241.l()) {
         ...
         Class93.aGraphicsToolkit1241.b(Node_Sub38_Sub20.GAME_CANVAS);
         Class150_Sub1.method1657(true);
         if (Class71.aBoolean967) {
            Node_Sub54.method2982(-106, Node_Sub38_Sub20.GAME_CANVAS);
         } else {
            Dimension dimension = Node_Sub38_Sub20.GAME_CANVAS.getSize();
            Class93.aGraphicsToolkit1241.b(Node_Sub38_Sub20.GAME_CANVAS, dimension.width, dimension.height);
         }

         Class93.aGraphicsToolkit1241.a(Node_Sub38_Sub20.GAME_CANVAS);
      }
