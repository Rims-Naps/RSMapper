public class Class113 {
   ...
   static final void method1150(byte b) {
      ...
      Node_Sub38_Sub24.minimapEntityIndicatorSprites = null;
      ...
      Node_Sub53.minimapFlagSprites = null;
      DrawMiniMapSprites.aGLSpriteArray312 = null;
   ...
   static final void method1151(int i, int i_2_, int i_3_, byte b, int i_4_) {
      ...
      i_3_ -= (-i_6_ + i_4_) / 2;
      i_2_ -= (-i_5_ + i) / 2;
      Class94.anInt1250 = i_2_ * WorldmapDefinitions.totalXTiles / i_5_;
      Class327.anInt5360 = -(WorldmapDefinitions.totalYTiles * i_3_ / i_6_) + WorldmapDefinitions.totalYTiles;
