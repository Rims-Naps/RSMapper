abstract class Class262_Sub15 extends Class262 {
   ...
   static Animable[] animatedObjectsInScene;
   ...
   Class262_Sub15(Buffer buffer) {
      super(buffer);
      this.anInt7818 = buffer.readUnsignedShort();
      this.anInt7815 = buffer.readUnsignedShort();
      this.anInt7820 = buffer.readUnsignedByte();
   }
