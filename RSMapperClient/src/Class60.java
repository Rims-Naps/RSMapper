public class Class60 {
   static int anInt880 = -1;
   static int anInt881 = -1;
   static int[][] anIntArrayArray882 = new int[][]{
      {0, 2, 4, 6},
      {6, 0, 2, 4},
      {6, 0, 2},
      {2, 6, 0},
   ...
   static final void method594(int i, int i_0_) {
      ...
      if (~i_0_ != ~Node_Sub38_Sub23.anInt10346) {
            ...
            if (class383 == null) {
               ...
               Class240.aSignLink2946
                  .method3645(
                     ...
                     new java.awt.Point(class364.registerHoverPositionX, class364.registerHoverPositionY),
                     class383.method4190()
                  );
         ...
         if (i_0_ == -1 && Node_Sub38_Sub23.anInt10346 != -1) {
            Class240.aSignLink2946.method3645(-1, (byte)-18, null, Node_Sub38_Sub20.GAME_CANVAS, new java.awt.Point(), -1);
