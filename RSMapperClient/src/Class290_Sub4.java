...
public class Class290_Sub4 extends Class290 {
   static OutgoingPacket aClass318_8089 = new OutgoingPacket(82, 3);
   ...
   final void method3422(int i, boolean bool) {
      if (this.anInterface13_Impl2Array8096 != null && bool) {
         this.anAbstractToolkit3654.method1362(255, 1);
         this.anAbstractToolkit3654.method1321((byte)102, Class191.aClass139_2349);
         Class336_Sub1 class336_sub1 = this.anAbstractToolkit3654.method1306(7);
         class336_sub1.method3865(1024);
         this.anAbstractToolkit3654.method1297(-21029, Class55.aClass346_829);
         if (!this.aBoolean8090) {
            this.anAbstractToolkit3654.method1318(-30, Class116.aClass94_5075, Class117_Sub1.aClass94_4924);
            this.anAbstractToolkit3654.method1304(0, 0, Class200_Sub1.aClass135_5139);
            this.anAbstractToolkit3654.method1362(255, 2);
            this.anAbstractToolkit3654.method1318(-30, Class117_Sub1.aClass94_4924, UnderlayDefinition.aClass94_2898);
            this.anAbstractToolkit3654.method1304(0, 0, Class200_Sub1.aClass135_5139);
            this.anAbstractToolkit3654.method1349(Class200_Sub1.aClass135_5139, (byte)19, true, false, 1);
            this.anAbstractToolkit3654.method1366((byte)110, Class115.aClass135_1465, 0);
            ...
            this.anAbstractToolkit3654.method1366((byte)-96, Class115.aClass135_1465, 0);
         }

         this.anAbstractToolkit3654.method1362(255, 0);
         this.aBoolean8098 = true;
      } else {
         this.anAbstractToolkit3654.method1366((byte)-107, Class115.aClass135_1465, 0);
      }
   ...
   Class290_Sub4(AbstractToolkit abstracttoolkit) {
      ...
      if (abstracttoolkit.aBoolean6310) {
         this.aBoolean8090 = ~abstracttoolkit.anInt6370 > -4;
         int i = this.aBoolean8090 ? 48 : 127;
         ...
         this.anInterface13_Impl2Array8096 = new Interface13_Impl2[3];
         this.anInterface13_Impl2Array8096[0] = this.anAbstractToolkit3654.method1287(64, is_0_, false, 0);
         this.anInterface13_Impl2Array8096[1] = this.anAbstractToolkit3654.method1287(64, is_1_, false, 0);
         this.anInterface13_Impl2Array8096[2] = this.anAbstractToolkit3654.method1287(64, is, false, 0);
      }
   }
   ...
   static final Class145 method3431(GLToolkit gltoolkit, int i, Class210[] class210s) {
      ...
      if (~Class78.anIntArray1030[0] == -1) {
         int var10000 = Class78.anIntArray1030[0];
   ...
   final void method3415(boolean bool, int i, int i_17_) {
      ...
      if (this.aBoolean8098) {
         this.anAbstractToolkit3654.method1362(255, 1);
         this.anAbstractToolkit3654.method1312((byte)-21, this.anInterface13_Impl2Array8096[i - 1]);
         this.anAbstractToolkit3654.method1362(255, 0);
      }
   ...
   final void method3411(int i) {
      ...
      if (!this.aBoolean8098) {
         ...
         this.anAbstractToolkit3654.method1321((byte)102, Class308.aClass139_3915);
         this.anAbstractToolkit3654.method1255((byte)-12);
         if (!this.aBoolean8090) {
            ...
            this.anAbstractToolkit3654.method1362(i ^ -8485, 2);
            this.anAbstractToolkit3654.method1318(-30, Class116.aClass94_5075, Class116.aClass94_5075);
            this.anAbstractToolkit3654.method1304(0, 0, Class106.aClass135_1354);
            this.anAbstractToolkit3654.method1304(1, 0, Class200_Sub1.aClass135_5139);
            this.anAbstractToolkit3654.method1366((byte)-89, Class106.aClass135_1354, 0);
            this.anAbstractToolkit3654.method1312((byte)-21, null);
         } else {
            this.anAbstractToolkit3654.method1318(-30, Class116.aClass94_5075, Class116.aClass94_5075);
            this.anAbstractToolkit3654.method1304(0, i + 8668, Class106.aClass135_1354);
            this.anAbstractToolkit3654.method1366((byte)-122, Class106.aClass135_1354, 0);
         }

         this.anAbstractToolkit3654.method1362(255, 0);
         this.aBoolean8098 = false;
      }
