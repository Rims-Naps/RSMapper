public class Node_Sub38_Sub8_Sub1 extends Node_Sub38_Sub8 {
   ...
   final int[][] method2778(int i, boolean bool) {
      ...
      if (this.aClass348_7454.aBoolean4300 && this.method2814((byte)99)) {
         int[] is_0_ = is[0];
         int[] is_1_ = is[1];
         int[] is_2_ = is[2];
         int i_3_ = this.anInt10172 * (i % this.anInt10172);

         for(int i_4_ = 0; ~Class339_Sub7.anInt8728 < ~i_4_; ++i_4_) {
            int i_5_ = this.anIntArray10165[i_4_ % this.anInt10169 + i_3_];
         ...
         if (i >= 2 && string_8_ != null) {
            for(int i_9_ = 0; i_9_ < Node_Sub38_Sub14.anInt10242; ++i_9_) {
               ...
               if (Class310.method3601(string, string_11_, 30195, string_10_, string_8_)) {
                  ...
                  OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(Node_Sub38_Sub6.aClass318_10135, class123.issacKeys);
