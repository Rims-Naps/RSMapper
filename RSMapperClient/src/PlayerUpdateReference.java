public class PlayerUpdateReference {
   ...
   static int[] anIntArray4083 = new int[]{0, -1, 0, 1};
   ...
   static final void method3808(boolean bool, int i) {
      ...
      if (i == -1 && bool) {
         ...
         for(Node_Sub47 node_sub47 = (Node_Sub47)Class320_Sub3.aHashTable8234.method1516(false);
            node_sub47 != null;
            node_sub47 = (Node_Sub47)Class320_Sub3.aHashTable8234.method1520(i + 125)
         ) {
            if (node_sub47.aNode_Sub9_Sub2_7568 != null) {
               Class176.aNode_Sub9_Sub3_2106.method2514(node_sub47.aNode_Sub9_Sub2_7568);
               node_sub47.aNode_Sub9_Sub2_7568 = null;
   ...
   static final void method3809(int i, int i_2_, int i_3_, CacheNode_Sub4 cachenode_sub4) {
      ...
      if (Class213.rightClickDialogueIsOpen) {
         ...
         for(CacheNode_Sub13 cachenode_sub13 = (CacheNode_Sub13)cachenode_sub4.aClass158_9457.method1723(13);
            cachenode_sub13 != null;
            cachenode_sub13 = (CacheNode_Sub13)cachenode_sub4.aClass158_9457.method1721(0)
         ) {
         ...
         if (i_4_ + i_7_ > Class360.canvasWidth) {
         ...
         int i_9_ = -i_8_ + i - -13;
         if (~Class205.canvasHeight > ~(i_6_ + i_9_)) {
            i_9_ = -i_6_ + Class205.canvasHeight;
         }
