...
public class Class377_Sub1 extends Class377 {
   ...
   static int GAME_SCENE_HEIGHT = 104;
   ...
   static Node_Sub29[] aNode_Sub29Array8782 = new Node_Sub29[8];
   ...
   static final void method4130(boolean bool, int i) {
      ...
      if (i == -10385) {
         try {
            ...
            System.out.println("Runtime exception ignored in Class377_Sub1 while setting culling distance");
         }
      }
   }
   ...
   final Class46 method4131(byte b) {
      ...
      return Class320_Sub22.aClass46Array8418[this.anInt4674];
   }
