...
public class Class11 implements IEnumModesCallback {
   ...
   final void method191(Frame frame, int i, int i_0_, int i_1_, int i_2_, int i_3_) {
      ...
      User32.SetWindowLong(i_4_, -16, Integer.MIN_VALUE);
      User32.SetWindowLong(i_4_, -20, 8);
      if (i_2_ > 105) {
         this.aDirectDraw178.setCooperativeLevel(frame, 17);
         this.aDirectDraw178.setDisplayMode(i_3_, i_1_, i, i_0_, 0);
   ...
   public Class11() {
      this.aDirectDraw178.initialize(null);
   }

   final void method192(Frame frame, int i) {
      this.aDirectDraw178.restoreDisplayMode();
      this.aDirectDraw178.setCooperativeLevel((Component)frame, i);
   }

   final int[] method193(int i) {
      this.aDirectDraw178.enumDisplayModes(0, null, null, this);
