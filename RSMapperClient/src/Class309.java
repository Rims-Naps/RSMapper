public class Class309 {
   ...
   static final void method3586(int i) {
      ...
      if (Class109.anInt1367 != -1 && Class203.anInt2452 != -1) {
         ...
         for(int i_3_ = 111 / ((14 - i) / 59); ~i_2_ > -4; ++i_2_) {
            ...
            int i_6_ = (
                  Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][i_1_ - -2][i_2_]
                     + -Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][3 + i_1_][i_2_]
                     + Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][2 + i_1_][i_2_]
               )
               * 3;
         ...
         Node_Sub10.cameraPosY = -(512 * Class320_Sub4.gameSceneBaseY) + (int)fs[2];
         Class190.cameraHeight = (int)fs[1] * -1;
         Class98.cameraPosX = (int)fs[0] - Node_Sub53.gameSceneBaseX * 512;
         ...
         for(int i_13_ = 0; i_13_ < 3; ++i_13_) {
            ...
            int i_16_ = (
                  Class277_Sub1.anIntArrayArrayArray8042[Class203.anInt2452][i_12_ - -2][i_13_]
                     + -Class277_Sub1.anIntArrayArrayArray8042[Class203.anInt2452][3 + i_12_][i_13_]
                     + Class277_Sub1.anIntArrayArrayArray8042[Class203.anInt2452][i_12_ + 2][i_13_]
               )
               * 3;
         ...
         OutgoingPacket.anInt4050 = 16383 & (int)(Math.atan2((double)f_22_, d) * 2607.5945876176133);
         Class170.anInt2053 = 16383 & (int)(2607.5945876176133 * -Math.atan2((double)f_21_, (double)f_23_));
         Class48.anInt704 = (
               (-Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][i_1_][3] + Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][2 + i_1_][3])
                     * Class141.anInt1758
                  >> 16
            )
            + Class277_Sub1.anIntArrayArrayArray8042[Class109.anInt1367][i_1_][3];
      }
   }
}
