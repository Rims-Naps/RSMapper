...
public class Class134_Sub3 extends Class134 implements Interface13_Impl1 {
   ...
   public final void method43(byte b, int i, int i_3_, int[] is, int i_4_, int i_5_, int i_6_) {
      ++anInt9033;
      int[] is_7_ = new int[this.anInt9030 * this.anInt9032];
      this.aGLXToolkit5299.method1312((byte)-21, this);
      OpenGL.glGetTexImagei(this.anInt5296, 0, 32993, 5121, is_7_, 0);
      if (b == 64) {
         for(int i_8_ = 0; ~i_8_ > ~i_6_; ++i_8_) {
            Class311.method3609(is_7_, (-i_8_ + -1 - -i_6_ + i_3_) * this.anInt9030, is, i_5_ * i_8_ + i, i_5_);
         }
      }
   }
   ...
   Class134_Sub3(GLXToolkit glxtoolkit, int i, int i_9_, int[] is, int i_10_, int i_11_) {
      ...
      OpenGL.glTexImage2Di(this.anInt5296, 0, 6408, this.anInt9030, this.anInt9032, 0, 32993, this.aGLXToolkit5299.anInt9321, is, 4 * i_10_);
      OpenGL.glPixelStorei(3314, 0);
   }
   ...
   Class134_Sub3(GLXToolkit glxtoolkit, Class68 class68, Class372 class372, int i, int i_13_) {
      ...
      OpenGL.glTexImage2Dub(
         ...
         Class136.method1590((byte)108, this.aClass372_5297),
         null,
         0
      );
   }
   ...
   public final void method47(int[] is, int i, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_) {
      ...
      OpenGL.glTexSubImage2Di(this.anInt5296, 0, i, i_14_, i_17_, i_15_, 32993, this.aGLXToolkit5299.anInt9321, is, i_18_);
      if (i_16_ != 23110) {
         this.anInt9032 = 92;
      }
   ...
   static final void method1583(Animable animable, int i, int i_22_, int i_23_) {
      if (i_22_ < Class328.SCENE_WIDTH_X) {
         ...
         if (class261 != null && class261.anAnimable_Sub1_3317 != null && class261.anAnimable_Sub1_3317.method821(0)) {
            animable.method816(0, true, CacheNode_Sub18.aGraphicsToolkit9607, 0, (byte)108, Class179.INT_18, class261.anAnimable_Sub1_3317);
         }
      }

      if (i_23_ < Class328.SCENE_WIDTH_X) {
         Class261 class261 = Class175.aClass261ArrayArrayArray2099[i][i_22_][i_23_ + 1];
         if (class261 != null && class261.anAnimable_Sub1_3317 != null && class261.anAnimable_Sub1_3317.method821(0)) {
            animable.method816(0, true, CacheNode_Sub18.aGraphicsToolkit9607, Class179.INT_18, (byte)118, 0, class261.anAnimable_Sub1_3317);
         }
      }

      if (i_22_ < Class328.SCENE_WIDTH_X && i_23_ < Node_Sub50.SCENE_WIDTH_Y) {
         Class261 class261 = Class175.aClass261ArrayArrayArray2099[i][i_22_ + 1][i_23_ + 1];
         if (class261 != null && class261.anAnimable_Sub1_3317 != null && class261.anAnimable_Sub1_3317.method821(0)) {
            animable.method816(0, true, CacheNode_Sub18.aGraphicsToolkit9607, Class179.INT_18, (byte)122, Class179.INT_18, class261.anAnimable_Sub1_3317);
         }
      }

      if (i_22_ < Class328.SCENE_WIDTH_X && i_23_ > 0) {
         Class261 class261 = Class175.aClass261ArrayArrayArray2099[i][i_22_ + 1][i_23_ - 1];
         if (class261 != null && class261.anAnimable_Sub1_3317 != null && class261.anAnimable_Sub1_3317.method821(0)) {
            animable.method816(0, true, CacheNode_Sub18.aGraphicsToolkit9607, -Class179.INT_18, (byte)121, Class179.INT_18, class261.anAnimable_Sub1_3317);
         }
      }
   }
   ...
   public final void method50(int i, int i_24_, int i_25_, int i_26_, byte[] bs, int i_27_, Class68 class68, int i_28_, int i_29_) {
      ...
      if (i_26_ != -15178) {
         this.method45(1.0271162F, -71);
      }

      OpenGL.glTexSubImage2Dub(this.anInt5296, 0, i_28_, i_27_, i_29_, i_25_, Node_Sub36.method2753((byte)-18, class68), 5121, bs, i);
      if (~i_24_ != ~i_29_) {
         OpenGL.glPixelStorei(3314, 0);
      }
   ...
   Class134_Sub3(GLXToolkit glxtoolkit, Class68 class68, int i, int i_30_, byte[] bs, int i_31_, int i_32_) {
      ...
      this.anInt9030 = i;
      this.anInt9032 = i_30_;
      this.aGLXToolkit5299.method1312((byte)-21, this);
      OpenGL.glPixelStorei(3317, 1);
      OpenGL.glPixelStorei(3314, i_32_);
      OpenGL.glTexImage2Dub(this.anInt5296, 0, this.method1570(10242), i, i_30_, 0, Node_Sub36.method2753((byte)-18, this.aClass68_5317), 5121, bs, i_31_);
      OpenGL.glPixelStorei(3314, 0);
      OpenGL.glPixelStorei(3317, 4);
   }
