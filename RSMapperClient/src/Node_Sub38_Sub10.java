public class Node_Sub38_Sub10 extends Node_Sub38 {
   ...
   final int[][] method2778(int i, boolean bool) {
      ...
      if (this.aClass348_7454.aBoolean4300) {
         ...
         for(int i_5_ = 0; ~i_5_ > ~Class339_Sub7.anInt8728; ++i_5_) {
            int i_6_ = (255 * is_0_[i_5_] & 1044959) >> 12;
            int i_7_ = is_1_[i_5_] * this.anInt10195 >> 12;
   ...
   static final void method2824(int i) {
      ++anInt10196;
      WorldItem.aClass234_11017.method2146(-4756);
   ...
   final void method2780(boolean bool, Buffer buffer, int i) {
      if (~i != -1) {
         ...
         this.anInt10195 = buffer.readUnsignedShort() << 4;
      }
   ...
   final int[] method2775(int i, int i_16_) {
      ...
      if (this.aClass146_7460.aBoolean1819) {
         ...
         for(int i_19_ = 0; ~Class339_Sub7.anInt8728 < ~i_19_; ++i_19_) {
            ...
            int i_21_ = this.anInt10195 * is_18_[i_19_] >> 12;
