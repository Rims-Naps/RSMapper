public class Class50 {
   ...
   protected final void finalize() throws Throwable {
      this.aGLToolkit777.method1450((byte)-33, this.anInt773);
      ++anInt776;
      super.finalize();
   }
   ...
   static final void method512(int i, int i_6_, String string, GraphicsToolkit graphicstoolkit, byte b, int i_7_, int i_8_, int i_9_) {
      if (Class247.aGLSprite3141 == null || aa.aGLSprite102 == null) {
         if (Node_Sub38_Sub39.index8.method3510(Class40.anInt620, (byte)63) && Node_Sub38_Sub39.index8.method3510(Class150.anInt5085, (byte)63)) {
            Class247.aGLSprite3141 = graphicstoolkit.a(Class383.method4194(Node_Sub38_Sub39.index8, Class40.anInt620, 0), true);
            Class383 class383 = Class383.method4194(Node_Sub38_Sub39.index8, Class150.anInt5085, 0);
      ...
      if (b == -39) {
         Class262_Sub4.aClass52_7721.method538(i_8_ + 3, 14 + i_7_, string, -1, b ^ -40, 0xFF000000 | Class320_Sub26.anInt8451);
