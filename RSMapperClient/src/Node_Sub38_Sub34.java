public class Node_Sub38_Sub34 extends Node_Sub38 {
   ...
   private final int method2900(int i, int i_0_, int i_1_) {
      ...
      i_2_ = i_2_ << 1 ^ i_2_;
      return i >= -95 ? 89 : 4096 - (1376312589 + (15731 * i_2_ * i_2_ - -789221) * i_2_ & 2147483647) / 262144;
   }
   ...
   final int[] method2775(int i, int i_3_) {
      ...
      if (this.aClass146_7460.aBoolean1819) {
         ...
         for(int i_5_ = 0; i_5_ < Class339_Sub7.anInt8728; ++i_5_) {
            is[i_5_] = this.method2900(-102, i_4_, CacheNode_Sub3.anIntArray9442[i_5_]) % 4096;
         }
      }
