public class Node_Sub38_Sub19 extends Node_Sub38 {
   ...
   static final boolean method2849(int i, int i_1_, Class261[][][] class261s, int i_2_, int i_3_, boolean bool) {
      ++anInt10285;
      int i_4_ = 82 / ((i - 38) / 54);
      byte b = !bool ? (byte)(Class110.anInt1412 & 0xFF) : 1;
      if (~Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][i_3_][i_1_] == ~b) {
         return false;
      } else if ((4 & Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][i_3_][i_1_]) == 0) {
         return false;
      } else {
         int i_5_ = 0;
         ...
         while(~i_6_ != ~i_5_) {
            int i_7_ = 65535 & Node_Sub38_Sub11.anIntArray10218[i_6_];
            int i_8_ = 0xFF & Node_Sub38_Sub11.anIntArray10218[i_6_] >> 16;
            int i_9_ = Node_Sub38_Sub11.anIntArray10218[i_6_] >> 24 & 0xFF;
            int i_10_ = Animable_Sub2_Sub1.anIntArray10638[i_6_] & 65535;
            int i_11_ = (Animable_Sub2_Sub1.anIntArray10638[i_6_] & 16735654) >> 16;
            i_6_ = i_6_ + 1 & 4095;
            boolean bool_12_ = false;
            if (~(Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_] & 4) == -1) {
               bool_12_ = true;
            }
            ...
            if (class261s != null) {
               label237:
               for(int i_14_ = CacheNode_Sub20_Sub1.myPlayerPlane + 1; ~i_14_ >= -4; ++i_14_) {
                  if (class261s[i_14_] != null && (Class277.tileFlags[i_14_][i_7_][i_10_] & 8) == 0) {
                     if (bool_12_ && class261s[i_14_][i_7_][i_10_] != null) {
                        if (class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314 != null) {
                           ...
                           if (~class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314.aShort9110 == ~i_15_
                              || class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308 != null
                                 && i_15_ == class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308.aShort9110) {
                              continue;
                           }

                           if (~i_9_ != -1) {
                              int i_16_ = Class130.method1559(-124, i_9_);
                              if (class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314.aShort9110 == i_16_
                                 || class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308 != null
                                    && ~i_16_ == ~class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308.aShort9110) {
                                 continue;
                              }
                           }
                           ...
                           if (i_11_ != 0) {
                              ...
                              if (class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314.aShort9110 == i_17_
                                 || class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308 != null
                                    && ~class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308.aShort9110 == ~i_17_) {
                                 continue;
                              }
                           }
                        }
                        ...
                        if (class261.aClass256_3312 != null) {
                           for(Class256 class256 = class261.aClass256_3312; class256 != null; class256 = class256.aClass256_3238) {
                              ...
                              if (mobile instanceof WorldObject) {
                                 WorldObject interface19 = (WorldObject)mobile;
                                 int i_18_ = interface19.getType(-118);
                                 int i_19_ = interface19.getRotation(23796);
                                 if (~i_18_ == -22) {
                                    i_18_ = 19;
                                 }
            ...
            if (bool_13_) {
               int i_23_ = Class320_Sub10.aPlaneArray8300[CacheNode_Sub20_Sub1.myPlayerPlane - -1].getVerticeHeight(i_10_, i_7_, (byte)-118);
               if (~RenderDefinitions.anIntArray3296[i_2_] > ~i_23_) {
                  RenderDefinitions.anIntArray3296[i_2_] = i_23_;
               }
            ...
            if (!bool_12_) {
               if (~i_7_ <= -2 && b != Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][-1 + i_7_][i_10_]) {
               ...
               if (++i_10_ < Class377_Sub1.GAME_SCENE_HEIGHT) {
                  if (~(i_7_ - 1) <= -1
                     && ~b != ~Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][-1 + i_7_][i_10_]
                     && ~(Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_] & 4) == -1
                     && ~(Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ + -1][-1 + i_10_] & 4) == -1) {
                  ...
                  if (Node_Sub54.GAME_SCENE_WDITH > 1 + i_7_
                     && b != Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ + 1][i_10_]
                     && ~(4 & Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_]) == -1
                     && (4 & Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][1 + i_7_][i_10_ - 1]) == 0) {
               ...
               if (i_7_ - -1 < Node_Sub54.GAME_SCENE_WDITH
                  && Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ + 1][--i_10_] != b) {
               ...
               if (--i_10_ >= 0) {
                  if (i_7_ - 1 >= 0
                     && ~Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ - 1][i_10_] != ~b
                     && ~(4 & Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_]) == -1
                     && (Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][-1 + i_7_][i_10_ + 1] & 4) == 0) {
                  ...
                  if (~Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_] != ~b) {
                  ...
                  if (i_7_ + 1 < Node_Sub54.GAME_SCENE_WDITH
                     && ~Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ + 1][i_10_] != ~b
                     && (Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_] & 4) == 0
                     && (Class277.tileFlags[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ - -1][1 + i_10_] & 4) == 0) {
         ...
         if (~RenderDefinitions.anIntArray3296[i_2_] != 999999) {
            RenderDefinitions.anIntArray3296[i_2_] += 40;
   ...
   final void method2780(boolean bool, Buffer buffer, int i) {
      if (!bool) {
         ...
         if (~i != -1) {
            if (~i == -2) {
               this.aBoolean10287 = buffer.readUnsignedByte() == 1;
            }
         } else {
            this.anInt10290 = buffer.readUnsignedShort();
         }
      }
   }
   ...
   final int[][] method2778(int i, boolean bool) {
      ...
      if (this.aClass348_7454.aBoolean4300) {
         ...
         for(int i_37_ = 0; ~i_37_ > ~Class339_Sub7.anInt8728; ++i_37_) {
            int i_38_ = (is_33_[i_37_] - is_31_[i_37_]) * this.anInt10290;
            int i_39_ = this.anInt10290 * (-is_32_[i_37_ - 1 & Class303.anInt3824] + is_32_[Class303.anInt3824 & i_37_ - -1]);
            int i_40_ = i_39_ >> 12;
            int i_41_ = i_38_ >> 12;
