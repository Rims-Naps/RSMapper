class CacheNode extends Node {
   ...
   final void method2275(int i) {
      ++anInt7034;
      if (this.aCacheNode7036 != null) {
         this.aCacheNode7036.aCacheNode7035 = this.aCacheNode7035;
         this.aCacheNode7035.aCacheNode7036 = this.aCacheNode7036;
         this.aCacheNode7035 = null;
         this.aCacheNode7036 = null;
         if (i > -37) {
            anInt7033 = -122;
         }
      }
   ...
   final boolean method2276(byte b) {
      ...
      if (this.aCacheNode7036 == null) {
         ...
         return b < 52 ? true : true;
      }
   }

   static final void method2277(int i, int i_0_) {
      ++anInt7039;
      CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(i ^ 1, i, (long)i_0_);
