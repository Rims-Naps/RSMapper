...
class Class169_Sub2 extends Class169 {
   ...
   Class169_Sub2(GLToolkit gltoolkit, int i, int i_0_, int i_1_, int i_2_, boolean bool, byte[] bs, int i_3_, boolean bool_4_) {
      ...
      if (bool && this.anInt4951 != 34037) {
         Class212.method2051(i_0_, i, i_3_, i_1_, (byte)98, i_2_, bs);
         this.method1766((byte)73, true);
      } else {
         OpenGL.glTexImage2Dub(this.anInt4951, 0, this.anInt4950, this.anInt8795, this.anInt8803, 0, i_3_, 5121, bs, 0);
   ...
   Class169_Sub2(GLToolkit gltoolkit, int i, int i_10_, int i_11_, int i_12_, int i_13_) {
      ...
      this.anInt8795 = i_12_;
      this.anInt8803 = i_13_;
      int i_14_ = -i_11_ - i_13_ + this.aGLToolkit4947.anInt6567;
      this.aGLToolkit4947.method1444(-2, this);
      OpenGL.glCopyTexImage2D(this.anInt4951, 0, this.anInt4950, i_10_, i_14_, i_12_, i_13_, 0);
      this.method1757(false, true);
   }

   @Override
   public final void method5(int i) {
      OpenGL.glFramebufferTexture2DEXT(this.anInt8805, this.anInt8797, this.anInt4951, 0, i);
      ++anInt8801;
      this.anInt8805 = -1;
      this.anInt8797 = -1;
   }
   ...
   Class169_Sub2(GLToolkit gltoolkit, int i, int i_15_, int i_16_, int i_17_) {
      ...
      this.anInt8795 = i_16_;
      this.anInt8803 = i_17_;
      this.aGLToolkit4947.method1444(-2, this);
      OpenGL.glTexImage2Dub(this.anInt4951, 0, this.anInt4950, i_16_, i_17_, 0, Class320_Sub16.method3742(6406, this.anInt4950), 5121, null, 0);
      this.method1757(false, true);
   }
   ...
   final void method1772(byte b, int[] is, boolean bool, int i, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_) {
      ...
      this.aGLToolkit4947.method1444(b + 26, this);
      if (~i_21_ != ~i_19_) {
         OpenGL.glPixelStorei(3314, i_21_);
      }

      OpenGL.glTexSubImage2Di(this.anInt4951, 0, i, -i_18_ + -i_20_ + this.anInt8803, i_19_, i_18_, 32993, this.aGLToolkit4947.anInt6740, is, i_22_);
      if (~i_19_ != ~i_21_) {
   ...
   Class169_Sub2(GLToolkit gltoolkit, int i, int i_28_, int i_29_, int i_30_, boolean bool, int[] is, int i_31_, int i_32_, boolean bool_33_) {
      ...
      this.anInt8803 = i_30_;
      this.anInt8795 = i_29_;
      if (bool_33_) {
      ...
      this.aGLToolkit4947.method1444(-2, this);
      if (~this.anInt4951 != -34038 && bool && i_31_ == 0 && ~i_32_ == -1) {
         Class258.method3124(this.anInt8795, this.anInt4951, is, 32993, this.anInt4950, this.anInt8803, 1, this.aGLToolkit4947.anInt6740);
         this.method1766((byte)126, true);
      } else {
         OpenGL.glPixelStorei(3314, i_31_);
         OpenGL.glTexImage2Di(this.anInt4951, 0, this.anInt4950, this.anInt8795, this.anInt8803, 0, 32993, this.aGLToolkit4947.anInt6740, is, 4 * i_32_);
         OpenGL.glPixelStorei(3314, 0);
   ...
   final void method1773(int i, int i_39_, int i_40_, byte b, int i_41_, int i_42_, int i_43_) {
      ++anInt8800;
      if (b > 60) {
         int i_44_ = this.aGLToolkit4947.anInt6567 + -i + -i_41_;
         this.aGLToolkit4947.method1444(-2, this);
         OpenGL.glCopyTexSubImage2D(this.anInt4951, 0, i_39_, this.anInt8803 - i_40_ - i, i_42_, i_44_, i_43_, i);
         OpenGL.glFlush();
      }
   }
   ...
   Class169_Sub2(GLToolkit gltoolkit, int i, int i_45_, int i_46_, int i_47_, boolean bool, float[] fs, int i_48_) {
      ...
      this.anInt8795 = i_46_;
      this.anInt8803 = i_47_;
      this.aGLToolkit4947.method1444(-2, this);
      if (bool && ~this.anInt4951 != -34038) {
         Node_Sub47.method2953(i_48_, i_47_, true, i_46_, i, fs, i_45_);
         this.method1766((byte)120, true);
      } else {
         OpenGL.glTexImage2Df(this.anInt4951, 0, this.anInt4950, this.anInt8795, this.anInt8803, 0, i_48_, 5126, fs, 0);
   ...
   final void method1774(int i, int i_49_, int i_50_, int i_51_) {
      ++anInt8802;
      OpenGL.glFramebufferTexture2DEXT(i_50_, i_51_, this.anInt4951, this.anInt4960, i);
      this.anInt8805 = i_50_;
      if (i_49_ != 3314) {
         this.method1773(-14, -48, -69, (byte)58, 74, 2, 50);
      }

      this.anInt8797 = i_51_;
   }
   ...
   final void method1775(int i, byte b, int i_52_, int i_53_, int i_54_, byte[] bs, boolean bool, int i_55_, int i_56_, int i_57_) {
      ...
      if (b < 81) {
         this.method1774(-13, 61, 125, 53);
      }

      OpenGL.glTexSubImage2Dub(this.anInt4951, 0, i_56_, i_57_, i_54_, i_53_, i_52_, 5121, bs, i);
      if (i_55_ != i_54_) {
         OpenGL.glPixelStorei(3314, 0);
      }
   ...
   final void method1776(boolean bool, int i, boolean bool_66_) {
      if (~this.anInt4951 == -3554) {
         this.aGLToolkit4947.method1444(-2, this);
         OpenGL.glTexParameteri(this.anInt4951, 10242, bool ? 10497 : '\u812F');
         OpenGL.glTexParameteri(this.anInt4951, 10243, !bool_66_ ? '\u812F' : 10497);
      }
