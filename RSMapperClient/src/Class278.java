public class Class278 {
   ...
   final void method3362(int i, int i_0_) {
      ...
      synchronized(this.aClass61_3543) {
         this.aClass61_3543.method598(i, -11819);
      }
   }

   final void method3363(int i) {
      if (i != -29945) {
         this.aClass302_3539 = null;
      }

      synchronized(this.aClass61_3543) {
         this.aClass61_3543.method602((byte)-124);
      }
   ...
   private final Class82 method3364(int i, int i_1_) {
      ...
      synchronized(this.aClass61_3543) {
         ...
         class82 = (Class82)this.aClass61_3543.method607((long)i, 0);
      }
      ...
      if (class82 != null) {
         ...
         byte[] bs;
         synchronized(this.aClass302_3539) {
            bs = this.aClass302_3539.getFile(false, i, 29);
         }
         ...
         synchronized(this.aClass61_3543) {
            this.aClass61_3543.method601(class82, i_1_ ^ -3004, (long)i);
            return class82;
         }
      }
   }
   ...
   final void method3365(int i) {
      synchronized(this.aClass61_3543) {
         this.aClass61_3543.method608(false);
      }

      ++anInt3547;
      if (i <= 82) {
         this.aClass61_3543 = null;
      }
   }
   ...
   final Class119 method3366(Class57 class57, int i, int i_2_, int i_3_, int i_4_, boolean bool) {
      ...
      Class82 class82 = this.method3364(i_2_, -26726);
   ...
   static final boolean method3367(int i, int i_6_, byte b) {
      ...
      ++anInt3540;
      return ~(544 & i_6_) == -545 | (24 & i_6_) != 0;
   }

   Class278(Class353 class353, int i, Index class302) {
      this.aClass302_3539 = class302;
      this.aClass302_3539.method3537(-2, 29);
   }
