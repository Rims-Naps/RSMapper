public class CacheNode_Sub12 extends CacheNode {
   static IncommingPacket aClass192_9552 = new IncommingPacket(44, 10);
   static int anInt9553;
   protected Mobile_Sub1 aMobile_Sub1_9554;
   static int anInt9555 = 0;
   static Class61 aClass61_9556 = new Class61(8);
   ...
   CacheNode_Sub12(Mobile_Sub1 mobile_sub1) {
      this.aMobile_Sub1_9554 = mobile_sub1;
   }
   ...
   static final void method2343(ObjectDefinition objectdefinition, byte b, int i, GraphicsToolkit graphicstoolkit, int i_10_, int i_11_) {
      ...
      if (class140.spriteId != -1) {
         ...
         if (glsprite != null) {
            int i_12_ = objectdefinition.sizeX;
            int i_13_ = objectdefinition.sizeY;
            if (b < 79) {
               anInt9555 = 47;
            }

            if (~(i & 1) == -2) {
               i_12_ = objectdefinition.sizeY;
               i_13_ = objectdefinition.sizeX;
            }
            ...
            if (class140.anInt1737 != 0) {
               glsprite.method1199(i_10_, -((i_13_ + -1) * 4) + i_11_, i_14_, i_15_, 0, 0xFF000000 | class140.anInt1737, 1);
            } else {
