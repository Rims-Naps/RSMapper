   ...
   static final void method3648(int i) {
      ...
      Class229.aGraphicsToolkit2732
         .ZA(
            ...
            CacheNode_Sub16_Sub2.aFloat11082,
            Class363.aFloat4502,
            (float)(Class181.anInt2145 << 2),
            (float)(Class134_Sub2.anInt9022 << 2),
            (float)(Class173.anInt2089 << 2)
         );
      int i_1_ = -3 % ((i - -57) / 39);
   ...
   static final boolean method3649(boolean bool, int i, int i_2_, int i_3_) {
      ...
      if (!Class12.aBoolean194 || !Mobile_Sub1.aBoolean10959) {
         ...
         if (~(-Class359.anInt4465) == ~i_4_) {
            return false;
         } else if (Class359.anInt4465 == i_4_) {
            return true;
         } else if (Class368.aPlaneArray4548 == Class320_Sub10.aPlaneArray8300) {
            return false;
         } else {
            int i_5_ = i_3_ << Class36.INT_9;
            int i_6_ = i << Class36.INT_9;
            if (Class99.method1087(
                  -1 + i_5_ + Class179.INT_18,
                  i_6_ + 1,
                  Class320_Sub10.aPlaneArray8300[i_2_].getVerticeHeight(1 + i, i_3_ + 1, (byte)-118),
                  Class320_Sub10.aPlaneArray8300[i_2_].getVerticeHeight(1 + i, i_3_, (byte)-118),
                  Class320_Sub10.aPlaneArray8300[i_2_].getVerticeHeight(i, i_3_, (byte)-118),
                  (byte)89,
                  -1 + i_6_ - -Class179.INT_18,
                  Class179.INT_18 + i_6_ + -1,
                  1 + i_5_,
                  1 + i_5_
               )
               && Class99.method1087(
                  -1 + Class179.INT_18 + i_5_,
                  1 + i_6_,
                  Class320_Sub10.aPlaneArray8300[i_2_].getVerticeHeight(i, i_3_ + 1, (byte)-118),
                  Class320_Sub10.aPlaneArray8300[i_2_].getVerticeHeight(i + 1, i_3_ + 1, (byte)-118),
                  Class320_Sub10.aPlaneArray8300[i_2_].getVerticeHeight(i, i_3_, (byte)-118),
                  (byte)89,
                  1 + i_6_,
                  Class179.INT_18 + i_6_ + -1,
