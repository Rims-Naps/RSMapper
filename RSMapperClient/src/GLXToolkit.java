...
public class GLXToolkit extends AbstractToolkit {
   ...
   final void method1374(byte b) {
      ...
      ++anInt9248;
      this.aFloat6311 = this.aFloat6328 - (float)this.anInt6355;
      if ((float)this.anInt6364 > this.aFloat6311) {
         this.aFloat6311 = (float)this.anInt6364;
      }

      OpenGL.glFogf(2915, this.aFloat6311);
      OpenGL.glFogf(2916, this.aFloat6328);
      GLDrawableModel.aFloatArray5626[0] = (float)Node_Sub30.method2723(this.anInt6276, 16711680) / 1.671168E7F;
      GLDrawableModel.aFloatArray5626[1] = (float)Node_Sub30.method2723(this.anInt6276, 65280) / 65280.0F;
      GLDrawableModel.aFloatArray5626[2] = (float)Node_Sub30.method2723(255, this.anInt6276) / 255.0F;
   ...
   final Object method1351(java.awt.Canvas canvas, int i) {
      ++anInt9258;
      long l = this.anOpenGL9249.prepareSurface(canvas);
      if (i >= -70) {
         this.b(true);
      }
   ...
   final void method1308(byte b) {
      if (this.aBoolean6338 && this.aBoolean6299 && ~this.anInt6355 <= -1) {
   ...
   final int I() {
      ++anInt9271;
      return this.anInt9319;
   }

   private final void method1397(byte b) {
      if (this.aBoolean9313) {
         OpenGL.glPopMatrix();
      }

      ++anInt9241;
      if (this.aClass56_6303.method566(107)) {
         if (!this.aBoolean9305) {
            OpenGL.glLoadMatrixf(this.aClass336_Sub1_6269.method3884(true, Node_Sub38_Sub8.aFloatArray10162), 0);
            this.aBoolean9305 = true;
            this.method1382(103);
            this.method1273(-124);
         }
         ...
         if (!this.aBoolean6261) {
            OpenGL.glPushMatrix();
            OpenGL.glMultMatrixf(this.aClass336_Sub1_6262.method3884(true, Node_Sub38_Sub8.aFloatArray10162), 0);
            this.aBoolean9313 = true;
         } else {
            this.aBoolean9313 = false;
         }
      } else if (!this.aBoolean6261) {
         OpenGL.glLoadMatrixf(this.aClass336_Sub1_6262.method3884(true, Node_Sub38_Sub8.aFloatArray10162), 0);
         this.aBoolean9313 = false;
      } else {
   ...
   final synchronized void method1398(int i, int i_5_, boolean bool) {
      ++anInt9253;
      if (!bool) {
         this.method1349(null, (byte)-14, false, true, -23);
      }

      Node_Sub32 node_sub32 = new Node_Sub32(i);
      node_sub32.scriptId = (long)i_5_;
      this.aClass312_9275.method3625((byte)-54, node_sub32);
   }
   ...
   final Class290 method1311(int i, int i_6_) {
      ...
      if (i_6_ != 3) {
         if (~i_6_ != -5) {
            return (Class290)(~i_6_ == -9 ? new Class290_Sub3(this, this.aClass302_6167, this.aClass5_6247) : super.method1311(-22838, i_6_));
         } else {
            return new Class290_Sub1(this, this.aClass302_6167, this.aClass5_6247);
         }
      } else {
         return new Class290_Sub11(this, this.aClass302_6167);
      }
   }
   ...
   final Class270 a(Class270 class270, Class270 class270_8_, float f, Class270 class270_9_) {
      ++anInt9254;
      return f >= 0.5F ? class270_8_ : class270;
   }
   ...
   final void method1261(byte b) {
      ...
      ++anInt9226;
      OpenGL.glViewport(this.anInt6280, this.anInt6307, this.anInt6239, this.anInt6124);
   }

   @Override
   final void method1251(byte b) {
      ++anInt9298;
      int i = this.anIntArray9324[this.anInt6284];
      if (~i != -1) {
         this.anIntArray9324[this.anInt6284] = 0;
   ...
   final void h() {
      ++anInt9214;
      if (this.anInt6239 > 0 || this.anInt6124 > 0) {
         int i = this.anInt6295;
         int i_10_ = this.anInt6294;
         int i_11_ = this.anInt6325;
         int i_12_ = this.anInt6333;
         this.la();
         ...
         OpenGL.glCopyPixels(0, 0, this.anInt6239, this.anInt6124, 6144);
         OpenGL.glFlush();
   ...
   final Interface13_Impl1 method1367(int i, int i_13_, int[] is, int i_14_, int i_15_, boolean bool, int i_16_) {
      ...
      if (!this.aBoolean9320 && (!Class371.method4094(i_13_, false) || !Class371.method4094(i_16_, false))) {
         if (this.aBoolean9317) {
            return new Class134_Sub3(this, i_13_, i_16_, is, i_14_, i_15_);
         } else {
            Class134_Sub4 class134_sub4 = new Class134_Sub4(
               this, Class99.aClass68_1290, Class372.aClass372_4594, Class320_Sub19.method3753(i_13_), Class320_Sub19.method3753(i_16_)
            );
   ...
   final void method1309(int i) {
      ++anInt9211;
      if (i <= -101) {
         OpenGL.glActiveTexture(33984 + this.anInt6284);
      }
   }
   ...
   final synchronized void e(int i) {
      ...
      while(!this.aClass312_9264.method3616(0)) {
         Node_Sub32 node_sub32 = (Node_Sub32)this.aClass312_9264.method3619(-65);
         Class262_Sub14.anIntArray7813[i_17_++] = (int)node_sub32.scriptId;
         this.anInt6260 -= node_sub32.anInt7381;
         if (i_17_ == 1000) {
      ...
      while(!this.aClass312_9275.method3616(0)) {
         Node_Sub32 node_sub32 = (Node_Sub32)this.aClass312_9275.method3619(-65);
         Class262_Sub14.anIntArray7813[i_17_++] = (int)node_sub32.scriptId;
         this.anInt6266 -= node_sub32.anInt7381;
         if (i_17_ == 1000) {
      ...
      while(!this.aClass312_9301.method3616(0)) {
         Node_Sub32 node_sub32 = (Node_Sub32)this.aClass312_9301.method3619(-81);
      ...
      while(!this.aClass312_9302.method3616(0)) {
         Node_Sub32 node_sub32 = (Node_Sub32)this.aClass312_9302.method3619(-98);
         Class262_Sub14.anIntArray7813[i_17_++] = (int)node_sub32.scriptId;
         this.anInt6264 -= node_sub32.anInt7381;
         if (i_17_ == 1000) {
      ...
      while(!this.aClass312_9223.method3616(0)) {
         Node_Sub32 node_sub32 = (Node_Sub32)this.aClass312_9223.method3619(-92);
         OpenGL.glDeleteLists((int)node_sub32.scriptId, node_sub32.anInt7381);
      }

      while(!this.aClass312_9303.method3616(0)) {
         Node node = this.aClass312_9303.method3619(-113);
         OpenGL.glDeleteProgramARB((int)node.scriptId);
      }

      while(!this.aClass312_9304.method3616(0)) {
         Node node = this.aClass312_9304.method3619(-67);
         OpenGL.glDeleteObjectARB(node.scriptId);
      }

      while(!this.aClass312_9223.method3616(0)) {
         Node_Sub32 node_sub32 = (Node_Sub32)this.aClass312_9223.method3619(-79);
         OpenGL.glDeleteLists((int)node_sub32.scriptId, node_sub32.anInt7381);
      }

      if (~this.E() < -100663297 && 60000L + this.aLong9312 < Class313.method3650(false)) {
         System.gc();
         this.aLong9312 = Class313.method3650(false);
      }
   ...
   final void method1360(byte b) {
      if (b <= 36) {
         this.aBoolean9316 = false;
      }

      ++anInt9268;
      this.method1397((byte)-22);
   }
   ...
   final synchronized void method1400(int i, int i_22_) {
      ...
      Node node = new Node();
      if (i_22_ != -15743) {
         this.method1275(-84, null, null);
      }

      node.scriptId = (long)i;
      this.aClass312_9303.method3625((byte)-54, node);
   }

   static final boolean consoleIsOpen(int i) {
      ++anInt9261;
      if (i != -6279) {
         anInt9276 = -87;
      }
   ...
   final void method1275(int i, java.awt.Canvas canvas, Object object) {
      ...
      if (i > -61) {
         this.method1321((byte)11, null);
      }

      this.anOpenGL9249.releaseSurface(canvas, var_long);
   }

   @Override
   final void method1300(int i) {
      OpenGL.glScissor(
         this.anInt6295 + this.anInt6280, this.anInt6307 + this.anInt6124 - this.anInt6333, this.anInt6294 - this.anInt6295, this.anInt6333 + -this.anInt6325
      );
      if (i != 0) {
         this.a(60, -64, 90, -20);
      }
   ...
   final void method1334(int i) {
      ++anInt9225;
      OpenGL.glMatrixMode(5889);
      OpenGL.glLoadMatrixf(this.aFloatArray6314, 0);
      OpenGL.glMatrixMode(5888);
   }
   ...
   final void method1254(boolean bool) {
      if (!bool) {
         this.a(0.92554986F, -1.3076545F, 0.5009772F);
      }

      OpenGL.glTexEnvi(8960, 34162, Class260.method3136(this.aClass94Array6296[this.anInt6284], 30716));
      ++anInt9215;
   }
   ...
   final Interface15_Impl2 method1380(int i, boolean bool) {
      ++anInt9228;
      return i != 2 ? null : new Class51_Sub1(this, bool);
   }

   @Override
   final void method1353(boolean bool) {
      ++anInt9243;
      GLDrawableModel.aFloatArray5626[1] = this.aFloat6300 * this.aFloat6293;
      GLDrawableModel.aFloatArray5626[0] = this.aFloat6300 * this.aFloat6323;
      if (bool) {
         this.method1269((byte)-92);
      }

      GLDrawableModel.aFloatArray5626[2] = this.aFloat6300 * this.aFloat6365;
   ...
   final void e(int i, int i_26_) throws Exception_Sub1 {
      this.anOpenGL9249.swapBuffers();
      ++anInt9267;
   }

   @Override
   final void method1337(int i) {
      GLDrawableModel.aFloatArray5626[3] = (float)(this.anInt6318 >>> 24) / 255.0F;
      GLDrawableModel.aFloatArray5626[0] = (float)Node_Sub30.method2723(16711680, this.anInt6318) / 1.671168E7F;
      if (i != 6) {
         this.method1380(14, false);
      }

      GLDrawableModel.aFloatArray5626[2] = (float)Node_Sub30.method2723(this.anInt6318, 255) / 255.0F;
      GLDrawableModel.aFloatArray5626[1] = (float)Node_Sub30.method2723(65280, this.anInt6318) / 65280.0F;
      ++anInt9208;
   ...
   final void method1354(int i, int i_27_, Interface15_Impl2 interface15_impl2) {
      ++anInt9229;
      if (i_27_ == 32011) {
         this.aClass51_Sub1Array9309[i] = (Class51_Sub1)interface15_impl2;
      }
   }
   ...
   final void method1289(boolean bool) {
      GLDrawableModel.aFloatArray5626[0] = this.aFloat6323 * this.aFloat6274;
      ++anInt9288;
      GLDrawableModel.aFloatArray5626[3] = 1.0F;
      GLDrawableModel.aFloatArray5626[1] = this.aFloat6293 * this.aFloat6274;
      GLDrawableModel.aFloatArray5626[2] = this.aFloat6274 * this.aFloat6365;
      OpenGL.glLightfv(16384, 4609, GLDrawableModel.aFloatArray5626, 0);
      GLDrawableModel.aFloatArray5626[1] = this.aFloat6293 * -this.aFloat6272;
      GLDrawableModel.aFloatArray5626[3] = 1.0F;
      if (bool) {
         this.v();
      }

      GLDrawableModel.aFloatArray5626[0] = -this.aFloat6272 * this.aFloat6323;
      GLDrawableModel.aFloatArray5626[2] = this.aFloat6365 * -this.aFloat6272;
   ...
   final synchronized void method1402(byte b, int i, int i_28_) {
      if (b <= -22) {
         ...
         node_sub32.scriptId = (long)i;
         this.aClass312_9264.method3625((byte)-54, node_sub32);
      }
   }
   ...
   final synchronized void method1403(int i, long l) {
      ...
      Node node = new Node();
      node.scriptId = l;
      this.aClass312_9304.method3625((byte)-54, node);
      if (i != 2) {
         this.method1338(null, -35);
      }
   }
   ...
   final void method1338(Class213 class213, int i) {
      ...
      if (i == 9422) {
         for(int i_33_ = 0; class207s.length > i_33_; ++i_33_) {
            ...
            Class51_Sub1 class51_sub1 = this.aClass51_Sub1Array9309[i_33_];
            int i_34_ = 0;
         ...
         if (this.aBoolean9306 != bool_32_) {
            ...
            this.aBoolean9306 = bool_32_;
         }

         if (!bool_31_ == this.aBoolean9310) {
            if (bool_31_) {
            ...
            this.aBoolean9310 = bool_31_;
         }

         if (!this.aBoolean9307 == bool) {
            if (!bool) {
            ...
            this.aBoolean9307 = bool;
         }

         if (~this.anInt9311 > ~i_30_) {
            for(int i_37_ = this.anInt9311; ~i_37_ > ~i_30_; ++i_37_) {
               OpenGL.glClientActiveTexture(i_37_ + 33984);
               OpenGL.glEnableClientState(32888);
            }

            this.anInt9311 = i_30_;
         } else if (~i_30_ > ~this.anInt9311) {
            for(int i_38_ = i_30_; i_38_ < this.anInt9311; ++i_38_) {
   ...
   final Interface13_Impl1 method1322(Class68 class68, boolean bool, int i, int i_41_, byte b, float[] fs, int i_42_, int i_43_) {
      ...
      if (!this.aBoolean9320 && (!Class371.method4094(i_43_, false) || !Class371.method4094(i, false))) {
         if (this.aBoolean9317) {
            return new Class134_Sub3(this, class68, i_43_, i, fs, i_41_, i_42_);
         } else {
            Class134_Sub4 class134_sub4 = new Class134_Sub4(
               this, class68, Class372.aClass372_4598, Class320_Sub19.method3753(i_43_), Class320_Sub19.method3753(i)
            );
            class134_sub4.method1586(class68, 0, i, i_41_, fs, b ^ -27325, 0, i_42_, i_43_);
            return class134_sub4;
         }
      } else {
   ...
   final void method1326(boolean bool) {
      for(int i = this.anInt6370 - 1; ~i <= -1; --i) {
      ...
      float[] fs = new float[]{0.0F, 0.0F, 0.0F, 1.0F};
      ...
      this.anOpenGL9249.setSwapInterval(0);
   ...
   final Interface13_Impl1 method1291(Class68 class68, Class372 class372, int i, int i_45_, int i_46_) {
      ++anInt9240;
      if (!this.aBoolean9320 && (!Class371.method4094(i_45_, false) || !Class371.method4094(i, false))) {
         return (Interface13_Impl1)(!this.aBoolean9317
            ? new Class134_Sub4(this, class68, class372, Class320_Sub19.method3753(i_45_), Class320_Sub19.method3753(i))
            : new Class134_Sub3(this, class68, class372, i_45_, i));
      } else {
   ...
   final Interface13_Impl1 method1327(Class68 class68, int i, boolean bool, int i_48_, int i_49_, int i_50_, boolean bool_51_, byte[] bs) {
      ...
      if (!bool_51_) {
         return null;
      } else if (!this.aBoolean9320 && (!Class371.method4094(i, !bool_51_) || !Class371.method4094(i_50_, false))) {
         if (!this.aBoolean9317) {
            Class134_Sub4 class134_sub4 = new Class134_Sub4(
               this, class68, Class372.aClass372_4594, Class320_Sub19.method3753(i), Class320_Sub19.method3753(i_50_)
            );
   ...
   final int[] na(int i, int i_52_, int i_53_, int i_54_) {
      ...
      for(int i_55_ = 0; ~i_54_ < ~i_55_; ++i_55_) {
         OpenGL.glReadPixelsi(i, -1 + this.anInt6124 + -i_52_ + -i_55_, i_53_, 1, 32993, this.anInt9321, is, i_53_ * i_55_);
      }
   ...
   final Renderer c() {
      ++anInt9222;
      int i = -1;
      if (this.aString9318.indexOf("nvidia") == -1) {
         if (~this.aString9318.indexOf("intel") != 0) {
            i = 32902;
         } else if (this.aString9318.indexOf("ati") != -1) {
            i = 4098;
         }
      } else {
         i = 4318;
      ...
      return new Renderer(i, "OpenGL", this.anInt9325, this.aString9323, 0L);
   }
   ...
   final void method1370(int i) {
      if (i >= -12) {
         this.aBoolean9315 = true;
      }

      ++anInt9263;
      OpenGL.glDepthMask(this.aBoolean6275 && this.aBoolean6313);
   }
   ...
   final void method1310(byte b) {
      ...
      if (Class119.aClass346_1515 != this.aClass346Array6343[this.anInt6284]) {
         OpenGL.glLoadMatrixf(this.aClass336_Sub1Array6327[this.anInt6284].method3884(true, Node_Sub38_Sub8.aFloatArray10162), 0);
      } else {
         OpenGL.glLoadIdentity();
      }
   ...
   final void method1319(Object object, java.awt.Canvas canvas, int i) {
      ...
      if (!this.anOpenGL9249.setSurface(var_long)) {
         throw new RuntimeException();
      }
   }
   ...
   final void method1382(int i) {
      ++anInt9245;
      OpenGL.glLightfv(16384, 4611, this.aFloatArray6292, 0);
      OpenGL.glLightfv(16385, 4611, this.aFloatArray6304, 0);
   }
   ...
   GLXToolkit(OpenGL opengl, java.awt.Canvas canvas, long l, d var_d, Index class302, int i) {
      ...
      this.aMapBuffer9308 = new MapBuffer();
      this.aMapBuffer9314 = new MapBuffer();
      this.anInt9319 = 0;

      try {
         this.anOpenGL9249 = opengl;
         this.anOpenGL9249.b();
         this.aString9318 = OpenGL.glGetString(7936).toLowerCase();
         this.aString9323 = OpenGL.glGetString(7937).toLowerCase();
         if (this.aString9318.indexOf("microsoft") == -1 && this.aString9318.indexOf("brian paul") == -1 && this.aString9318.indexOf("mesa") == -1) {
            ...
            if (~strings.length <= -3) {
               try {
                  ...
                  this.anInt9325 = i_74_ * 10 - -i_75_;
               } catch (NumberFormatException var19) {
                  throw new RuntimeException("");
               }

               if (~this.anInt9325 > -13) {
                  throw new RuntimeException("");
               } else if (!this.anOpenGL9249.a("GL_ARB_multitexture")) {
                  throw new RuntimeException("");
               } else if (!this.anOpenGL9249.a("GL_ARB_texture_env_combine")) {
                  throw new RuntimeException("");
               } else {
                  int[] is = new int[1];
                  ...
                  if (~this.anInt6370 > -3) {
                     ...
                     this.anInt6367 = 8;
                     this.aBoolean9316 = this.anOpenGL9249.a("GL_ARB_vertex_buffer_object");
                     this.aBoolean6342 = this.anOpenGL9249.a("GL_ARB_multisample");
                     this.aBoolean9317 = this.anOpenGL9249.a("GL_ARB_texture_rectangle");
                     this.aBoolean6310 = this.anOpenGL9249.a("GL_ARB_texture_cube_map");
                     this.aBoolean9320 = this.anOpenGL9249.a("GL_ARB_texture_non_power_of_two");
                     this.aBoolean6366 = this.anOpenGL9249.a("GL_EXT_texture3D");
                     this.aBoolean9315 = this.anOpenGL9249.a("GL_ARB_vertex_shader");
                     this.aBoolean9326 = this.anOpenGL9249.a("GL_ARB_vertex_program");
                     this.aBoolean9322 = this.anOpenGL9249.a("GL_ARB_fragment_shader");
                     this.anOpenGL9249.a("GL_ARB_fragment_program");
                     this.anIntArray9324 = new int[this.anInt6370];
                     this.anInt9321 = Stream.b() ? '\u8367' : 5121;
                     if (~this.aString9323.indexOf("radeon") != 0) {
                        int i_76_ = 0;
                        boolean bool = false;
                        boolean bool_77_ = false;
                        String[] strings_78_ = Class106.method1120((byte)78, this.aString9323.replace('/', ' '), ' ');
                        ...
                        this.aBoolean9317 &= this.anOpenGL9249.a("GL_ARB_half_float_pixel");
                     }

                     this.aString9318.indexOf("intel");
                     if (this.aBoolean9316) {
                        try {
   ...
   final void u() {
      ++anInt9246;
      super.u();
      if (this.anOpenGL9249 != null) {
         this.anOpenGL9249.a();
         this.anOpenGL9249.release();
         this.anOpenGL9249 = null;
      }
   }

   @Override
   final void method1263(boolean bool) {
      OpenGL.glTexEnvi(8960, 34161, Class260.method3136(this.aClass94Array6351[this.anInt6284], 30716));
      if (bool) {
         this.aBoolean9322 = true;
      }
   ...
   final boolean method1377(Class372 class372, Class68 class68, byte b) {
      if (b != -72) {
         this.method1287(74, null, false, 75);
      }
   ...
   final void method1273(int i) {
      ...
      int i_92_;
      for(i_92_ = 0; this.anInt6358 > i_92_; ++i_92_) {
         Node_Sub29 node_sub29 = this.aNode_Sub29Array6345[i_92_];
         int i_93_ = node_sub29.getColor((byte)-63);
         int i_94_ = 16386 - -i_92_;
         float f = node_sub29.method2707(1) / 255.0F;
         GLDrawableModel.aFloatArray5626[0] = (float)node_sub29.getReferenceX(32311);
         GLDrawableModel.aFloatArray5626[1] = (float)node_sub29.getHeight(30);
         GLDrawableModel.aFloatArray5626[2] = (float)node_sub29.getReferenceY(27433);
         GLDrawableModel.aFloatArray5626[3] = 1.0F;
         ...
         OpenGL.glLightf(i_94_, 4617, 1.0F / (float)(node_sub29.getFlickerType(121) * node_sub29.getFlickerType(123)));
         OpenGL.glEnable(i_94_);
      }

      while(this.anInt6356 > i_92_) {
   ...
   final void method1302(int i) {
      if (i == 1) {
         if (this.aBoolean6340 && !this.aBoolean6283) {
   ...
   final void method1265(java.awt.Canvas canvas, Object object, int i) {
      ++anInt9242;
      Long var_long = (Long)object;
      this.anOpenGL9249.surfaceResized(var_long);
   }

   @Override
   final void method1259(int i) {
      if (this.aClass26_6301 != Class47.aClass26_688) {
         if (this.aClass26_6301 == Class339_Sub3.aClass26_8664) {
            OpenGL.glBlendFunc(1, 1);
         } else if (this.aClass26_6301 == Node_Sub15_Sub7.aClass26_9827) {
      ...
      if (i < 85) {
         this.a(null, null, -2.3890455F, null);
      }
