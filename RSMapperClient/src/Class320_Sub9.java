public class Class320_Sub9 extends Class320 {
   ...
   static final void method3714(int i, byte b, int i_2_, int i_3_, int i_4_) {
      ...
      if (b < -123) {
         for(Node_Sub47 node_sub47 = (Node_Sub47)Class200_Sub2.aClass312_4942.method3613(65280);
            ...
            int i_5_ = 1;
            RenderDefinitions class259 = node_sub47.aNpc7583.method868((byte)-125);
            int i_6_ = node_sub47.aNpc7583.anAnimator10860.getAnimationId();
            if (~i_6_ != 0 && !node_sub47.aNpc7583.aBoolean10867) {
               if (~i_6_ == ~class259.anInt3252 || i_6_ == class259.anInt3271 || ~i_6_ == ~class259.anInt3293 || class259.anInt3270 == i_6_) {
                  i_5_ = 2;
               } else if (~class259.anInt3262 == ~i_6_ || ~i_6_ == ~class259.anInt3297 || class259.anInt3304 == i_6_ || i_6_ == class259.anInt3269) {
                  i_5_ = 3;
               }
            } else {
               i_5_ = 0;
            ...
            if (~node_sub47.anInt7586 != ~i_5_) {
               ...
               NpcDefinition npcdefinition = node_sub47.aNpc7583.definitions;
            ...
            node_sub47.anInt7569 = node_sub47.aNpc7583.x;
            node_sub47.anInt7582 = node_sub47.aNpc7583.x + (node_sub47.aNpc7583.getSize((byte)53) << 8);
            node_sub47.anInt7563 = node_sub47.aNpc7583.y;
            node_sub47.anInt7559 = node_sub47.aNpc7583.y + (node_sub47.aNpc7583.getSize((byte)68) << 8);
            Class338.method3913(i, node_sub47, i_4_, i_3_, (byte)54, i_2_);
         }

         for(Node_Sub47 node_sub47 = (Node_Sub47)Class320_Sub3.aHashTable8234.method1516(false);
            node_sub47 != null;
            node_sub47 = (Node_Sub47)Class320_Sub3.aHashTable8234.method1520(69)
         ) {
            int i_8_ = 1;
            RenderDefinitions class259 = node_sub47.aPlayer7573.method868((byte)-125);
            int i_9_ = node_sub47.aPlayer7573.anAnimator10860.getAnimationId();
            if (i_9_ != -1 && !node_sub47.aPlayer7573.aBoolean10867) {
               if (~i_9_ == ~class259.anInt3252 || ~i_9_ == ~class259.anInt3271 || ~class259.anInt3293 == ~i_9_ || i_9_ == class259.anInt3270) {
                  i_8_ = 2;
            ...
            node_sub47.anInt7569 = node_sub47.aPlayer7573.x;
            node_sub47.anInt7582 = node_sub47.aPlayer7573.x + (node_sub47.aPlayer7573.getSize((byte)127) << 8);
            node_sub47.anInt7563 = node_sub47.aPlayer7573.y;
            node_sub47.anInt7559 = node_sub47.aPlayer7573.y - -(node_sub47.aPlayer7573.getSize((byte)62) << 8);
            Class338.method3913(i, node_sub47, i_4_, i_3_, (byte)54, i_2_);
         }
      }
   }
   ...
   final int method3677(int i) {
      ...
      if (i != 0) {
         ...
         return !this.aNode_Sub27_4063.method2697(-66) ? 0 : 1;
      }
   }
   ...
   static final void method3716(boolean bool, int i, boolean bool_11_, int i_12_, IComponentDefinitions[] widgets, int i_13_) {
      ...
      if (bool) {
         for(; ~widgets.length < ~i_14_; ++i_14_) {
            ...
            if (widget != null && ~widget.parentId == ~i_13_) {
               Node_Sub39.method2921(bool_11_, i_12_, 18815, i, widget);
               Node_Sub38_Sub23.adjustWidgetPositions(widget, i, i_12_, -8525);
               if (-widget.width + widget.scrollMaxX < widget.scrollX) {
                  widget.scrollX = -widget.width + widget.scrollMaxX;
               }
               ...
               if (~(widget.scrollMaxY + -widget.height) > ~widget.scrollY) {
                  widget.scrollY = -widget.height + widget.scrollMaxY;
               }
