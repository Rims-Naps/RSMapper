...
public class Class169_Sub1 extends Class169 {
   ...
   final void method1767(int i, byte b, int i_0_, int i_1_, int i_2_) {
      ++anInt8792;
      OpenGL.glFramebufferTexture2DEXT(i_1_, i_0_, i, this.anInt4960, i_2_);
      this.anInt8791 = i_0_;
      int i_3_ = -46 % ((b - -68) / 47);
      this.anInt8786 = i_1_;
   }
   ...
   Class169_Sub1(GLToolkit gltoolkit, int i, int i_8_, boolean bool, byte[][] bs, int i_9_) {
      ...
      for(int i_10_ = 0; ~i_10_ > -7; ++i_10_) {
         OpenGL.glTexImage2Dub(i_10_ + 34069, 0, this.anInt4950, i_8_, i_8_, 0, i_9_, 5121, bs[i_10_], 0);
      }
   ...
   Class169_Sub1(GLToolkit gltoolkit, int i, int i_11_) {
      ...
      this.anInt8793 = i_11_;
      this.aGLToolkit4947.method1444(-2, this);

      for(int i_12_ = 0; i_12_ < 6; ++i_12_) {
         OpenGL.glTexImage2Dub(i_12_ + 34069, 0, this.anInt4950, i_11_, i_11_, 0, Class320_Sub16.method3742(6406, this.anInt4950), 5121, null, 0);
      }
   ...
   public final void method5(int i) {
      OpenGL.glFramebufferTexture2DEXT(this.anInt8786, this.anInt8791, 3553, i, 0);
      ++anInt8789;
      this.anInt8791 = -1;
      this.anInt8786 = -1;
   }
   ...
   Class169_Sub1(GLToolkit gltoolkit, int i, int i_13_, boolean bool, int[][] is) {
      ...
      this.anInt8793 = i_13_;
      this.aGLToolkit4947.method1444(-2, this);
      if (!bool) {
         for(int i_14_ = 0; ~i_14_ > -7; ++i_14_) {
            OpenGL.glTexImage2Di(34069 - -i_14_, 0, this.anInt4950, i_13_, i_13_, 0, 32993, this.aGLToolkit4947.anInt6740, is[i_14_], 0);
         }
      } else {
         for(int i_15_ = 0; ~i_15_ > -7; ++i_15_) {
            Class258.method3124(i_13_, i_15_ + 34069, is[i_15_], 32993, this.anInt4950, i_13_, 1, this.aGLToolkit4947.anInt6740);
         }
      }
