abstract class Class34 {
      ...
      if (i <= 59) {
         ...
         if (model.aByteArray2610 != null) {
            ...
            for(int i_11_ = 0; i_11_ < i_4_; ++i_11_) {
               is_5_[i_11_] = Integer.MAX_VALUE;
               is_6_[i_11_] = -2147483647;
               is_7_[i_11_] = Integer.MAX_VALUE;
               is_8_[i_11_] = -2147483647;
               is_9_[i_11_] = Integer.MAX_VALUE;
            ...
            for(int i_12_ = 0; i_12_ < i_0_; ++i_12_) {
               ...
               if (~model.aByteArray2610[i_13_] != 0) {
                  int i_14_ = 255 & model.aByteArray2610[i_13_];
            ...
            for(int i_19_ = 0; i_19_ < i_4_; ++i_19_) {
               ...
               if (b > 0) {
                  ...
                  fs[i_19_] = Class262_Sub15.method3189(
                     f_21_,
                     f,
                     f_20_,
                     model.aShortArray2613[i_19_],
                     model.aShortArray2604[i_19_],
                     8,
                     Node_Sub30.method2723(model.aByteArray2609[i_19_], 255),
                     model.aShortArray2577[i_19_]
                  );
               }
            }
         }
   ...
   abstract void method368(int var1, int var2);

   abstract int method369(byte var1, int var2);
   ...
   static final void method370(Actor actor, byte b) {
      ...
      for(; i < actor.aClass165Array10886.length; ++i) {
         if (~actor.aClass165Array10886[i].graphicsId != 0) {
               ...
               if (class195.aBoolean2402) {
                  if (class48.anInt698 == 3) {
                     if (actor.anInt10900 > 0
                        && ~Class174.clientCycle <= ~actor.toFirstTileTicketDelay
                        && actor.toSecondTileTicketDelay < Class174.clientCycle) {
                     ...
                     && ~actor.anInt10900 < -1
                     && actor.toFirstTileTicketDelay <= Class174.clientCycle
                     && ~Class174.clientCycle < ~actor.toSecondTileTicketDelay) {
                     continue;
                  }
               }
            }
      ...
      if (animator_25_.method245(-127)) {
         ...
         if (class48.anInt698 == 3) {
            if (~actor.anInt10900 < -1 && actor.toFirstTileTicketDelay <= Class174.clientCycle && Class174.clientCycle > actor.toSecondTileTicketDelay) {
               actor.anIntArray10817 = null;
               animator_25_.method249(true, -1);
               break label86;
            }
         } else if (~class48.anInt698 == -2) {
            if (~actor.anInt10900 < -1 && Class174.clientCycle >= actor.toFirstTileTicketDelay && actor.toSecondTileTicketDelay < Class174.clientCycle) {
   ...
   abstract byte[] method373(int var1, byte var2);

   abstract ReferenceTable method374(byte var1);
}
