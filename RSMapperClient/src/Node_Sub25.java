...
abstract class Node_Sub25 extends Node {
   ...
   static byte[] aByteArray7239 = new byte[32896];
   ...
   final void method2652(int i, OggPacket oggpacket) {
      ...
      this.method2654(18986, oggpacket);
      ++this.anInt7234;
   }
   ...
   static final boolean method2653(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
      ...
      if (i_5_ != 255) {
         return false;
      } else if (!Class99.method1087(i_9_, i_6_, i_10_, i_10_, i_10_, (byte)89, i_11_, i_11_, i_4_, i_4_)) {
         return false;
      } else if (!Class99.method1087(i_9_, i_6_, i_10_, i_10_, i_10_, (byte)89, i_6_, i_11_, i_4_, i_9_)) {
         return false;
      } else {
   ...
   abstract void method2654(int var1, OggPacket var2);

   Node_Sub25(OggStreamState oggstreamstate) {
      this.anOggStreamState7235 = oggstreamstate;
   }
   ...
   abstract void method2656(int var1);
}
