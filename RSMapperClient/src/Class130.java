public class Class130 {
   ...
   static final void cacheSprites(byte b, Index class302, GraphicsToolkit graphicstoolkit) {
      ++anInt1671;
      ...
      DrawMiniMapSprites.aGLSpriteArray312 = new GLSprite[class383s.length];

      for(int i_1_ = 0; ~i_1_ > ~class383s.length; ++i_1_) {
         DrawMiniMapSprites.aGLSpriteArray312[i_1_] = graphicstoolkit.a(class383s[i_1_], true);
      }
      ...
      Node_Sub53.minimapFlagSprites = new GLSprite[class383s.length];

      for(int i_3_ = 0; ~i_3_ > ~class383s.length; ++i_3_) {
         Node_Sub53.minimapFlagSprites[i_3_] = graphicstoolkit.a(class383s[i_3_], true);
      }
      ...
      Node_Sub38_Sub24.minimapEntityIndicatorSprites = new GLSprite[class383s.length];

      for(int i_5_ = 0; i_5_ < class383s.length; ++i_5_) {
         Node_Sub38_Sub24.minimapEntityIndicatorSprites[i_5_] = graphicstoolkit.a(class383s[i_5_], true);
      }
      ...
      class383s = Class383.method4187(class302, OverlayDefinition.anInt3645, 0);
   ...
   public static void method1558(int i) {
      aClass312_1670 = null;
      if (i != -4800) {
         cacheSprites((byte)-117, null, null);
      }
   }
