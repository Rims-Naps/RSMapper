public class Class190 {
   ...
   static final int method1939(int[] is, int i, int i_1_, int[] is_2_, int i_3_, byte[][] bs, byte[] bs_4_, byte[][] bs_5_) {
      ...
      if (~(255 & bs_4_[i_1_]) > ~i_12_) {
         i_12_ = bs_4_[i_1_] & 255;
      }
   ...
   final Class190 method1941(boolean bool) {
      ...
      ++anInt2340;
      return new Class190(this.anInt2335, this.anInt2339, this.anInt2332, this.anInt2337, this.anInt2329, this.anInt2333);
   }
   ...
   final void method1943(byte b, Class190 class190_19_) {
      this.anInt2333 = class190_19_.anInt2333;
      if (b != -106) {
         this.method1941(true);
      }

      this.anInt2332 = class190_19_.anInt2332;
      this.anInt2335 = class190_19_.anInt2335;
      this.anInt2337 = class190_19_.anInt2337;
      this.anInt2329 = class190_19_.anInt2329;
      this.anInt2339 = class190_19_.anInt2339;
      ++anInt2338;
   }
   ...
   private Class190(int i, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_) {
      this.anInt2329 = i_23_;
      this.anInt2339 = i_20_;
      this.anInt2337 = i_22_;
      this.anInt2335 = i;
      this.anInt2332 = i_21_;
      this.anInt2333 = i_24_;
   }
}
