class Node_Sub38_Sub8 extends Node_Sub38 {
   ...
   static float[] aFloatArray10162 = new float[16];
   ...
   static final boolean method2812(int i, boolean bool, int i_0_) {
      ...
      boolean bool_1_ = ~(55 & i_0_) != -1 ? Class303.method3538(i_0_, -128, i) : Node_Sub41.method2932(-125, i, i_0_);
      return bool_1_ | Class278.method3367(i_0_, i, (byte)87) | ~(i & 65536) != -1;
   }
   ...
   int[][] method2778(int i, boolean bool) {
      ...
      if (this.aClass348_7454.aBoolean4300 && this.method2814((byte)80)) {
         int[] is_2_ = is[0];
         int[] is_3_ = is[1];
         int[] is_4_ = is[2];
         int i_5_ = this.anInt10169 * (Node_Sub38_Sub1.anInt10083 == this.anInt10172 ? i : i * this.anInt10172 / Node_Sub38_Sub1.anInt10083);
         if (~this.anInt10169 == ~Class339_Sub7.anInt8728) {
            for(int i_6_ = 0; ~Class339_Sub7.anInt8728 < ~i_6_; ++i_6_) {
               int i_7_ = this.anIntArray10165[i_5_++];
            ...
            for(int i_8_ = 0; ~i_8_ > ~Class339_Sub7.anInt8728; ++i_8_) {
               int i_9_ = this.anInt10169 * i_8_ / Class339_Sub7.anInt8728;
               int i_10_ = this.anIntArray10165[i_9_ + i_5_];
   ...
   final boolean method2814(byte b) {
      if (b < 75) {
         ...
         ++anInt10171;
         if (this.anIntArray10165 != null) {
            return true;
         } else if (~this.anInt10173 <= -1) {
            Class383 class383 = Class230.anInt5209 >= 0
               ? Class383.method4194(Class308.aClass302_3909, Class230.anInt5209, this.anInt10173)
               : Class383.method4191(Class308.aClass302_3909, this.anInt10173);
            class383.method4201();
            this.anIntArray10165 = class383.method4195();
            this.anInt10172 = class383.anInt4900;
            this.anInt10169 = class383.anInt4897;
            return true;
         } else {
            return false;
         }
   ...
   final void method2780(boolean bool, Buffer buffer, int i) {
      ++anInt10164;
      if (!bool && ~i == -1) {
         this.anInt10173 = buffer.readUnsignedShort();
      }
   }
