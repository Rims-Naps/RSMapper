public class Class262_Sub13 extends Class262 {
   ...
   static final void method3183(int i) {
      if (i == 9844) {
         ...
         Class331.anInt4130 = -1;
         Class144_Sub1.anInt6806 = -1;
      }
   }

   Class262_Sub13(Buffer buffer) {
      super(buffer);
      this.anInt7796 = buffer.readUnsignedShort();
      this.anInt7805 = buffer.readUnsignedByte();
      this.anInt7804 = buffer.readUnsignedByte();
      this.anInt7798 = buffer.readUnsignedByte();
   }
   ...
   static final Class170[] method3184(int i) {
      ...
      ++anInt7794;
      return new Class170[]{
         Node_Sub40.aClass170_7508,
         Class46.aClass170_680,
         Class169_Sub2.aClass170_8806,
         Class336_Sub3.aClass170_8613,
         Class96.aClass170_1273,
         Class262_Sub18.aClass170_7850,
         Class350.aClass170_5391,
         Class106.aClass170_1357,
         Class356.aClass170_4425,
         Class270.aClass170_3476
      };
   }

   @Override
   final void method3148(int i) {
      TextureDefinitions.method1033(this.anInt7804, 0, this.anInt7796, this.anInt7798, this.anInt7805, 0);
      ++anInt7799;
      if (i >= -102) {
         anInt7806 = 25;
      }
