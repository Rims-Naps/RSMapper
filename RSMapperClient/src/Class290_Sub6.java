public class Class290_Sub6 extends Class290 {
   ...
   static final int method3438(int i) {
      ...
      if (Class118.anInt5405 == 1) {
         ...
         Class298.aClass298_3712.method3484(new Class108(Class176.index28), i + -13627);
         ...
         Class298.aClass298_3722.method3484(new Class108(Node_Sub38_Sub10.index26), 1000);
         Class298.aClass298_3723.method3484(new Class108(Class4.index2), i ^ 15051);
         Class298.aClass298_3724.method3484(new Class108(Class247.index16), 1000);
         Class298.aClass298_3725.method3484(new Class108(Class14.index17), i + -13627);
         Class298.aClass298_3726.method3484(new Class108(Class174.index18), 1000);
         Class298.aClass298_3727.method3484(new Class108(Class205.index19), i ^ 15051);
         Class298.aClass298_3728.method3484(new Class108(Class262_Sub23.index20), i + -13627);
         Class298.aClass298_3729.method3484(new Class108(Node_Sub15_Sub5.index21), 1000);
         Class298.aClass298_3730.method3484(new Class108(Class127.index22), 1000);
         Class298.aClass298_3731.method3484(new Class108(Node_Sub38_Sub4.index24), 1000);
         Class298.aClass298_3732.method3484(new Class108(Node_Sub18.index25), 1000);
         Class298.aClass298_3733.method3484(new Class108(CacheNode_Sub5.index27), 1000);
         Class298.aClass298_3734.method3484(new Class108(Class262_Sub3.index29), 1000);
         Class298.aClass298_3735.method3484(new Class258(Class250.index10, "huffman"), 1000);
         Class298.aClass298_3736.method3484(new Class108(Class293.index3), 1000);
         Class298.aClass298_3737.method3484(new Class108(Class21.index12), 1000);
         Class298.aClass298_3738.method3484(new Class108(AnimableAnimator_Sub1.index13), i + -13627);
         Class298.aClass298_3739.method3484(new Class88(r_Sub1.index23, "details"), 1000);
      ...
      if (GLToolkit.aClass298Array6403 == null) {
         ...
         for(int i_9_ = 0; ~i_9_ > ~class298s.length; ++i_9_) {
            ...
            int i_11_ = class298.method3483((byte)-106).method35(i ^ -14640);
         ...
         if (bool) {
            if (!((Class45)Class298.aClass298_3717.method3483((byte)-106)).method464(i ^ -14677)) {
