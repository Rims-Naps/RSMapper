public class Class376 {
   ...
   static final void method4118(int i, String string) {
      ...
      if (Class96.anApplet1270 != null) {
         try {
            ...
            if (string.length() == 0) {
               string_3_ = string_3_ + "; Expires=Thu, 01-Jan-1970 00:00:00 GMT; Max-Age=0";
            } else {
               string_3_ = string_3_ + "; Expires=" + Class93.method1043(94608000000L + Class313.method3650(false), i + 9) + "; Max-Age=" + 94608000L;
            }
   ...
   static final void method4119(int i, int i_4_, int i_5_, int i_6_) {
      Class277.tileFlags = RSMapperClient.editor.mapEditor.dataLoaded ? RSMapperClient.editor.mapEditor.flags : new byte[i_6_][i][i_5_];
      ++anInt4658;
      if (i_4_ >= -120) {
         method4118(33, null);
      }
