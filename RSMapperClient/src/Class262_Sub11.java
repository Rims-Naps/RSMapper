public class Class262_Sub11 extends Class262 {
   ...
   Class262_Sub11(Buffer buffer) {
      super(buffer);
      this.anInt7784 = buffer.readUnsignedShort();
      this.anInt7778 = buffer.readUnsignedShort();
   }
   ...
   static final void method3176(int i) {
      ...
      if (Class170.anIntArray2054 == null) {
         ...
         while(~i_3_ > -513) {
            ...
            float f_4_ = 0.0625F + (float)(7 & i_3_) / 8.0F;
   ...
   final void method3148(int i) {
      ...
      Class121.aClass206Array1529[this.anInt7784].method2037(-122).method849(this.anInt7778, -56, true);
   }
   ...
   static final void method3178(int i, int i_22_, Class48 class48) {
      ...
      if (Class23.anInt434 < 50
         ...
         if (!class48.aBoolean699) {
            TextureDefinitions.method1033(i_27_, 0, i_24_, i_26_, 255, 0);
         } else {
