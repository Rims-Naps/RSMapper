...
public class Class339_Sub7 extends Class339 {
   ...
   static final void method3942(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, boolean bool) {
      ...
      for(int i_8_ = 0; ~i_7_ < ~i_8_; ++i_8_) {
         ...
         if (~aa.anInt101 != -4) {
            if (~i_8_ > ~i_6_) {
               ...
               actor = ((Node_Sub41)Class12.aHashTable187.get(3512, (long)Class54.LocalNPCsIndexes[-i_6_ + i_8_])).aNpc7518;
               npcdefinition = ((Npc)actor).definitions;
            ...
            if (~actor.anInt10857 > -1 || actor.anInt10815 != Class110.anInt1412 && Class295.myPlayer.plane != actor.plane) {
               continue;
            }
         } else {
         ...
         if (~Class119.anIntArray1516[0] <= -1) {
            if (actor.method862((byte)-93)) {
               ...
               if (class59 != null && ~Node_Sub37.anInt7445 > ~Node_Sub36_Sub2.anInt10042) {
                  Node_Sub36_Sub2.anIntArray10052[Node_Sub37.anInt7445] = Class262_Sub15_Sub1.aClass357_10524.method4033((byte)-6, class59.method587(-102))
                     / 2;
            ...
            if (!actor.aBoolean10826 && ~Class174.clientCycle > ~actor.anInt10874) {
               int i_10_ = -1;
               int i_11_ = 1;
               if (npcdefinition != null) {
               ...
               if (~i_10_ != 0) {
                  ...
                  if (glsprites_12_ == null) {
                     Class383[] class383s = Class383.method4187(Node_Sub38_Sub39.index8, i_10_, 0);
                     if (class383s != null) {
            ...
            if (!actor.aBoolean10826) {
               if (actor.anInt10835 > Class174.clientCycle) {
                  ...
                  if (i_19_ != -1) {
                     ...
                     if (glsprites == null) {
                        Class383[] class383s = Class383.method4187(Node_Sub38_Sub39.index8, i_19_, 0);
                        if (class383s != null) {
               ...
               if (npcdefinition == null) {
                  ...
                  if (player.skullId != -1) {
                     ...
                     Class362.method4053(
                        i_9_,
                        glsprite.method1186() + i_9_,
                        Class119.anIntArray1516[0] + i_4_ + -12,
                        (byte)107,
                        Class119.anIntArray1516[0] + i_4_ + -12 + glsprite.method1197()
                     );
                     i_9_ -= 2;
                  }
                  ...
                  if (player.prayIconId != -1) {
                     ...
                     Class362.method4053(
                        i_9_,
                        i_9_ + glsprite.method1186(),
                        Class119.anIntArray1516[0] + i_4_ + -12,
                        (byte)-27,
                        -12 + Class119.anIntArray1516[0] + i_4_ - -glsprite.method1197()
                     );
                     i_9_ -= 2;
                  }
               } else if (npcdefinition.headIcon >= 0 && ReferenceTable.aGLSpriteArray284.length > npcdefinition.headIcon) {
                  GLSprite glsprite = ReferenceTable.aGLSpriteArray284[npcdefinition.headIcon];
                  i_9_ -= glsprite.method1176();
                  glsprite.method1196(i_4_ - -Class119.anIntArray1516[0] + -(glsprite.method1193() >> 1), i_9_);
                  Class362.method4053(
                     i_9_,
                     glsprite.method1186() + i_9_,
                     i_4_ + Class119.anIntArray1516[0] - (glsprite.method1193() >> 1),
                     (byte)-48,
                     Class119.anIntArray1516[0] + i_4_ + -(glsprite.method1193() >> 1) - -glsprite.method1197()
                  );
                  i_9_ -= 2;
               }
            }
            ...
            if (actor instanceof Player) {
               if (~i_8_ <= -1) {
                  ...
                  for(int i_27_ = 0; ~class223s.length < ~i_27_; ++i_27_) {
                     ...
                     if (class223 != null && class223.anInt2654 == 10 && class223.anInt2658 == is[i_8_]) {
                        ...
                        Class362.method4053(
                           i_9_ + -glsprite.method1176(),
                           i_9_ - glsprite.method1176() - -glsprite.method1186(),
                           -12 + i_4_ + Class119.anIntArray1516[0],
                           (byte)126,
                           Class119.anIntArray1516[0] + i_4_ - 12 - -glsprite.method1197()
                        );
                     }
               ...
               for(int i_29_ = 0; ~i_29_ > ~class223s.length; ++i_29_) {
                  ...
                  if (class223 != null && class223.anInt2654 == 1 && ~Class54.LocalNPCsIndexes[-i_6_ + i_8_] == ~class223.anInt2658) {
                     GLSprite glsprite = DrawMiniMapSprites.aGLSpriteArray312[class223.anInt2659];
                     ...
                     if (class223.anInt2651 == 0) {
                        ...
                        bool_30_ = ~i_31_ < ~(Class174.clientCycle % (i_31_ * 2));
                     }

                     if (bool_30_) {
                        glsprite.method1196(-12 + Class119.anIntArray1516[0] + i_4_, -glsprite.method1176() + i_9_);
                        Class362.method4053(
                           -glsprite.method1176() + i_9_,
                           -glsprite.method1176() + i_9_ - -glsprite.method1186(),
                           i_4_ - -Class119.anIntArray1516[0] + -12,
                           (byte)118,
                           i_4_ + Class119.anIntArray1516[0] - (12 - glsprite.method1197())
                        );
                     }
                  }
               }
            ...
            for(int i_32_ = 0; ~CacheNode_Sub4.aClass1_9466.anInt117 < ~i_32_; ++i_32_) {
               ...
               if (~(-i_35_ + i_33_) >= ~Class174.clientCycle) {
                  ...
                  if (class255 == null) {
                     ...
                     if (Class119.anIntArray1516[0] > -1) {
                        ...
                        if (i_115_ >= 0 && i_115_ < 255) {
                           ...
                           class52.method538(i_105_ + i_93_, i_109_, string_85_, 0, 1, class255.anInt3229 | 0xFF000000);
                           if (class255_37_ != null) {
                              if (glsprite != null) {
                              ...
                              class52_75_.method538(i_100_ + i_105_, i_112_, string, 0, 1, class255_37_.anInt3229 | 0xFF000000);
                           }
                        }
      ...
      while(~i_122_ > ~Class99.anInt1286) {
         int i_123_ = Class171.anIntArray2070[i_122_];
         Actor actor;
         if (i_123_ < 2048) {
            actor = Class270_Sub2.LOCAL_PLAYERS[i_123_];
         } else {
            actor = ((Node_Sub41)Class12.aHashTable187.get(3512, (long)(-2048 + i_123_))).aNpc7518;
         }
         ...
         if (i_124_ < 2048) {
            ...
            actor_125_ = ((Node_Sub41)Class12.aHashTable187.get(3512, (long)(i_124_ - 2048))).aNpc7518;
         }
      ...
      for(int i_127_ = 0; ~i_127_ > ~Node_Sub37.anInt7445; ++i_127_) {
         ...
         while(bool_131_) {
            ...
            for(int i_132_ = 0; i_127_ > i_132_; ++i_132_) {
               if (~(i_129_ + 2) < ~(-i_126_ + Node_Sub36_Sub2.anIntArray10050[i_132_])
                  && ~(i_129_ + -i_126_) > ~(Node_Sub36_Sub2.anIntArray10050[i_132_] - -2)
                  && ~(Node_Sub36_Sub2.anIntArray10051[i_132_] - -Node_Sub36_Sub2.anIntArray10052[i_132_]) < ~(i_128_ - i_130_)
                  && i_128_ - -i_130_ > Node_Sub36_Sub2.anIntArray10051[i_132_] + -Node_Sub36_Sub2.anIntArray10052[i_132_]
         ...
         if (~Class134_Sub1.anInt9014 == -1) {
            ...
            if (~i_139_ == -8) {
               i_138_ = Class110.anInt1412 % 20 >= 10 ? '\uffff' : 255;
            }

            if (i_139_ == 8) {
               i_138_ = Class110.anInt1412 % 20 >= 10 ? 8454016 : '\uB000';
            }

            if (~i_139_ == -10) {
               int i_140_ = 150
                  + -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte)-66) * 150 / Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1));
               if (~i_140_ > -51) {
            ...
            if (i_139_ == 10) {
               int i_141_ = -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte)-57) * 150 / Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1))
                  + 150;
               if (~i_141_ <= -51) {
                  if (i_141_ < 100) {
            ...
            if (i_139_ == 11) {
               int i_142_ = -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte)-39) * 150 / Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1))
                  + 150;
               if (i_142_ < 50) {
            ...
            if (i_144_ == 3) {
               int i_145_ = 150
                  + -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte)-61) * 150 / Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1));
               i_134_ -= i_133_ >> 1;
               i_137_ += 7;
               i_135_ -= 7;
               i_136_ -= i_133_ >> 1;
            ...
            if (~i_144_ == -5) {
               int i_146_ = -(Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte)-49) * 150 / Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1))
                  + 150;
            ...
            if (~i_144_ == -6) {
               int i_148_ = -(
                     150 * Node_Sub36_Sub2.aClass59Array10044[i_127_].method592((byte)-125) / Node_Sub36_Sub2.aClass59Array10044[i_127_].method585(-1)
                  )
                  + 150;
               int i_149_ = 0;
               if (~i_148_ > -26) {
   ...
   final void method3919(int i, int i_151_, int i_152_) {
      if (this.aBoolean8727) {
         int i_153_ = 1 << (i_152_ & 3);
         float f = (float)(1 << ((62 & i_152_) >> 3)) / 32.0F;
         int i_154_ = 65535 & i_151_;
         float f_155_ = (float)((i_151_ & 199335) >> 16) / 8.0F;
         float f_156_ = (float)(i_151_ >> 19 & 15) / 16.0F;
         float f_157_ = (float)((129960456 & i_151_) >> 23) / 16.0F;
         int i_158_ = (i_151_ & 2099600478) >> 27;
         long l = this.aClass145_8716.aLong1795;
         OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "time"), (float)(this.aGLToolkit4202.anInt6605 * i_153_ % 40000) / 40000.0F);
   ...
   Class339_Sub7(GLToolkit gltoolkit, Class301 class301) {
      super(gltoolkit);
      this.aClass301_8730 = class301;
      if (this.aClass301_8730.aClass169_Sub3_3778 != null && this.aGLToolkit4202.aBoolean6725 && this.aGLToolkit4202.aBoolean6738) {
         ...
         Class210 class210_159_ = Class134.method1568(
         ...
         this.aClass145_8716 = Class290_Sub4.method3431(this.aGLToolkit4202, 0, new Class210[]{class210, class210_159_});
         this.aBoolean8717 = this.aClass145_8716 != null;
      }
   }
   ...
   final void method3923(boolean bool, int i) {
      ++anInt8723;
      if (i == 0) {
         Class169_Sub1 class169_sub1 = this.aGLToolkit4202.method1406((byte)-122);
         if (this.aBoolean8717 && class169_sub1 != null) {
            float f = 1.0F + (1.0F - Math.abs(this.aGLToolkit4202.aFloatArray6664[1])) * 2.0F;
            this.aGLToolkit4202.method1457(33984, 1);
            this.aGLToolkit4202.method1444(-2, class169_sub1);
            this.aGLToolkit4202.method1457(33984, 0);
            this.aGLToolkit4202.method1444(-2, this.aClass301_8730.aClass169_Sub3_3778);
            long l = this.aClass145_8716.aLong1795;
            ...
            OpenGL.glUniform4fARB(
               ...
               f * this.aGLToolkit4202.aFloat6734,
               this.aGLToolkit4202.aFloat6707 * f,
               this.aGLToolkit4202.aFloat6672 * f,
               1.0F
            );
            OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(l, "sunExponent"), 64.0F + 928.0F * Math.abs(this.aGLToolkit4202.aFloatArray6664[1]));
            this.aBoolean8727 = true;
         }
      }
   }
}
