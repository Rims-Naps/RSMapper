public class Class74 {
   ...
   private static final boolean method754(int i) {
      ...
      int i_3_;
      for(int i_2_ = anInt1000; i_1_ >= i_0_; i_1_ = i_3_) {
         anInt1000 = ++i_2_;
         if (i_2_ >= i) {
            return false;
         }

         for(i_3_ = anInt998; i_0_ < anInt995; i_0_ += 4) {
   ...
   private static final void method756(int i, int i_12_) {
      if (i_12_ > i + 4) {
         int i_13_ = i;
         int i_14_ = anIntArray997[i];
         int i_15_ = anIntArray997[i + 1];
         int i_16_ = anIntArray997[i + 2];
         int i_17_ = anIntArray997[i + 3];
