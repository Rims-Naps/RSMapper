public class Node_Sub29_Sub3 extends Node_Sub29 {
   ...
   static final void method2717(int i, boolean bool) {
      Class13.method209(bool, Class320_Sub15.WINDOWS_PANE_ID, -104, Class205.canvasHeight, Class360.canvasWidth);
      if (i != 1) {
         aShort10026 = 59;
      }
   ...
   static final Class371 method2718(int i) {
      ++anInt10025;
      return i != -27615 ? null : Node_Sub23_Sub1.method2638(1, (byte)-77);
   }
   ...
   @Override
   final void setReferencePositionsAndHeight(int i, int i_73_, int i_74_, int i_75_) {
      this.referenceX = i_73_;
      this.referenceY = i_74_;
      if (i != 4752) {
         aShort10026 = -106;
      }
