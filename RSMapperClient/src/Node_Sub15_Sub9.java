public class Node_Sub15_Sub9 extends Node_Sub15 {
   ...
   static final void method2576(byte b, int i, int i_0_) {
      ++anInt9841;
      if (b == 26) {
         CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(b ^ 25, 7, (long)i_0_);
   ...
   final void method2556(ClanChat clanchat, int i) {
      ...
      clanchat.method504(this.anInt9837, this.anInt9840, this.anInt9835, this.anInt9834, 11226);
      ++anInt9833;
   }
   ...
   final void method2554(int i, Buffer buffer) {
      ++anInt9836;
      this.anInt9834 = buffer.readInt();
      this.anInt9835 = buffer.readInt();
      this.anInt9840 = buffer.readUnsignedByte();
      this.anInt9837 = buffer.readUnsignedByte();
      if (i != 29147) {
