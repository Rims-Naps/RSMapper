public class Class262_Sub18 extends Class262 {
   ...
   final void method3148(int i) {
      Class194_Sub1.aClass331Array6894[this.anInt7845].method3840(0, 2);
      ++anInt7840;
      Class194_Sub1.aClass331Array6894[this.anInt7847].method3840(1, 2);
      Node_Sub6.anInt7056 = this.anInt7841;
      Class109.anInt1367 = 0;
      Class203.anInt2452 = 1;
      Class320_Sub22.anInt8415 = 3;
      Class141.anInt1758 = 0;
      Class66_Sub2_Sub1.anInt10582 = this.anInt7846;
      Class290_Sub5.anInt8107 = this.anInt7844;
      if (i >= -102) {
         this.anInt7841 = -102;
      }

      Class221.anInt2633 = this.anInt7848;
   ...
   Class262_Sub18(Buffer buffer) {
      super(buffer);
      this.anInt7845 = buffer.readUnsignedShort();
      this.anInt7847 = buffer.readUnsignedShort();
      this.anInt7844 = buffer.readUnsignedShort();
      this.anInt7846 = buffer.readUnsignedShort();
      this.anInt7841 = buffer.readUnsignedShort();
      this.anInt7848 = buffer.readUnsignedShort();
   }
}
