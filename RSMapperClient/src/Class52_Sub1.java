...
public class Class52_Sub1 extends Class52 {
   ...
   Class52_Sub1(AbstractToolkit abstracttoolkit, Class357 class357, Class383[] class383s, boolean bool) {
      ...
      this.anAbstractToolkit5561 = abstracttoolkit;
      int i = 0;
      ...
      if (bool) {
         ...
         if (abstracttoolkit.method1295(Node_Sub52.aClass68_7639, Class372.aClass372_4594, 1)) {
            this.anInterface13_Impl1_5560 = abstracttoolkit.method1252(i_1_, bs, Node_Sub52.aClass68_7639, i_1_, (byte)-3, false);
         } else {
            ...
            this.anInterface13_Impl1_5560 = abstracttoolkit.method1258(false, i_1_, true, i_1_, is);
         }

         this.aBoolean5559 = true;
      } else {
            ...
            if (bs != null) {
               for(int i_25_ = 0; i_25_ < i_19_; ++i_25_) {
                  for(int i_26_ = 0; i_26_ < i_20_; ++i_26_) {
                     is[i_23_++] = bs[i_24_] << 24 | is_17_[bs_18_[i_24_] & 255];
                     ++i_24_;
                  }
               ...
               for(int i_27_ = 0; i_27_ < i_19_; ++i_27_) {
                  for(int i_28_ = 0; i_28_ < i_20_; ++i_28_) {
                     ...
                     if ((i_29_ = bs_18_[i_24_++]) != 0) {
                        is[i_23_++] = 0xFF000000 | is_17_[i_29_ & 0xFF];
                     } else {
                        ++i_23_;
                     }
                  }
         ...
         this.anInterface13_Impl1_5560 = abstracttoolkit.method1258(false, i_1_, true, i_1_, is);
         this.aBoolean5559 = false;
      }

      this.anInterface13_Impl1_5560.method41((byte)-114, Class194.aClass228_2377);
      this.anInterface15_Impl2_5562 = abstracttoolkit.method1380(2, false);
      this.anInterface15_Impl2_5562.method37(20, 20480, -12093);

      for(int i_30_ = 0; i_30_ < 4; ++i_30_) {
         jaclib.memory.Buffer buffer = this.anInterface15_Impl2_5562.method40(-12, true);
         if (buffer != null) {
            Stream stream = this.anAbstractToolkit5561.method1324(true, buffer);
            float f = this.anInterface13_Impl1_5560.method45((float)i_1_, -51) / (float)i_1_;
            float f_31_ = this.anInterface13_Impl1_5560.method49((float)i_1_, (byte)-47) / (float)i_1_;
            ...
            stream.c();
            if (this.anInterface15_Impl2_5562.method39(-95)) {
               break;
            }
         }
      }
   ...
   @Override
   final void fa(char c, int x, int y, int color, boolean bool) {
      this.anAbstractToolkit5561.method1288(0);
      this.anAbstractToolkit5561.method1312((byte)-21, this.anInterface13_Impl1_5560);
      if (!this.aBoolean5559 && !bool) {
         this.anAbstractToolkit5561.method1318(-30, Class117_Sub1.aClass94_4924, Class117_Sub1.aClass94_4924);
      } else {
         this.anAbstractToolkit5561.method1318(-30, Class116.aClass94_5075, Class117_Sub1.aClass94_4924);
         this.anAbstractToolkit5561.method1304(0, 0, InterfaceSettings.aClass135_7421);
         this.anAbstractToolkit5561.method1336(-2, color);
      }

      Class336_Sub1 class336_sub1 = this.anAbstractToolkit5561.method1264(false);
      class336_sub1.method3854(x, y, 0);
      this.anAbstractToolkit5561.method1266((byte)120);
      this.anAbstractToolkit5561.method1354(0, 32011, this.anInterface15_Impl2_5562);
      this.anAbstractToolkit5561.method1338(this.anAbstractToolkit5561.aClass213_6373, 9422);
      this.anAbstractToolkit5561.method1303(Class169_Sub3.aClass104_8818, 66, c * 4, 2);
      if (this.aBoolean5559 || bool) {
         this.anAbstractToolkit5561.method1304(0, 0, Class106.aClass135_1354);
      }
   }
}
