public class Class300 {
   ...
   final Class355 method3495(int i) {
      if (i != 99999999) {
         this.method3502(false, -4, 3, 47);
      }

      ++anInt3773;
      return NpcDefinition.method3008((byte)-111, this.anInt3755);
   }
   ...
   static final Class234 method3498(int i) {
      ...
      try {
         ...
         try {
            ...
            return i != 4 ? null : new Class234_Sub1();
         }
      }
   }
   ...
   final Class300 method3502(boolean bool, int i, int i_3_, int i_4_) {
      ...
      ++anInt3765;
      return new Class300(this.anInt3755, i, i_3_, i_4_, this.aByte3768);
   }
