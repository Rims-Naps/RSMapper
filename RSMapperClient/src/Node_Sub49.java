public class Node_Sub49 extends Node {
   ...
   static final Node_Sub49 method2954(Index class302, int i) {
      if (!method2961(class302)) {
         ...
         return bs == null ? null : new Node_Sub49(bs);
      }
   }

   private final void method2955(byte[] bs) {
      Buffer buffer = new Buffer(bs);
      this.anInt7602 = buffer.readInt();
      this.anInt7614 = buffer.readInt();
      this.anInt7615 = buffer.readInt();
      this.anInt7597 = buffer.readInt();
      if (this.anInt7597 < 0) {
         this.anInt7597 = ~this.anInt7597;
         this.aBoolean7596 = true;
      }

      int i = buffer.readInt();
      this.aByteArrayArray7616 = new byte[i][];
      ...
      for(int i_0_ = 0; i_0_ < i; ++i_0_) {
         ...
         this.aByteArrayArray7616[i_0_] = bs_3_;
      }
   }
   ...
   static final int method2956(int i) {
      ...
      int i_5_;
      int i_6_;
      for(i_5_ = 0; i >= 8 - anInt7593; i -= i_6_) {
         i_6_ = 8 - anInt7593;
         int i_7_ = (1 << i_6_) - 1;
   ...
   final Node_Sub45_Sub1 method2958(int[] is) {
      if (is != null && is[0] <= 0) {
         ...
         if (this.aByteArray7621 == null) {
            this.anInt7619 = 0;
            this.aFloatArray7617 = new float[anInt7613];
            this.aByteArray7621 = new byte[this.anInt7614];
            this.anInt7620 = 0;
            this.anInt7622 = 0;
         }

         for(; this.anInt7622 < this.aByteArrayArray7616.length; ++this.anInt7622) {
            if (is != null && is[0] <= 0) {
               return null;
            }

            float[] fs = this.method2959(this.anInt7622);
            if (fs != null) {
               int i = this.anInt7620;
               int i_8_ = fs.length;
               if (i_8_ > this.anInt7614 - i) {
                  i_8_ = this.anInt7614 - i;
               }
               ...
               for(int i_9_ = 0; i_9_ < i_8_; ++i_9_) {
                  ...
                  this.aByteArray7621[i++] = (byte)(i_10_ - 128);
               }

               if (is != null) {
                  is[0] -= i - this.anInt7620;
               }
         ...
         this.aFloatArray7617 = null;
         byte[] bs = this.aByteArray7621;
         this.aByteArray7621 = null;
         return new Node_Sub45_Sub1(this.anInt7602, bs, this.anInt7615, this.anInt7597, this.aBoolean7596);
      }
   }

   private final float[] method2959(int i) {
      method2964(this.aByteArrayArray7616[i], 0);
      method2965();
      ...
      if (bool_24_) {
         ...
         for(int i_80_ = i_16_; i_80_ < i_17_; ++i_80_) {
            float f = (float)Math.sin(((double)(i_80_ - i_16_) + 0.5) / (double)i_18_ * 0.5 * Math.PI);
            aFloatArray7601[i_80_] *= (float)Math.sin((Math.PI / 2) * (double)f * (double)f);
         }

         for(int i_81_ = i_19_; i_81_ < i_20_; ++i_81_) {
            float f = (float)Math.sin(((double)(i_81_ - i_19_) + 0.5) / (double)i_21_ * 0.5 * Math.PI + (Math.PI / 2));
            aFloatArray7601[i_81_] *= (float)Math.sin((Math.PI / 2) * (double)f * (double)f);
         }
      }

      float[] fs = null;
      if (this.anInt7619 > 0) {
         int i_82_ = this.anInt7619 + i_12_ >> 2;
         fs = new float[i_82_];
         if (!this.aBoolean7591) {
            for(int i_83_ = 0; i_83_ < this.anInt7595; ++i_83_) {
               int i_84_ = (this.anInt7619 >> 1) + i_83_;
               fs[i_83_] += this.aFloatArray7617[i_84_];
            }
         }
      ...
      float[] fs_87_ = this.aFloatArray7617;
      this.aFloatArray7617 = aFloatArray7601;
      aFloatArray7601 = fs_87_;
      this.anInt7619 = i_12_;
      this.anInt7595 = i_20_ - (i_12_ >> 1);
      this.aBoolean7591 = bool_24_;
      return fs;
   }
   ...
   private static final void method2960(byte[] bs) {
      ...
      for(int i = 0; i < 2; ++i) {
         ...
         for(int i_92_ = 0; i_92_ < i_90_; ++i_92_) {
            fs[2 * i_92_] = (float)Math.cos((double)(4 * i_92_) * Math.PI / (double)i_88_);
            fs[2 * i_92_ + 1] = -((float)Math.sin((double)(4 * i_92_) * Math.PI / (double)i_88_));
         }

         float[] fs_93_ = new float[i_89_];

         for(int i_94_ = 0; i_94_ < i_90_; ++i_94_) {
            fs_93_[2 * i_94_] = (float)Math.cos((double)(2 * i_94_ + 1) * Math.PI / (double)(2 * i_88_));
            fs_93_[2 * i_94_ + 1] = (float)Math.sin((double)(2 * i_94_ + 1) * Math.PI / (double)(2 * i_88_));
         }

         float[] fs_95_ = new float[i_90_];

         for(int i_96_ = 0; i_96_ < i_91_; ++i_96_) {
            fs_95_[2 * i_96_] = (float)Math.cos((double)(4 * i_96_ + 2) * Math.PI / (double)i_88_);
            fs_95_[2 * i_96_ + 1] = -((float)Math.sin((double)(4 * i_96_ + 2) * Math.PI / (double)i_88_));
         }
   ...
   private static final boolean method2961(Index class302) {
      if (!aBoolean7600) {
         byte[] bs = class302.getFile(false, 0, 0);
         if (bs == null) {
            return false;
         }
   ...
   static final Node_Sub49 method2962(Index class302, int i, int i_110_) {
      if (!method2961(class302)) {
         ...
         byte[] bs = class302.getFile(false, i_110_, i);
         return bs == null ? null : new Node_Sub49(bs);
      }
   }

   static final float method2963(int i) {
      int i_111_ = i & 2097151;
      int i_112_ = i & -2147483648;
      int i_113_ = (i & 2145386496) >> 21;
      if (i_112_ != 0) {
         i_111_ = -i_111_;
      }
   ...
   static final int method2965() {
      int i = aByteArray7592[anInt7610] >> anInt7593 & 1;
      ++anInt7593;
