public class Class262_Sub1 extends Class262 {
   ...
   final void method3148(int i) {
      ...
      Class121.aClass206Array1529[this.anInt7699].method2037(-67).method864(this.anInt7700, this.aString7698, false, 0, this.anInt7701);
      ++anInt7697;
   }
   ...
   Class262_Sub1(Buffer buffer) {
      super(buffer);
      this.anInt7699 = buffer.readUnsignedShort();
      this.aString7698 = buffer.readString();
      this.anInt7701 = buffer.readInt();
      this.anInt7700 = buffer.readUnsignedShort();
   }

   static final void method3150(int i, Player player, int i_0_, int i_1_, Npc npc, ObjectDefinition objectdefinition, int rotation) {
      ++anInt7703;
      ...
      if (objectdefinition == null) {
         if (npc != null) {
            ...
            if (npcdefinition != null) {
               node_sub47.anInt7582 = npcdefinition.size + i_0_ << 9;
               node_sub47.anInt7559 = i_1_ - -npcdefinition.size << 9;
         ...
         int i_3_ = objectdefinition.sizeX;
         int i_4_ = objectdefinition.sizeY;
         if (rotation == 1 || rotation == 3) {
            i_4_ = objectdefinition.sizeX;
            i_3_ = objectdefinition.sizeY;
         }
         ...
         node_sub47.anInt7572 = objectdefinition.mapSpriteOffset2;
         ...
         node_sub47.anInt7571 = objectdefinition.mapSpriteOffset1;
   ...
   static final void method3151(
      float[] fs, float f, int i, int i_5_, int i_6_, float[] fs_7_, float f_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_
   ) {
      i_5_ -= i_13_;
      i_12_ -= i;
      if (i_10_ != -2356) {
      ...
      float f_17_ = (float)Math.atan2((double)f_14_, (double)f_16_) / (float) (Math.PI * 2) + 0.5F;
      if (f_8_ != 1.0F) {
         f_17_ *= f_8_;
      }
