public class Class262_Sub2 extends Class262 {
   ...
   Class262_Sub2(Buffer buffer) {
      super(buffer);
      this.anInt7706 = buffer.readUnsignedShort();
   }

   static final void method3153(
      int i, int i_0_, int i_1_, int i_2_, Class77 class77, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, Class379 class379, int i_8_
   ) {
   ...
   static final boolean method3155(int i, byte b) {
      ...
      ++anInt7710;
      return ~i == -3 || i == 22 || i == 52 || i == 30 || i == 53 || i == 9 || i == 51 || i == 15 || i == 48 || ~i == -17 || ~i == -45;
   }
   ...
   final void method3148(int i) {
      ...
      Node_Sub39.aClass369Array7497[this.anInt7706].method4082((byte)-115);
   }
}
