...
public class Class167 {
   ...
   final boolean method1749(byte b, float f, Class169_Sub3 class169_sub3, Class169_Sub3 class169_sub3_3_) {
      ++anInt2040;
      if (!this.method1751(80)) {
         return false;
      } else {
         Class382 class382 = this.aGLToolkit2036.aClass382_6701;
         CacheNode_Sub17 cachenode_sub17 = new CacheNode_Sub17(this.aGLToolkit2036, 6408, class169_sub3.anInt8819, class169_sub3.anInt8809);
         int i = 12 % ((b - 37) / 63);
         boolean bool = false;
         this.aGLToolkit2036.method1410(15, class382);
         ...
         if (class382.method4180(10785)) {
            ...
            OpenGL.glUseProgramObjectARB(this.aClass145_2035.aLong1795);
            OpenGL.glUniform1iARB(OpenGL.glGetUniformLocationARB(this.aClass145_2035.aLong1795, "heightMap"), 0);
            OpenGL.glUniform1fARB(OpenGL.glGetUniformLocationARB(this.aClass145_2035.aLong1795, "rcpRelief"), 1.0F / f);
            OpenGL.glUniform2fARB(
               OpenGL.glGetUniformLocationARB(this.aClass145_2035.aLong1795, "sampleSize"),
               1.0F / (float)class169_sub3_3_.anInt8819,
               1.0F / (float)class169_sub3_3_.anInt8809
            );

            for(int i_4_ = 0; i_4_ < class169_sub3.anInt8811; ++i_4_) {
               float f_5_ = (float)i_4_ / (float)class169_sub3.anInt8811;
               this.aGLToolkit2036.method1444(-2, class169_sub3_3_);
               OpenGL.glBegin(7);
         ...
         this.aGLToolkit2036.method1436(class382, (byte)45);
         return bool;
      }
   }
   ...
   final boolean method1751(int i) {
      if (this.aGLToolkit2036.aBoolean6719 && this.aGLToolkit2036.aBoolean6738 && this.aClass145_2035 == null) {
         ...
         if (class210 != null) {
            this.aClass145_2035 = Class290_Sub4.method3431(this.aGLToolkit2036, 0, new Class210[]{class210});
         }
      }
      ...
      if (i < 34) {
         ...
         return this.aClass145_2035 != null;
      }
   }
