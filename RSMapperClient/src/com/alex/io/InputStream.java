...
public final class InputStream extends Stream {
   ...
   public int readShort128() {
      int i = (this.readUnsignedByte() << 8) + (this.readByte() - 128 & 0xFF);
      if (i > 32767) {
         i -= 65536;
      }
   ...
   public int readShortLE128() {
      int i = (this.readByte() - 128 & 0xFF) + (this.readUnsignedByte() << 8);
      if (i > 32767) {
         i -= 65536;
      }
   ...
   public int read128ShortLE() {
      int i = (128 - this.readByte() & 0xFF) + (this.readUnsignedByte() << 8);
      if (i > 32767) {
         i -= 65536;
      }
   ...
   public int readUnsignedShortLE128() {
      return (this.readByte() - 128 & 0xFF) + (this.readUnsignedByte() << 8);
   }
   ...
   public int readSmart3() {
      int i_13_ = this.buffer[this.offset] & 255;
      return i_13_ < 128 ? this.readUnsignedByte() - 64 : this.readUnsignedShort() - 49152;
   }

   public int readSmart() {
      int i_93_ = this.buffer[this.offset] & 255;
      return i_93_ < 128 ? this.readUnsignedByte() - 1 : this.readUnsignedShort() - 32769;
   }
