public class Class339_Sub8 extends Class339 {
   ...
   static final void method3944(int i, int i_0_) {
      ...
      ++anInt8740;
      CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(i ^ 12003, 3, (long)i_0_);
   ...
   final void method3918(int i) {
      ...
      this.aGLToolkit4202.method1483(false, 1028);
      ++anInt8737;
   }

   @Override
   final void method3923(boolean bool, int i) {
      this.aGLToolkit4202.method1483(true, 1028);
      if (i == 0) {
         ++anInt8741;
      }
   }
   ...
   final void method3917(Class169 class169, int i, int i_2_) {
      ++anInt8731;
      this.aGLToolkit4202.method1444(i_2_ + 28287, class169);
