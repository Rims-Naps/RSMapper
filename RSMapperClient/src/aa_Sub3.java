public class aa_Sub3 extends aa {
   ...
   static final int method160(int i) {
      ...
      if (Class291.anIntArray3665 == null) {
         ...
         return i != -5573 ? 103 : 2 * Class291.anIntArray3665.length;
      }
   }
   ...
   static final void method162(int i, int i_0_, byte[] bs, int i_1_, int i_2_, int i_3_, byte[] bs_4_, int i_5_, int i_6_) {
      ...
      for(int i_8_ = -i_1_; ~i_8_ > -1; ++i_8_) {
         for(int i_9_ = i_7_; i_9_ < 0; ++i_9_) {
            int var10001 = i_2_++;
            bs[var10001] = (byte)(bs[var10001] + -bs_4_[i_0_++]);
            var10001 = i_2_++;
            bs[var10001] = (byte)(bs[var10001] + -bs_4_[i_0_++]);
            var10001 = i_2_++;
            bs[var10001] = (byte)(bs[var10001] + -bs_4_[i_0_++]);
         ...
         for(int i_10_ = i_5_; ~i_10_ > -1; ++i_10_) {
            int var23 = i_2_++;
            bs[var23] = (byte)(bs[var23] + -bs_4_[i_0_++]);
         }
   ...
   aa_Sub3(GLToolkit gltoolkit, int i, int i_11_, byte[] bs) {
      this.aClass169_Sub2_Sub1_5494 = Class320_Sub21.method3761(i_11_, 6406, 8222, bs, 6406, gltoolkit, i, false);
      this.aClass169_Sub2_Sub1_5494.method1776(false, 126, false);
   }
}
