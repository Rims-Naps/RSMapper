public class Node_Sub38_Sub5 extends Node_Sub38 {
   ...
   static Class228 aClass228_10123 = new Class228();
   ...
   static boolean aBoolean10130 = false;
   static int[] anIntArray10131 = new int[]{16, 32, 64, 128};
   ...
   public Node_Sub38_Sub5() {
      super(1, false);
      this.anIntArray10127 = new int[3];
      this.anInt10122 = 4096;
   }
      ...
      if (!bool) {
         ...
         if (this.aClass348_7454.aBoolean4300) {
            ...
            for(int i_9_ = 0; ~Class339_Sub7.anInt8728 < ~i_9_; ++i_9_) {
               ...
               int i_11_ = -this.anIntArray10127[0] + i_10_;
               if (~i_11_ > -1) {
                  i_11_ = -i_11_;
               }

               if (i_11_ > this.anInt10129) {
                  is_6_[i_9_] = i_10_;
                  is_7_[i_9_] = is_4_[i_9_];
                  is_8_[i_9_] = is_5_[i_9_];
               } else {
                  int i_12_ = is_4_[i_9_];
                  i_11_ = -this.anIntArray10127[1] + i_12_;
                  if (~i_11_ > -1) {
                     i_11_ = -i_11_;
                  }
                  ...
                  if (~i_11_ < ~this.anInt10129) {
                     ...
                     i_11_ = i_13_ - this.anIntArray10127[2];
                     if (i_11_ < 0) {
                        i_11_ = -i_11_;
                     }

                     if (this.anInt10129 < i_11_) {
                        is_6_[i_9_] = i_10_;
                        is_7_[i_9_] = i_12_;
                        is_8_[i_9_] = i_13_;
                     } else {
                        is_6_[i_9_] = i_10_ * this.anInt10121 >> 12;
                        is_7_[i_9_] = this.anInt10126 * i_12_ >> 12;
                        is_8_[i_9_] = i_13_ * this.anInt10122 >> 12;
                     }
                  }
               }
            }
   ...
   static final void method2802(int i, boolean bool, int i_14_, int i_15_, int i_16_) {
      ...
      WorldmapDefinitions.method282(i);
      if (i_16_ != -11493) {
         aBoolean10125 = false;
      }
   }
            ...
            if (i != 2) {
               if (i != 3) {
                  if (i == 4) {
                     ...
                     this.anIntArray10127[1] = Node_Sub30.method2723(i_18_ >> 4, 4080);
                     this.anIntArray10127[2] = Node_Sub30.method2723(i_18_, 255) >> 12;
                     this.anIntArray10127[0] = Node_Sub30.method2723(i_18_, 16711680) << 4;
                  }
               } else {
                  this.anInt10121 = buffer.readUnsignedShort();
               }
            } else {
               this.anInt10126 = buffer.readUnsignedShort();
            }
         } else {
            this.anInt10122 = buffer.readUnsignedShort();
         }
      } else {
         this.anInt10129 = buffer.readUnsignedShort();
      }
