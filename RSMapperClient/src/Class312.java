public class Class312 {
   ...
   static IncommingPacket aClass192_3966 = new IncommingPacket(82, 6);
   static int anInt3967;
   static int[] anIntArray3968 = new int[]{16776960, 16711680, 65280, 65535, 16711935, 16777215};
   static int anInt3969;
   private Node aNode3970;
   static int anInt3971;
   static int anInt3972;
   static OutgoingPacket aClass318_3973 = new OutgoingPacket(46, 3);
   static int anInt3974;
   static int anInt3975;
   static OutgoingPacket aClass318_3976 = new OutgoingPacket(87, 6);
   ...
   final void method3611(Node node, int i) {
      ...
      node.aNode2800 = this.aNode3958.aNode2800;
      if (i > -61) {
         aBoolean3960 = true;
      }

      node.aNode2799 = this.aNode3958;
   ...
   final Node method3613(int i) {
      ++anInt3957;
      Node node = this.aNode3958.aNode2800;
      if (i != 65280) {
         this.aNode3970 = null;
      }

      if (node == this.aNode3958) {
         this.aNode3970 = null;
         return null;
      } else {
         this.aNode3970 = node.aNode2800;
         return node;
      }
   }
   ...
   final int method3615(int i) {
      ...
      for(Node node = this.aNode3958.aNode2800; node != this.aNode3958; ++i_2_) {
         node = node.aNode2800;
      }
   ...
   final boolean method3616(int i) {
      ...
      ++anInt3972;
      return this.aNode3958 == this.aNode3958.aNode2800;
   }

   private final void method3617(Node node, Class312 class312_3_, byte b) {
      ++anInt3967;
      Node node_4_ = this.aNode3958.aNode2799;
      this.aNode3958.aNode2799 = node.aNode2799;
      int i = 32 % ((48 - b) / 57);
      node.aNode2799.aNode2800 = this.aNode3958;
      if (node != this.aNode3958) {
   ...
   final void method3621(int i, Class312 class312_6_) {
      this.method3617(this.aNode3958.aNode2800, class312_6_, (byte)-75);
      ++anInt3961;
      if (i != -2869) {
         aClass318_3976 = null;
      }
   ...
   final Node method3622(byte b) {
      ...
      ++anInt3959;
      Node node = this.aNode3958.aNode2799;
      if (node == this.aNode3958) {
         this.aNode3970 = null;
         return null;
      } else {
         this.aNode3970 = node.aNode2799;
         return node;
      }
   }
   ...
   static final Class244[] method3624(int i) {
      ...
      if (Node_Sub52.aClass244Array7654 == null) {
         ...
         for(int i_10_ = 0; i_10_ < class244s.length; ++i_10_) {
            ...
            if ((~class244.anInt3079 >= -1 || ~class244.anInt3079 <= -25)
               && ~class244.anInt3084 <= -801
               && ~class244.anInt3078 <= -601
               && (i_9_ != 2 || ~class244.anInt3084 >= -801 && ~class244.anInt3078 >= -601)
               && (i_9_ != 1 || ~class244.anInt3084 >= -1025 && class244.anInt3078 <= 768)) {
   ...
   public Class312() {
      this.aNode3958.aNode2800 = this.aNode3958;
      this.aNode3958.aNode2799 = this.aNode3958;
   }
   ...
   final void method3625(byte b, Node node) {
      ...
      ++anInt3964;
      node.aNode2800 = this.aNode3958;
      if (b != -54) {
         this.method3615(-84);
      }

      node.aNode2799 = this.aNode3958.aNode2799;
      node.aNode2799.aNode2800 = node;
      node.aNode2800.aNode2799 = node;
   }
}
