public class Class90 {
   ...
   private static final void method1024(Class231 class231) {
      ...
      while(bool_22_) {
         ...
         int var44 = method1031(class231);
         class231.anInt2737 = class231.anInt2737 << 8 | var44 & 255;
         var44 = method1031(class231);
         class231.anInt2737 = class231.anInt2737 << 8 | var44 & 255;
         ...
         for(int i_34_ = 0; i_34_ < i_30_; ++i_34_) {
            ...
            byte b_36_;
            for(b_36_ = bs[b_35_]; b_35_ > 0; --b_35_) {
               bs[b_35_] = bs[b_35_ - 1];
            }
         ...
         for(int i_40_ = 0; i_40_ < i_29_; ++i_40_) {
            ...
            method1025(
               class231.anIntArrayArray2754[i_40_],
               class231.anIntArrayArray2762[i_40_],
               class231.anIntArrayArray2768[i_40_],
               class231.aByteArrayArray2748[i_40_],
               i_41_,
               b_42_,
               i_28_
            );
         ...
         b_33_ = (byte)(class231.anInt2755 + 1);
         int i_45_ = -1;
         int i_46_ = 0;
         ...
         int i_54_;
         int i_55_;
         for(i_55_ = method1028(i, class231); i_55_ > is[i_53_]; i_55_ = i_55_ << 1 | i_54_) {
            ++i_53_;
         ...
         while(i_56_ != b_33_) {
            if (i_56_ != 0 && i_56_ != 1) {
               ...
               if (i_60_ < 16) {
                  ...
                  for(b = class231.aByteArray2758[i_61_ + i_60_]; i_60_ > 3; i_60_ -= 4) {
                  ...
                  for(b = class231.aByteArray2758[i_65_]; i_65_ > class231.anIntArray2746[i_63_]; --i_65_) {
               ...
               class231.anIntArray2735[class231.aByteArray2765[b & 255] & 255]++;
               Class55.anIntArray834[i_51_] = class231.aByteArray2765[b & 255] & 255;
               ++i_51_;
               if (i_46_ == 0) {
                  ++i_45_;
                  i_46_ = 50;
               ...
               ++i_57_;
               var44 = class231.aByteArray2765[class231.aByteArray2758[class231.anIntArray2746[0]] & 255];

               for(class231.anIntArray2735[var44 & 255] += i_57_; i_57_ > 0; --i_57_) {
                  Class55.anIntArray834[i_51_] = var44 & 255;
                  ++i_51_;
               }
            }
         }
         ...
         for(int i_72_ = 0; i_72_ < i_51_; ++i_72_) {
            var44 = (byte)(Class55.anIntArray834[i_72_] & 0xFF);
            Class55.anIntArray834[class231.anIntArray2763[var44 & 255]] |= i_72_ << 8;
            class231.anIntArray2763[var44 & 255]++;
         }
   ...
   private static final int method1028(int i, Class231 class231) {
      while(class231.anInt2767 < i) {
         class231.anInt2739 = class231.anInt2739 << 8 | class231.aByteArray2745[class231.anInt2744] & 255;
