public class Class66_Sub1 extends Class66 {
   ...
   static Class257 aClass257_8984 = new Class257(7, 2);
   ...
   final void method719(boolean bool, int i, byte b, int i_4_) {
      Class93.aGraphicsToolkit1241
         .d(i + -2, i_4_, this.aClass150_5171.anInt5086 + 4, this.aClass150_5171.anInt5081 + 2, ((Class150_Sub2)this.aClass150_5171).anInt8958, 0);
      ++anInt8986;
      if (b == -16) {
         Class93.aGraphicsToolkit1241.d(-1 + i, i_4_ - -1, 2 + this.aClass150_5171.anInt5086, this.aClass150_5171.anInt5081, 0, 0);
      }
   }
   ...
   final void method721(int i, int i_5_, boolean bool, int i_6_) {
      ...
      ++anInt8982;
      int i_8_ = this.method720(100) * this.aClass150_5171.anInt5086 / 10000;
      Class93.aGraphicsToolkit1241.aa(i, 2 + i_6_, i_8_, this.aClass150_5171.anInt5081 - 2, ((Class150_Sub2)this.aClass150_5171).anInt8959, 0);
      Class93.aGraphicsToolkit1241.aa(i + i_8_, 2 + i_6_, -i_8_ + this.aClass150_5171.anInt5086, -2 + this.aClass150_5171.anInt5081, 0, 0);
   }
}
