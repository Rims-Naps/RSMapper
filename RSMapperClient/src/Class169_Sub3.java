...
public class Class169_Sub3 extends Class169 {
   ...
   static final void method1779(GraphicsToolkit graphicstoolkit, String string, boolean bool, Class357 class357, Class52 class52, int i) {
      ...
      if (bool_4_) {
         if (Class262_Sub16.aBoolean7830 && bool_4_) {
            ...
            graphicstoolkit.a(Class44.aClass383_667, false)
               .method1183(
                  Class223.aClass383_2664.anInt4897 + i_9_,
                  Class223.aClass383_2664.anInt4900 + i_10_,
                  i_5_ + -(Class223.aClass383_2664.anInt4897 * 2),
                  i_6_ + -(2 * Class223.aClass383_2664.anInt4900),
                  1,
                  0,
                  0
               );
            ...
            Class223.aClass383_2664.method4189();
            graphicstoolkit.a(Class336_Sub3.aClass383_8624, true)
               .method1192(i_9_, Class223.aClass383_2664.anInt4900 + i_10_, i_7_, -(Class223.aClass383_2664.anInt4900 * 2) + i_6_);
            Class336_Sub3.aClass383_8624.method4198();
            graphicstoolkit.a(Class336_Sub3.aClass383_8624, true)
               .method1192(Class223.aClass383_2664.anInt4897 + i_9_, i_10_, -(Class223.aClass383_2664.anInt4897 * 2) + i_5_, i_7_);
            Class336_Sub3.aClass383_8624.method4198();
            graphicstoolkit.a(Class336_Sub3.aClass383_8624, true)
               .method1192(-i_7_ + i_5_ + i_9_, Class223.aClass383_2664.anInt4900 + i_10_, i_7_, i_6_ - Class223.aClass383_2664.anInt4900 * 2);
            Class336_Sub3.aClass383_8624.method4198();
            graphicstoolkit.a(Class336_Sub3.aClass383_8624, true)
               .method1192(i_9_ - -Class223.aClass383_2664.anInt4897, i_6_ + i_10_ - i_7_, i_5_ - Class223.aClass383_2664.anInt4897 * 2, i_7_);
            Class336_Sub3.aClass383_8624.method4198();
            class52.method535(
               0,
               null,
               0xFF000000 | Class359.anInt4464,
               string,
               null,
               null,
               i_8_ + i_10_,
   ...
   Class169_Sub3(GLToolkit gltoolkit, int i, int i_16_, int i_17_, int i_18_) {
      ...
      this.anInt8809 = i_17_;
      this.anInt8811 = i_18_;
      this.anInt8819 = i_16_;
      this.aGLToolkit4947.method1444(-2, this);
      OpenGL.glTexImage3Dub(
         this.anInt4951, 0, this.anInt4950, this.anInt8819, this.anInt8809, this.anInt8811, 0, Class320_Sub16.method3742(6406, this.anInt4950), 5121, null, 0
      );
   ...
   static final int method1781(byte b) {
      ++anInt8810;
      int i = Class252.aClass110_3189.method1130(b ^ -81);
      if (b != 82) {
         method1779(null, null, false, null, null, 76);
      }

      if (~i > ~(Node_Sub25_Sub4.aClass110Array10006.length - 1)) {
   ...
   static final void method1782(int i) {
      ...
      for(int i_19_ = 0; Class290_Sub11.anInt8181 > i_19_; ++i_19_) {
         int i_20_ = AnimableAnimator.method254(RenderDefinitions.anInt3300 + i_19_, 16939, Class290_Sub11.anInt8181) * Class117.anInt1479;
         ...
         for(int i_21_ = 0; Class117.anInt1479 > i_21_; ++i_21_) {
            ...
            if (~Class290_Sub4.anIntArray8102[i_22_] == ~Class225.anInt2675) {
               Class352.anInterface6Array4332[i_22_]
                  .method19(0, 0, StandardSprite.anInt8946, aa_Sub3.anInt5493, StandardSprite.anInt8946 * i_21_, aa_Sub3.anInt5493 * i_19_, true, true);
            }
         }
      }
   ...
   final void method1783(int i, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_, byte b, int i_28_) {
      if (b == 98) {
         this.aGLToolkit4947.method1444(b + -100, this);
         ++anInt8814;
         OpenGL.glCopyTexSubImage3D(this.anInt4951, 0, i_27_, i, i_24_, i_25_, i_23_, i_26_, i_28_);
         OpenGL.glFlush();
      }
   }
   ...
   public final void method5(int i) {
      ++anInt8815;
      OpenGL.glFramebufferTexture3DEXT(this.anInt8812, this.anInt8817, this.anInt4951, 0, 0, i);
      this.anInt8812 = -1;
      this.anInt8817 = -1;
   }
   ...
   Class169_Sub3(GLToolkit gltoolkit, int i, int i_29_, int i_30_, int i_31_, byte[] bs, int i_32_) {
      ...
      this.anInt8809 = i_30_;
      this.anInt8811 = i_31_;
      this.anInt8819 = i_29_;
      this.aGLToolkit4947.method1444(-2, this);
      OpenGL.glPixelStorei(3317, 1);
      OpenGL.glTexImage3Dub(this.anInt4951, 0, this.anInt4950, this.anInt8819, this.anInt8809, this.anInt8811, 0, i_32_, 5121, bs, 0);
