public class Class320_Sub7 extends Class320 {
   ...
   static final byte method3707(int i, byte b, int i_0_) {
      ...
      if (b != 125) {
         ...
         return (byte)((1 & i_0_) == 0 ? 1 : 2);
      }
   }

   final int method3708(boolean bool) {
      ++anInt8273;
      return bool ? 72 : this.anInt4064;
   }

   final boolean method3709(byte b) {
      if (b <= 63) {
         this.method3708(true);
      }

      ++anInt8274;
      return !this.aNode_Sub27_4063.method2697(-114);
   }
   ...
   final void method3673(byte b) {
      ++anInt8276;
      if (b < -35) {
         if (this.aNode_Sub27_4063.method2697(-79)) {
            this.anInt4064 = 0;
         }
   ...
   final int method3675(int i, byte b) {
      ++anInt8277;
      if (this.aNode_Sub27_4063.method2697(-96)) {
         return 3;
      } else {
         if (b != 54) {
