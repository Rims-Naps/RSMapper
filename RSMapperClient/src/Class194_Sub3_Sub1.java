...
public class Class194_Sub3_Sub1 extends Class194_Sub3 {
   ...
   static final boolean recievePacket(Class123 class123, int i) {
      ++anInt9371;
      ...
      try {
         ...
         return PacketParser.processPacketFromServer(class123, -128);
         ...
         String string = "T2 - "
            + (class123.incomming_packet == null ? -1 : class123.incomming_packet.method1953(102))
            + ","
         ...
         for(int i_0_ = 0; class123.anInt1581 > i_0_ && ~i_0_ > -51; ++i_0_) {
            string = string + class123.aPacket1570.buffer[i_0_] + ",";
         }

         ClanChat.method507(var6, string, -114);
         Class127.logout(i ^ 15678, false);
         return true;
      }
   }
   ...
   static final void method1982(int i) {
      try {
         ...
         for(Node_Sub3 node_sub3 = (Node_Sub3)Class56.aHashTable839.method1516(false);
            node_sub3 != null;
            node_sub3 = (Node_Sub3)Class56.aHashTable839.method1520(106)
         ) {
            if (node_sub3.aClass189_Sub1_6943.method1920(-89)) {
               ...
               try {
                  ...
                  ClanChat.method507(var4, "TV: " + node_sub3.anInt6947, -127);
                  Renderer.method3446(node_sub3.anInt6947, 5);
               }
         ...
         throw Class126.method1537(var5, "hfa.J(" + i + ')');
      }
   }
}
