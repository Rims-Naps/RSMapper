...
public class Class212 implements Interface8 {
   ...
   static final void method2051(int i, int i_0_, int i_1_, int i_2_, byte b, int i_3_, byte[] bs) {
      ...
      } else if (i_3_ > 0 && !Class371.method4094(i_3_, false)) {
         throw new IllegalArgumentException("");
      } else {
   ...
   static final void method2053(int i, int i_20_, int i_21_, float[] fs, int i_22_, float f, float[] fs_23_, int i_24_, int i_25_, int i_26_, int i_27_) {
      ...
      float f_32_ = (float)Math.atan2((double)f_28_, (double)f_30_) / (float) (Math.PI * 2) + 0.5F;
      float f_33_ = (float)Math.asin((double)(f_29_ / f_31_)) / (float) Math.PI + 0.5F + f;
      if (i_24_ != 1) {
         if (i_24_ == 2) {
            f_32_ = -f_32_;
            f_33_ = -f_33_;
   ...
   static final void method2054(byte b, int i, Actor actor, int i_36_, Actor actor_37_, int i_38_, int i_39_, int i_40_, int i_41_, int i_42_) {
      ...
      if (~i_43_ != 0) {
         ...
         if (b == -124) {
            ...
            if (glsprite == null) {
               Class383[] class383s = Class383.method4187(Node_Sub38_Sub39.index8, i_43_, 0);
               if (class383s == null) {
                  return;
               }
            ...
            Animable_Sub3.method919(actor.plane, actor.y, 0, actor.x, false, actor.getSize((byte)55) * 256);
