public class Class89 {
   ...
   static final void method1021(GraphicsToolkit graphicstoolkit, byte b) {
      ...
      Class262_Sub4.aClass52_7721
         .method538(Node_Sub6.anInt7043 - -i + 3, Client.anInt5481 - (-i_4_ + -14), Class22.aClass22_387.getStoredString(Class35.language), -1, 1, i_5_);
      int i_7_ = Class106.aClass93_1356.getLastMousePosX() - -i;
      int i_8_ = Class106.aClass93_1356.getLastMousePosY(true) - -i_4_;
      if (!Class194_Sub3_Sub1.aBoolean9375) {
         ...
         for(CacheNode_Sub13 cachenode_sub13 = (CacheNode_Sub13)Class368.aClass312_4549.method3613(65280);
            ...
            IComponentDefinitions.method4139(
               ...
               Class362.anInt4492,
               Class219.anInt2627,
               Client.anInt5481 + i_4_,
               i_10_,
               -256,
               cachenode_sub13,
               -1,
               i_8_,
               i + Node_Sub6.anInt7043,
               i_7_,
               -4392
            );
         }
   ...
   static final void method1022(boolean bool) {
      ...
      if (!Class26.method311(Class151.anInt1843, -5) && !Class329.method3833((byte)-61, Class151.anInt1843)) {
         ...
         if (~i <= -1 && Node_Sub54.GAME_SCENE_WDITH >> 3 > i && ~i_14_ <= -1 && Class377_Sub1.GAME_SCENE_HEIGHT >> 3 > i_14_) {
         ...
         Model.method2092(OutputStream_Sub2.anInt97, (byte)8, Class98.cameraPosX >> 12, Node_Sub10.cameraPosY >> 12);
      }
