public class Node_Sub38_Sub22 extends Node_Sub38 {
   ...
   final void method2780(boolean bool, Buffer buffer, int i) {
      if (bool) {
         this.method2780(true, null, 2);
      }

      if (~i == -1) {
         this.anInt10321 = buffer.readUnsignedShort();
      }
   ...
   final int[] method2775(int i, int i_0_) {
      ...
      if (this.aClass146_7460.aBoolean1819) {
         ...
         for(int i_4_ = 0; ~i_4_ > ~Class339_Sub7.anInt8728; ++i_4_) {
            int i_5_ = (is_3_[i_4_] - is_1_[i_4_]) * this.anInt10321;
            int i_6_ = (is_2_[i_4_ + 1 & Class303.anInt3824] + -is_2_[Class303.anInt3824 & i_4_ - 1]) * this.anInt10321;
            int i_7_ = i_6_ >> 12;
            int i_8_ = i_5_ >> 12;
