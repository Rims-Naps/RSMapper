abstract class Node_Sub36 extends Node {
   ...
   static final void method2750(boolean bool, int i, int i_0_, int i_1_) {
      ...
      if (Class175.aClass261ArrayArrayArray2099 != null
         && ~i_1_ <= -1
         && ~i_0_ <= -1
         && i_1_ < Node_Sub54.GAME_SCENE_WDITH
         && Class377_Sub1.GAME_SCENE_HEIGHT > i_0_
         && (~Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(bool) != -1 || i == Class295.myPlayer.plane)) {
         ...
         if (node_sub11 == null) {
            ...
            if (node_sub8 == null) {
               ...
               WorldItem animable_sub3_sub1 = (WorldItem)Class262_Sub22.method3211(i, i_1_, i_0_);
               if (animable_sub3_sub1 != null) {
                  animable_sub3_sub1.anInt11010 = animable_sub3_sub1.anInt11007 = -1;
               } else {
                  animable_sub3_sub1 = new WorldItem(i_1_ << 9, Class320_Sub10.aPlaneArray8300[i].getVerticeHeight(i_0_, i_1_, (byte)-118), i_0_ << 9, i, i);
               }
               ...
               label46:
               while(true) {
                  Node_Sub8 node_sub8_4_ = (Node_Sub8)node_sub11.aClass312_7104.method3620(16776960);
                  if (node_sub8_4_ == null) {
                     break;
                  }

                  if (node_sub8_4_.anInt7065 != animable_sub3_sub1.anInt10996) {
               ...
               int i_6_ = Node_Sub38_Sub7.getTileMedianHeight(i, -29754, 256 + (i_0_ << 9), (i_1_ << 9) - -256);
               animable_sub3_sub1.plane = (byte)i;
               animable_sub3_sub1.anInt5937 = i_6_;
               animable_sub3_sub1.aByte5931 = (byte)i;
               animable_sub3_sub1.y = i_0_ << 9;
               animable_sub3_sub1.anInt11019 = 0;
               animable_sub3_sub1.x = i_1_ << 9;
               if (Class238.tileHasBridgeFlag(i_0_, i_1_, 94)) {
                  animable_sub3_sub1.aByte5931 = (byte)(animable_sub3_sub1.aByte5931 + 1);
               }
   ...
   abstract void method2751(Node_Sub43 var1, int var2);
   ...
   static final void method2754(Animator animator, DrawableModel drawablemodel, Animator animator_8_, byte b) {
      if (animator.method247(29340) && animator_8_.method247(29340)) {
         ...
         drawablemodel.method615(
            animator_8_.anInt247,
            animator.aClass226_270.anInt2685,
            animator.aClass226_270.aCacheNode_Sub15_2687,
            animator_8_.aClass226_270.anInt2688,
            -65,
            animator.aClass226_270.anInt2688,
            animator_8_.aClass226_270.aCacheNode_Sub15_2687,
            animator.aClass226_270.aCacheNode_Sub15_2683,
            animator.anInt247,
            class48.aBoolean691 | class48_9_.aBoolean691,
            class48_9_.anIntArray707[animator_8_.anInt259],
            animator_8_.aClass226_270.aCacheNode_Sub15_2683,
            class48.aBooleanArray703,
            class48.anIntArray707[animator.anInt259],
            animator_8_.aClass226_270.anInt2685
         );
      }
   ...
   abstract void method2756(Buffer var1, int var2);
