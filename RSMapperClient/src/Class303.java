public class Class303 {
   ...
   static final boolean method3538(int i, int i_0_, int i_1_) {
      ...
      ++anInt3829;
      return GraphicsBuffer.method2598(2048, i_1_, i) & (Class278.method3367(i, i_1_, (byte)12) | (8192 & i_1_) != 0 | Class320_Sub9.method3713(110, i_1_, i));
   }

   final Node method3539(int i) {
      ++anInt3825;
      if (i < this.anInt3823 && this.aHashTable3822.aNodeArray1597[this.anInt3823 - 1] != this.aNode3828) {
         Node node = this.aNode3828;
         this.aNode3828 = node.aNode2800;
         return node;
      } else {
         while(~this.aHashTable3822.anInt1592 < ~this.anInt3823) {
            Node node = this.aHashTable3822.aNodeArray1597[this.anInt3823++].aNode2800;
            if (this.aHashTable3822.aNodeArray1597[this.anInt3823 + -1] != node) {
               this.aNode3828 = node.aNode2800;
               return node;
            }
         }
