   ...
   static final void method4210(byte b) {
      ...
      for(int i = 0; Class290_Sub11.anInt8181 > i; ++i) {
         ...
         for(int i_36_ = 0; i_36_ < Class117.anInt1479; ++i_36_) {
            ...
            Class352.anInterface6Array4332[i_37_]
               .method18(i_36_ * StandardSprite.anInt8946, aa_Sub3.anInt5493 * i, StandardSprite.anInt8946, aa_Sub3.anInt5493, 0, 0, true, true);
         }
      }
   }

   RuntimeException_Sub1(Throwable throwable, String string) {
      this.aThrowable4921 = throwable;
      this.aString4919 = string;
   }
}
