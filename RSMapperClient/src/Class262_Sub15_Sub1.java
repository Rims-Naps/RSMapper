public class Class262_Sub15_Sub1 extends Class262_Sub15 {
   ...
   Class262_Sub15_Sub1(Buffer buffer) {
      ...
      this.anInt10522 = i & 65535;
      this.anInt10515 = i >>> 16;
      this.anInt10518 = buffer.readUnsignedByte();
   }

   @Override
   final void method3148(int i) {
      ++anInt10516;
      int i_0_ = 256 + 512 * this.anInt10515;
      int i_1_ = 512 * this.anInt10522 - -256;
      if (i >= -102) {
         method3192(104, -83, 29);
      }

      int i_2_ = this.anInt10518;
      if (~i_2_ > -4 && Class238.tileHasBridgeFlag(this.anInt10522, this.anInt10515, -29)) {
         ++i_2_;
      }
      ...
      Mobile_Sub4 mobile_sub4 = new Mobile_Sub4(
         ...
         i_2_,
         i_0_,
         Node_Sub38_Sub7.getTileMedianHeight(this.anInt10518, -29754, i_1_, i_0_) - this.anInt7820,
         i_1_,
         this.anInt10515,
         this.anInt10515,
         this.anInt10522,
      ...
      Class20_Sub1.aHashTable5508.put((long)(this.anInt10515 << 16 | this.anInt10522), new CacheNode_Sub18(mobile_sub4), -125);
   }
   ...
   static final boolean method3192(int i, int i_3_, int i_4_) {
      ...
      return (Class320_Sub5.method3700(i, (byte)125, i_3_) | Node_Sub38_Sub26.method2877(i, i_3_, 118) | Class321.method3800(i_3_, i, 126))
         & Class85.method999(i, i_3_, (byte)-72);
   }
}
