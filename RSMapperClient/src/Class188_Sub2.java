class Class188_Sub2 extends Class188 {
   ...
   Class188_Sub2(int i, int i_44_, int i_45_, int i_46_, int i_47_, float f) {
      ...
      for(int i_48_ = 0; ~this.anInt2282 < ~i_48_; ++i_48_) {
         this.anIntArray6874[i_48_] = (short)((int)(Math.pow((double)f, (double)i_48_) * 4096.0));
      }
   }
   ...
   final void method1886(int i) {
      ...
      this.anInt6878 = Math.abs(this.anInt6878);
      ++anInt6867;
      if (~this.anInt6878 <= -4097) {
         this.anInt6878 = 4095;
      }

      this.method1905((byte)-11, this.anInt6871++, (byte)(this.anInt6878 >> 4));
      this.anInt6878 = 0;
   }
   ...
   final void method1887(int i, int i_49_, int i_50_) {
      ...
      this.anInt6878 += this.anIntArray6874[i_49_] * i >> 12;
      ++anInt6876;
   }
   ...
   void method1905(byte b, int i, byte b_51_) {
      this.aByteArray6870[this.anInt6871++] = (byte)(127 + (Node_Sub30.method2723(b_51_, 255) >> 1));
      ++anInt6872;
      if (b != -11) {
         this.method1886(33);
      }
