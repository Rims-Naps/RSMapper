public class Class246 {
   static OutgoingPacket aClass318_3103 = new OutgoingPacket(60, -1);
   static int anInt3104;
   static int anInt3105;
   static int anInt3106;
   static int[] anIntArray3107 = new int[2];
   ...
   static final void method3072(byte b) {
      ...
      if (Class270_Sub1.anInt8034 != 0 && RenderDefinitions.anInt3254 != 0) {
         Class18.aShort310 = 334;
         OutgoingPacket.aShort4053 = 334;
         Animable_Sub2_Sub2.aShort10750 = Class291.aShort3667 = (short)(512 * Class270_Sub1.anInt8034 / RenderDefinitions.anInt3254);
      }
   }
   ...
   static final void method3073(int i) {
      ...
      if (Class85.colors == null) {
         ...
         for(int i_0_ = 0; i_0_ < 65536; ++i_0_) {
            double d_1_ = 0.0078125 + (double)(i_0_ >> 10 & 63) / 64.0;
            double d_2_ = 0.0625 + (double)((i_0_ & 984) >> 7) / 8.0;
            double d_3_ = (double)(127 & i_0_) / 128.0;
            double d_4_ = d_3_;
            double d_5_ = d_3_;
            double d_6_ = d_3_;
            if (d_2_ != 0.0) {
               ...
               if (d_1_ * 6.0 < 1.0) {
                  d_5_ = d_8_ + d_1_ * 6.0 * (-d_8_ + d_7_);
               } else if (2.0 * d_1_ < 1.0) {
                  d_5_ = d_7_;
               } else if (3.0 * d_1_ >= 2.0) {
                  d_5_ = d_8_;
               } else {
                  d_5_ = (-d_8_ + d_7_) * (-d_1_ + 0.6666666666666666) * 6.0 + d_8_;
               }
