public class Class268 {
   ...
   Class268(int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, boolean bool, boolean bool_15_, int i_16_) {
      this.aShort3460 = (short)i_12_;
      this.anInt3461 = i_9_;
      this.anInt3456 = i;
      this.aShort3458 = (short)i_10_;
      this.anInt3453 = i_7_;
      this.aByte3462 = (byte)i_14_;
      this.anInt3459 = i_16_;
      this.aShort3457 = (short)i_11_;
      this.anInt3454 = i_8_;
      this.aBoolean3451 = bool_15_;
   }
}
