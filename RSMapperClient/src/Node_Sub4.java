public class Node_Sub4 extends Node {
   ...
   static final Node_Sub4 method2173(Index class302, int i, int i_0_) {
      ...
      return bs == null ? null : new Node_Sub4(new Buffer(bs));
   }

   final void method2174() {
      if (this.aHashTable6950 == null) {
         this.aHashTable6950 = new HashTable(16);
         int[] is = new int[16];
         int[] is_1_ = new int[16];
         is[9] = is_1_[9] = 128;
         Class27 class27 = new Class27(this.aByteArray6951);
         ...
         while(true) {
            ...
            while(class27.anIntArray459[i_3_] == i_4_) {
               ...
               if (i_6_ == 176) {
                  int i_7_ = i_5_ & 15;
                  int i_8_ = i_5_ >> 8 & 127;
                  int i_9_ = i_5_ >> 16 & 127;
                  if (i_8_ == 0) {
                     is[i_7_] = (is[i_7_] & -2080769) + (i_9_ << 14);
                  }

                  if (i_8_ == 32) {
                     is[i_7_] = (is[i_7_] & -16257) + (i_9_ << 7);
                  }
               }

               if (i_6_ == 192) {
                  int i_10_ = i_5_ & 15;
                  int i_11_ = i_5_ >> 8 & 127;
                  is_1_[i_10_] = is[i_10_] + i_11_;
               }

               if (i_6_ == 144) {
                  int i_12_ = i_5_ & 15;
                  int i_13_ = i_5_ >> 8 & 127;
                  int i_14_ = i_5_ >> 16 & 127;
                  if (i_14_ > 0) {
                     int i_15_ = is_1_[i_12_];
                     Node_Sub51 node_sub51 = (Node_Sub51)this.aHashTable6950.get(3512, (long)i_15_);
                     if (node_sub51 == null) {
                        node_sub51 = new Node_Sub51(new byte[128]);
                        this.aHashTable6950.put((long)i_15_, node_sub51, -123);
                     }

                     node_sub51.aByteArray7631[i_13_] = 1;
                  }
               }
   ...
   private Node_Sub4(Buffer buffer) {
      ...
      for(int i_46_ = 0; i_46_ < i_19_; ++i_46_) {
         i_45_ = i_45_ + buffer.readUnsignedByte() & 127;
         if (i_45_ == 0 || i_45_ == 32) {
            ++i_25_;
         } else if (i_45_ == 1) {
            ++i_33_;
      ...
      this.aByteArray6951 = new byte[i_17_];
      Buffer buffer_69_ = new Buffer(this.aByteArray6951);
      ...
      for(int i_77_ = 0; i_77_ < i; ++i_77_) {
         ...
         while(true) {
            ...
            int i_81_ = buffer.buffer[i_47_++] & 255;
            ...
            if (i_81_ == 23) {
               ...
               if (i_79_ == 0) {
                  ...
                  buffer_69_.writeByte(i_71_ & 127);
                  buffer_69_.writeByte(i_72_ & 127);
               } else if (i_79_ == 1) {
                  if (bool) {
                  ...
                  buffer_69_.writeByte(i_71_ & 127);
                  buffer_69_.writeByte(i_73_ & 127);
               } else if (i_79_ == 2) {
                  if (bool) {
                     buffer_69_.writeByte(176 + i_70_);
                  }

                  i_45_ = i_45_ + buffer.buffer[i_32_++] & 127;
                  ...
                  i_82_ += is[i_45_];
                  is[i_45_] = i_82_;
                  buffer_69_.writeByte(i_82_ & 127);
               } else if (i_79_ == 3) {
                  if (bool) {
                     buffer_69_.writeByte(224 + i_70_);
                  }

                  int var79 = i_74_ + buffer.buffer[i_63_++];
                  i_74_ = var79 + (buffer.buffer[i_51_++] << 7);
                  buffer_69_.writeByte(i_74_ & 127);
                  buffer_69_.writeByte(i_74_ >> 7 & 127);
               } else if (i_79_ == 4) {
                  if (bool) {
                  ...
                  buffer_69_.writeByte(i_75_ & 127);
               } else if (i_79_ == 5) {
                  if (bool) {
                  ...
                  buffer_69_.writeByte(i_71_ & 127);
                  buffer_69_.writeByte(i_76_ & 127);
               } else {
                  if (i_79_ != 6) {
                     throw new RuntimeException();
                  }
