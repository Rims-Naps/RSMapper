...
public class Node_Sub20 extends Node {
   ...
   static final GraphicsToolkit method2613(int i, int i_0_, Index class302, d var_d, java.awt.Canvas canvas) {
      ...
      } else if (!Node_Sub38_Sub2.method2793(i_0_, "jaggl")) {
         throw new RuntimeException("");
      } else {
   ...
   static final void method2614(boolean bool, Actor actor, boolean bool_1_) {
      ...
      if (~actor.anInt10904 == -1) {
         ...
         for(int i = 0; ~actor.aClass165Array10886.length < ~i; ++i) {
            if (~actor.aClass165Array10886[i].graphicsId != 0 && actor.aClass165Array10886[i].anAnimator2026.method242((byte)-77)) {
         ...
         if (bool_1_ || i_3_ - i <= 1024 && i_3_ - i >= -1024 && ~(-i_2_ + i_4_) >= -1025 && ~(i_4_ + -i_2_) <= 1023) {
            ...
            if (actor instanceof Npc) {
               bool_6_ = ((Npc)actor).definitions.aBoolean2817;
            }
            ...
            if (!bool_6_) {
               ...
               int i_7_ = -actor.aClass99_10893.anInt1281 + actor.rotation;
            ...
            if (class259.anInt3256 != -1) {
               ...
               if (actor.anInt10904 != 1) {
                  ...
                  int i_9_ = (~i_3_ <= ~actor.x ? i_3_ - actor.x : actor.x - i_3_) << 9;
                  int i_10_ = (actor.y <= i_4_ ? -actor.y + i_4_ : actor.y + -i_4_) << 9;
            ...
            if (~i_3_ == ~i && i_2_ == i_4_) {
               ...
               if (i_3_ > i) {
                  actor.x += i_5_;
                  Class320_Sub23.anInt8431 |= 4;
                  if (actor.x > i_3_) {
                     actor.x = i_3_;
                  }
               } else if (i_3_ < i) {
                  actor.x -= i_5_;
                  Class320_Sub23.anInt8431 |= 8;
                  if (i_3_ > actor.x) {
                     actor.x = i_3_;
                  }
               }
               ...
               if (~i_4_ >= ~i_2_) {
                  if (~i_4_ > ~i_2_) {
                     actor.y -= i_5_;
                     Class320_Sub23.anInt8431 |= 2;
                     if (~i_4_ < ~actor.y) {
                        actor.y = i_4_;
                     }
                  }
               } else {
                  Class320_Sub23.anInt8431 |= 1;
                  actor.y += i_5_;
                  if (~i_4_ > ~actor.y) {
                     actor.y = i_4_;
                  }
            ...
            actor.y = i_4_;
            actor.x = i_3_;
            actor.method849(actor.rotation, -72, false);
            Class320_Sub23.anInt8431 = 0;
            if (actor.anInt10900 > 0) {
               --actor.anInt10900;
            }
   ...
   Node_Sub20(String string, int i) {
      this.anIntArray7177 = new int[i];
      this.aString7174 = string;
   }

   static final void method2615(
      Class52 class52,
      String string,
      Class357 class357,
      int i,
      ...
      if (Class320_Sub22.anInt8415 == 4) {
         i_18_ = (int)Node_Sub12.cameraRotationHorizontal & 16383;
      } else {
         i_18_ = (int)Node_Sub12.cameraRotationHorizontal - -Mobile_Sub1.anInt10960 & 16383;
      }

      int i_19_ = 10 + Math.max(widget.width / 2, widget.height / 2);
      if (bool) {
      ...
      if (~(i_19_ * i_19_) <= ~i_20_) {
         ...
         if (i_23_ >= -widget.width && ~widget.width <= ~i_23_ && i_24_ >= -widget.height && ~widget.height <= ~i_24_) {
            class52.method535(
               i_16_,
               null,
               i_13_,
               ...
               var_aa,
               null,
               -i_24_ + widget.height / 2 + i_16_ + -i_14_ + -i_26_,
               0,
               101,
               i,
               1,
               widget.width / 2 + i_23_ - -i,
               0,
               0,
               i_25_,
               50
