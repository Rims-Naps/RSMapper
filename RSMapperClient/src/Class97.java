...
public class Class97 {
   ...
   static final void decodeLswp(Packet packet) {
      ...
      int myPlayerX = playerLocHash >> 14 & 16383;
      myPlayer.scenePositionXQueue[0] = myPlayerX - Node_Sub53.gameSceneBaseX;
      int myPlayerY = playerLocHash & 16383;
      myPlayer.x = (myPlayer.scenePositionXQueue[0] << 9) + (myPlayer.getSize((byte)53) << 8);
      myPlayer.scenePositionYQueue[0] = myPlayerY - Class320_Sub4.gameSceneBaseY;
      myPlayer.y = (myPlayer.scenePositionYQueue[0] << 9) + (myPlayer.getSize((byte)65) << 8);
      CacheNode_Sub20_Sub1.myPlayerPlane = myPlayer.plane = myPlayer.aByte5931 = myPlayerPlane;
      if (Class238.tileHasBridgeFlag(myPlayer.scenePositionYQueue[0], myPlayer.scenePositionXQueue[0], -77)) {
         myPlayer.aByte5931 = (byte)(myPlayer.aByte5931 + 1);
      }
      ...
      for(int playerIndex = 1; playerIndex < 2048; ++playerIndex) {
         if (myPlayerIndex != playerIndex) {
            ...
            int baseRegionX = (regionLocHash & 65394) >> 8;
      ...
      if (b >= 62) {
         if (~Class262_Sub4.anInt7722 >= ~i_23_ && za_Sub2.anInt10513 >= i_21_ && Class384.anInt4906 <= i_22_ && Node_Sub25_Sub1.anInt9936 >= i) {
            if (i_20_ == 1) {
               ...
               OverlayDefinition.method3405(i_19_, i_23_, i_21_, i, i_20_, i_22_, (byte)44);
            }
         } else if (i_20_ != 1) {
