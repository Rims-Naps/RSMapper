...
public class Class371 {
   ...
   final void method4093(String string, byte b) {
      this.method4101((byte)-114, 1 + this.anInt4576, string);
      ++anInt4577;
      if (b != -105) {
         this.method4093(null, (byte)-128);
      }
   }
   ...
   public final String toString() {
      ...
      for(int i = 0; this.anInt4576 > i; ++i) {
         if (~i != -1) {
            stringbuffer.append(", ");
         }

         stringbuffer.append(this.aStringArray4579[i]);
      }
   ...
   final String[] method4095(int i) {
      ...
      ++anInt4575;
      String[] strings = new String[1 + this.anInt4576];
      Class311.method3605(this.aStringArray4579, 0, strings, 0, 1 + this.anInt4576);
      return strings;
   }
   ...
   private final int method4098(int i, int i_5_) {
      ...
      ++anInt4582;
      int i_6_ = this.aStringArray4579.length;

      while(i_6_ <= i) {
         if (!this.aBoolean4572) {
            i_6_ += this.anInt4574;
         } else if (i_6_ != 0) {
            i_6_ *= this.anInt4574;
         } else {
   ...
   private final void method4100(int i, byte b) {
      ++anInt4584;
      String[] strings = new String[this.method4098(i, 0)];
      Class311.method3605(this.aStringArray4579, 0, strings, 0, this.aStringArray4579.length);
      this.aStringArray4579 = strings;
      if (b <= 111) {
         this.method4101((byte)-49, 86, null);
      }
   }
   ...
   private final void method4101(byte b, int i, String string) {
      ...
      if (i >= this.aStringArray4579.length) {
         this.method4100(i, (byte)119);
      }

      this.aStringArray4579[i] = string;
   }

   Class371(int i, boolean bool) {
      this.anInt4576 = -1;
      this.aBoolean4572 = false;
      this.anInt4574 = i;
      this.aBoolean4572 = bool;
   }
}
