public class Class338 {
   ...
   final void method3907(byte b) {
      synchronized(this.aClass61_4189) {
         this.aClass61_4189.method602((byte)-126);
      }

      ++anInt4194;
      synchronized(this.aClass61_4200) {
         if (b == -101) {
            this.aClass61_4200.method602((byte)-124);
         }
      }
   }
   ...
   final void method3908(int i) {
      if (i != -32478) {
         this.aClass61_4200 = null;
      }

      synchronized(this.aClass61_4189) {
         this.aClass61_4189.method608(false);
      }

      ++anInt4196;
      synchronized(this.aClass61_4200) {
         this.aClass61_4200.method608(false);
      }
   }
   ...
   final Class140 method3909(int i, int i_7_) {
      ...
      Class140 class140;
      synchronized(this.aClass61_4189) {
         class140 = (Class140)this.aClass61_4189.method607((long)i, 0);
      }
      ...
      if (class140 != null) {
         ...
         byte[] bs;
         synchronized(this.aClass302_4192) {
            bs = this.aClass302_4192.getFile(false, i, i_7_);
         }

         class140 = new Class140();
         class140.aClass338_1733 = this;
         if (bs != null) {
            class140.method1611(new Buffer(bs), i_7_ ^ -32653);
         }

         synchronized(this.aClass61_4189) {
            this.aClass61_4189.method601(class140, 25566, (long)i);
            return class140;
         }
      }
   }
   ...
   static final boolean method3911(int i, int i_8_, int i_9_) {
      ...
      return ~(i & 2048) != -1 | Class150_Sub3.method1663((byte)-21, i, i_8_) || Class110.method1135(i, i_8_, false);
   }

   final void method3912(int i, int i_10_, int i_11_) {
      ++anInt4188;
      this.aClass61_4189 = new Class61(i_11_);
      this.aClass61_4200 = new Class61(i);
      if (i_10_ <= 114) {
         method3915(null, false, false);
      }
   }

   static void method3913(String string, int i) {
      if (i > 10) {
         method3913(-2, null, 10, -28, (byte)8, 8);
      } else if (Class132.method1732(string) || !Class157.method09671().equals(string)) {
         ++Client.anInt5485;
      }
   }
   ...
   static final void method3913(int i, Node_Sub47 node_sub47, int i_12_, int i_13_, byte b, int i_14_) {
      ...
      if ((node_sub47.anInt7564 != -1 || node_sub47.anIntArray7579 != null) && b == 54) {
         ...
         if (~node_sub47.anInt7567 != -1
            && node_sub47.anInt7567 >= i_15_ + -256
            && ~Class213.aNode_Sub27_2512.aClass320_Sub25_7265.method3776(false) != -1
            && i_12_ == node_sub47.anInt7560) {
            i_15_ -= 256;
            if (i_15_ < 0) {
               i_15_ = 0;
            }
            ...
            if (~i_21_ != -1 || ~i_22_ != -1) {
               int i_23_ = -Class170.anInt2053 - (int)(Math.atan2((double)i_21_, (double)i_22_) * 2607.5945876176133) + -4096 & 16383;
               if (i_23_ > 8192) {
                  i_23_ = 16384 - i_23_;
               }
            ...
            if (node_sub47.aNode_Sub9_Sub2_7568 == null) {
               if (~node_sub47.anInt7564 <= -1) {
                  int i_25_ = node_sub47.anInt7572 == 256 && node_sub47.anInt7571 == 256
                     ? 256
                     : Class89.method1019(node_sub47.anInt7571, 26817, node_sub47.anInt7572);
                  if (node_sub47.aBoolean7580) {
                     if (node_sub47.aNode_Sub49_7581 == null) {
                        node_sub47.aNode_Sub49_7581 = Node_Sub49.method2954(Class78.index14, node_sub47.anInt7564);
                     }
                     ...
                     Class65 class65 = Class65.method714(Class148.index4, node_sub47.anInt7564, 0);
                     if (class65 != null) {
            ...
            if (node_sub47.aNode_Sub9_Sub2_7556 != null) {
               ...
               int i_26_ = node_sub47.anInt7572 == 256 && node_sub47.anInt7571 == 256
                  ? 256
                  : node_sub47.anInt7571 + (int)((double)(node_sub47.anInt7572 - node_sub47.anInt7571) * Math.random());
               if (!node_sub47.aBoolean7584) {
                  int i_27_ = (int)((double)node_sub47.anIntArray7579.length * Math.random());
                  Class65 class65 = Class65.method714(Class148.index4, node_sub47.anIntArray7579[i_27_], 0);
                  if (class65 != null) {
                     Node_Sub45_Sub1 node_sub45_sub1 = class65.method716().method2947(Class361.aClass191_4486);
                  ...
                  if (node_sub47.aNode_Sub49_7578 == null) {
                     ...
                     node_sub47.aNode_Sub49_7578 = Node_Sub49.method2954(Class78.index14, node_sub47.anIntArray7579[i_28_]);
                  }
   ...
   final void method3914(int i, int i_29_) {
      ...
      synchronized(this.aClass61_4189) {
         if (i_29_ != 34) {
            this.aClass302_4192 = null;
         }

         this.aClass61_4189.method598(i, i_29_ + -11853);
      }

      synchronized(this.aClass61_4200) {
         this.aClass61_4200.method598(i, -11819);
      }
   }
   ...
   Class338(Class353 class353, int i, Index class302, Index class302_34_) {
      this.aClass302_4193 = class302_34_;
      this.aClass302_4192 = class302;
      this.aClass302_4192.method3537(-2, 34);
   }
}
