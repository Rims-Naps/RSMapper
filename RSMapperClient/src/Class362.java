public class Class362 {
   ...
   final Class39 method4051(int i) {
      ++anInt4496;
      Class39 class39;
      synchronized(this.aClass61_4491) {
         class39 = (Class39)this.aClass61_4491.method607((long)i, 0);
      }

      if (class39 != null) {
         return class39;
      } else {
         byte[] bs = this.index17.getFile(false, ObjectDefinition.method3050(i), Class200_Sub1.method2014(i));
         class39 = new Class39();
         if (bs != null) {
            class39.method405(new Buffer(bs));
         }

         synchronized(this.aClass61_4491) {
            this.aClass61_4491.method601(class39, 25566, (long)i);
            return class39;
         }
      }
   }
   ...
   Class362(Class353 class353, int i, Index class302) {
      this.index17 = class302;
      if (this.index17 != null) {
         int i_5_ = this.index17.method3526(-20871) - 1;
         this.index17.method3537(-2, i_5_);
      }
   }
      ...
      if (~Class320_Sub20.anInt8397 == -2) {
         ...
         if (~i_9_ > ~Class117.anInt1479 && ~i_10_ <= -1 && ~i_11_ > ~Class290_Sub11.anInt8181 && ~i_12_ <= -1) {
            ...
            for(int i_14_ = i_11_; i_12_ >= i_14_; ++i_14_) {
               int i_15_ = AnimableAnimator.method254(i_14_ - -RenderDefinitions.anInt3300, 16939, Class290_Sub11.anInt8181) * Class117.anInt1479;
