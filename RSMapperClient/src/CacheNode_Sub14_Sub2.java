public class CacheNode_Sub14_Sub2 extends CacheNode_Sub14 {
   ...
   final Object method2347(int i) {
      ++anInt11035;
      return i != 27670 ? null : this.anObject11034;
   }
   ...
   static final boolean method2352(int i, int i_0_, int i_1_) {
      ...
      return Class144_Sub2.method1634(i_1_, i_0_, false) | (393216 & i_0_) != 0 || GraphicsBuffer.method2596(-1, i_0_, i_1_);
   }
   ...
   static final void method2353(byte b, Buffer buffer) {
      ...
      if (~(buffer.buffer.length - buffer.offset) <= -2) {
         ...
         if (i >= 0 && ~i >= -2) {
            ...
            if (~(buffer.buffer.length + -buffer.offset) <= -3) {
               int i_2_ = buffer.readUnsignedShort();
               if (~(6 * i_2_) >= ~(buffer.buffer.length - buffer.offset)) {
                  for(int i_3_ = 0; ~i_2_ < ~i_3_; ++i_3_) {
                     int i_4_ = buffer.readUnsignedShort();
                     int i_5_ = buffer.readInt();
                     if (~i_4_ > ~Class320_Sub22.anIntArray8417.length
                        && FileOnDisk.aBooleanArray1332[i_4_]
                        && (~Node_Sub53.aClass176_7667.method1805(i_4_, -4409).aChar3210 != -50 || i_5_ >= -1 && ~i_5_ >= -2)) {
   ...
   static final void decodePlayerMasks(Packet packet) {
      for(int i = 0; i < Node_Sub9_Sub4.DECODE_MASKS_PLAYERS_COUNT; ++i) {
         ...
         TextureDefinitions.decodePlayerMasks(-1, player, playerIndex, packet, mask);
      }
   }

   static final DrawableModel method2356(
      int i,
      ...
      if (drawablemodel == null) {
         ...
         long l = ((long)i_13_ << 48) + ((long)i_19_ << 32) + (long)i_15_ + (long)(i_16_ << 16) + (long)(i << 24);
         ...
         if (drawablemodel_21_ == null || graphicstoolkit.b(drawablemodel_21_.ua(), i_20_) != 0) {
            ...
            for(int i_33_ = 0; ~i_23_ < ~i_33_; ++i_33_) {
               ...
               short s = (short)(
                  (i_34_ * (i_13_ & 127) + i_35_ * (127 & i_19_) & 32512)
                        + ((896 & i_19_) * i_35_ + (896 & i_13_) * i_34_ & 229376)
                        + ((64512 & i_19_) * i_35_ + (64512 & i_13_) * i_34_ & 16515072)
                     >> 8
               );
               ...
               for(int i_36_ = 0; i_22_ > i_36_; ++i_36_) {
                  if (i_33_ == 0) {
                     ...
                     model.method2080(
                        bool,
                        is_25_[i_33_ + -1][i_36_],
                        is_25_[i_33_][(i_36_ + 1) % i_22_],
                        is_25_[-1 + i_33_][(1 + i_36_) % i_22_],
                        s,
                        (short)-1,
                        b,
                        (byte)1,
                     ...
                     model.method2080(
                        true, is_25_[i_33_ - 1][i_36_], is_25_[i_33_][i_36_], is_25_[i_33_][(1 + i_36_) % i_22_], s, (short)-1, b, (byte)1, (byte)-1
                     );
                  }
               }
            }
