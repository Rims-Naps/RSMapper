public class Class143 {
   static int[] anIntArray1764 = new int[32];
   ...
   static LightFX[] aLightFXArray1771;
   ...
   static final int[] method1622(int i, int i_0_, boolean bool, int i_1_, int i_2_, int i_3_, float f, int i_4_) {
      ...
      node_sub38_sub27.method2880(i_1_, is, i_1_ ^ -92);
      return is;
   }
   ...
   final boolean method1625(int i, Class143 class143_19_) {
      ...
      return class143_19_.anInt1767 == this.anInt1767 && class143_19_.anInt1776 == this.anInt1776 && ~class143_19_.anInt1769 == ~this.anInt1769;
   }
}
