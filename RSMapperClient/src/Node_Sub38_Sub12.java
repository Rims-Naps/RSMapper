public class Node_Sub38_Sub12 extends Node_Sub38 {
   ...
   final int[][] method2778(int i, boolean bool) {
      ...
      if (!bool) {
         ...
         if (this.aClass348_7454.aBoolean4300) {
            int i_0_ = this.anInt10229 - (-this.anInt10229 + -1);
            int i_1_ = 65536 / i_0_;
            int i_2_ = 1 + this.anInt10224 + this.anInt10224;
            int i_3_ = 65536 / i_2_;
            int[][][] is_4_ = new int[i_0_][][];

            for(int i_5_ = -this.anInt10229 + i; ~(i + this.anInt10229) <= ~i_5_; ++i_5_) {
               ...
               for(int i_14_ = -this.anInt10224; ~i_14_ >= ~this.anInt10224; ++i_14_) {
               ...
               int var37;
               for(int i_19_ = 0; Class339_Sub7.anInt8728 > i_19_; i_9_ += is_12_[var37]) {
                  is_16_[i_19_] = i_8_ * i_3_ >> 16;
                  is_17_[i_19_] = i_9_ * i_3_ >> 16;
                  is_18_[i_19_] = i_3_ * i_10_ >> 16;
                  int i_20_ = Class303.anInt3824 & i_19_ + -this.anInt10224;
                  ++i_19_;
                  i_9_ -= is_12_[i_20_];
                  i_10_ -= is_13_[i_20_];
                  i_8_ -= is_11_[i_20_];
                  var37 = Class303.anInt3824 & i_19_ + this.anInt10224;
                  i_8_ += is_11_[var37];
                  i_10_ += is_13_[var37];
               }

               is_4_[-i + this.anInt10229 + i_5_] = is_7_;
            }
   ...
   static final Animable_Sub2 method2830(int i, int i_30_, int i_31_) {
      ...
      return class261 == null ? null : class261.anAnimable_Sub2_3314;
   }

   @Override
   final int[] method2775(int i, int i_32_) {
      ++anInt10227;
      int[] is = this.aClass146_7460.method1645(27356, i_32_);
      if (this.aClass146_7460.aBoolean1819) {
         int i_33_ = this.anInt10229 + this.anInt10229 - -1;
         int i_34_ = 65536 / i_33_;
         int i_35_ = 1 + this.anInt10224 + this.anInt10224;
         int i_36_ = 65536 / i_35_;
         int[][] is_37_ = new int[i_33_][];

         for(int i_38_ = i_32_ + -this.anInt10229; i_32_ - -this.anInt10229 >= i_38_; ++i_38_) {
            int[] is_39_ = this.method2786(i_38_ & r_Sub2.anInt11054, 0, 0);
            int[] is_40_ = new int[Class339_Sub7.anInt8728];
            int i_41_ = 0;

            for(int i_42_ = -this.anInt10224; i_42_ <= this.anInt10224; ++i_42_) {
               i_41_ += is_39_[i_42_ & Class303.anInt3824];
            }

            for(int i_43_ = 0; i_43_ < Class339_Sub7.anInt8728; i_41_ += is_39_[++i_43_ + this.anInt10224 & Class303.anInt3824]) {
               is_40_[i_43_] = i_36_ * i_41_ >> 16;
               i_41_ -= is_39_[Class303.anInt3824 & -this.anInt10224 + i_43_];
            }

            is_37_[i_38_ + this.anInt10229 - i_32_] = is_40_;
         }
   ...
   final void method2780(boolean bool, Buffer buffer, int i) {
      if (!bool) {
         ++anInt10226;
         if (i == 0) {
            this.anInt10224 = buffer.readUnsignedByte();
            return;
         }

         if (~i == -2) {
            this.anInt10229 = buffer.readUnsignedByte();
            return;
         }
