public class Class179 {
   ...
   final void method1813(int i, EntityNode_Sub6 entitynode_sub6) {
      ...
      if (!bool) {
         if (this.aBoolean2130) {
            for(EntityNode_Sub6 entitynode_sub6_1_ = (EntityNode_Sub6)this.aClass103_2124.method1113((byte)-3);
               entitynode_sub6_1_ != null;
               entitynode_sub6_1_ = (EntityNode_Sub6)this.aClass103_2124.method1108(99)
            ) {
         ...
         for(EntityNode_Sub6 entitynode_sub6_2_ = (EntityNode_Sub6)this.aClass103_2124.method1113((byte)-117);
            entitynode_sub6_2_ != null;
            entitynode_sub6_2_ = (EntityNode_Sub6)this.aClass103_2124.method1108(94)
         ) {
         ...
         this.aClass103_2124.method1110(false, entitynode_sub6);
      }
   }
   ...
   final void method1815(byte b) {
      while(true) {
         EntityNode_Sub6 entitynode_sub6 = (EntityNode_Sub6)this.aClass103_2124.method1106(102);
