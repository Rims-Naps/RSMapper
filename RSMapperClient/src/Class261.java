public class Class261 {
   ...
   final void method3141(int i) {
      ...
      while(this.aClass256_3312 != null) {
         Class256 class256 = this.aClass256_3312.aClass256_3238;
         this.aClass256_3312.method3119(-20952);
         this.aClass256_3312 = class256;
      }
   ...
   static final int method3144(boolean bool, int i, int i_7_) {
      ...
      return ~i_7_ != -2 && i_7_ != 3 ? Class339_Sub3.anIntArray8665[3 & i] : Node_Sub15.anIntArray7129[3 & i];
   }
}
