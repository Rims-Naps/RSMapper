...
public class Class245 {
   ...
   final void method3067(int i, Interface15_Impl1 interface15_impl1, int i_0_) {
      if (i_0_ > 0) {
         this.method3068((byte)108);
         this.anAbstractToolkit3098.method1312((byte)-21, this.anInterface13_Impl1_3093);
         this.anAbstractToolkit3098
            .method1276(this.anInt3087, (byte)-108, 0, interface15_impl1, this.anInt3086 - this.anInt3087 + 1, Class55.aClass104_833, i_0_);
      }

      ++anInt3092;
      if (i <= 87) {
         this.anInterface15_Impl1_3090 = null;
      }
   }

   private final void method3068(byte b) {
      ++anInt3094;
      if (this.aBoolean3099) {
         this.aBoolean3099 = false;
         byte[] bs = this.aClass263_3088.aByteArray3343;
         int i = 0;
         int i_1_ = this.aClass263_3088.anInt3347;
         int i_2_ = this.anInt3096 + this.anInt3095 * this.aClass263_3088.anInt3347;
         ...
         if (b != 108) {
            this.aClass263_3088 = null;
         }

         if (this.anInterface13_Impl1_3093 != null && ~i == ~this.anInt3097) {
            this.aBoolean3099 = false;
         } else {
            this.anInt3097 = i;
            int i_5_ = 0;
            i_2_ = this.anInt3095 * i_1_ + this.anInt3096;
            if (!this.anAbstractToolkit3098.method1295(Node_Sub52.aClass68_7639, Class372.aClass372_4594, 1)) {
               ...
               for(int i_6_ = -128; i_6_ < 0; ++i_6_) {
                  ...
                  i_2_ += -128 + this.aClass263_3088.anInt3347;
               }

               if (this.anInterface13_Impl1_3093 == null) {
                  this.anInterface13_Impl1_3093 = this.anAbstractToolkit3098.method1258(false, 128, true, 128, Class262_Sub15_Sub1.anIntArray10523);
                  this.anInterface13_Impl1_3093.method51(false, false, false);
               } else {
                  this.anInterface13_Impl1_3093.method47(Class262_Sub15_Sub1.anIntArray10523, 0, 0, 128, 23110, 128, 0, 128);
               }
            } else {
               ...
               for(int i_10_ = -128; ~i_10_ > -1; ++i_10_) {
                  ...
                  i_2_ += this.aClass263_3088.anInt3347 - 128;
               }

               if (this.anInterface13_Impl1_3093 == null) {
                  this.anInterface13_Impl1_3093 = this.anAbstractToolkit3098
                     .method1252(128, Class201.aByteArray2442, Node_Sub52.aClass68_7639, 128, (byte)-3, false);
                  this.anInterface13_Impl1_3093.method51(false, false, false);
               } else {
                  this.anInterface13_Impl1_3093.method50(0, 128, 128, -15178, Class201.aByteArray2442, 0, Node_Sub52.aClass68_7639, 0, 128);
               }
            }
         }
      }
   ...
   static final void method3069(int i, boolean bool) {
      ...
      if (bool) {
         ...
         for(Node_Sub2 node_sub2 = (Node_Sub2)OverlayDefinition.aHashTable3630.method1516(false);
            node_sub2 != null;
            node_sub2 = (Node_Sub2)OverlayDefinition.aHashTable3630.method1520(i + 115)
         ) {
         ...
         OverlayDefinition.aHashTable3630 = new HashTable(8);
      ...
      Class295.myPlayer.y = 512 * Class377_Sub1.GAME_SCENE_HEIGHT / 2;
      Class295.myPlayer.x = 512 * Node_Sub54.GAME_SCENE_WDITH / 2;
      ...
      if (~Class320_Sub22.anInt8415 == -3) {
         Node_Sub10.cameraPosY = Node_Sub38_Sub38.anInt10490 << 9;
         Class98.cameraPosX = Renderer.anInt3663 << 9;
      } else {
   ...
   final void method3070(int i) {
      this.method3067(i + 104, this.anInterface15_Impl1_3090, this.anInt3100);
      ++anInt3089;
      if (i != -1) {
         this.anInt3086 = -86;
      }
   ...
   Class245(AbstractToolkit abstracttoolkit, Class263 class263, StandardPlane standardplane, int i, int i_13_, int i_14_, int i_15_, int i_16_) {
      this.anInt3097 = -1;
      this.anInt3095 = i_16_;
      this.anAbstractToolkit3098 = abstracttoolkit;
      this.anInt3096 = i_15_;
      this.aClass263_3088 = class263;
      int i_17_ = 1 << i_14_;
      int i_18_ = 0;
      int i_19_ = i << i_14_;
      ...
      if (~i_18_ < -1) {
         this.anInt3086 = Integer.MIN_VALUE;
         this.anInt3087 = Integer.MAX_VALUE;
         this.anInterface15_Impl1_3090 = this.anAbstractToolkit3098.method1346(false, (byte)102);
         this.anInterface15_Impl1_3090.method56(-1696, i_18_);

         for(int i_24_ = 0; i_24_ < 4; ++i_24_) {
            jaclib.memory.Buffer buffer = this.anInterface15_Impl1_3090.method54(true, (byte)99);
            if (buffer != null) {
               Stream stream = this.anAbstractToolkit3098.method1324(true, buffer);
               if (Stream.b()) {
                     ...
                     for(int i_27_ = 0; i_27_ < i_17_; ++i_27_) {
                        ...
                        if (ses != null) {
                           for(int i_28_ = 0; ses.length > i_28_; ++i_28_) {
                              int i_29_ = ses[i_28_] & '\uffff';
                              if (~i_29_ > ~this.anInt3087) {
                                 this.anInt3087 = i_29_;
                              }

                              if (this.anInt3086 < i_29_) {
                                 this.anInt3086 = i_29_;
                              }
                     ...
                     for(int i_32_ = 0; i_17_ > i_32_; ++i_32_) {
                        ...
                        if (ses != null) {
                           for(int i_33_ = 0; i_33_ < ses.length; ++i_33_) {
                              int i_34_ = ses[i_33_] & '\uffff';
                              if (~i_34_ < ~this.anInt3086) {
                                 this.anInt3086 = i_34_;
                              }

                              if (~i_34_ > ~this.anInt3087) {
                                 this.anInt3087 = i_34_;
                              }
               ...
               stream.c();
               if (this.anInterface15_Impl1_3090.method53(-3308)) {
                  break;
               }
            }
         }

         this.anInt3100 = i_18_ / 3;
      } else {
         this.anInterface13_Impl1_3093 = null;
         this.anInt3100 = 0;
      }
   }
}
