...
public class Canvas extends java.awt.Canvas {
   ...
   static int anInt71;
   static int anInt72;
   static Color[] aColorArray73 = new Color[]{new Color(16777215), new Color(16777215), new Color(16741381), new Color(16741381)};
   static int anInt74;
   private Component aComponent75;

   @Override
   public final void update(Graphics graphics) {
      this.aComponent75.update(graphics);
      ++anInt68;
   }
   ...
   public final void paint(Graphics graphics) {
      ++anInt74;
      this.aComponent75.paint(graphics);
   }
