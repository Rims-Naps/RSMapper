   ...
   public void decodeScriptsFormat(InputStream stream) {
      ...
      if (i_28_ != 0) {
         ...
         for(this.aByteArray2317 = new byte[11]; ~i_28_ != -1; i_28_ = stream.readUnsignedByte()) {
            i_29_ = -1 + (i_28_ >> 360744868);
            i_28_ = i_28_ << -456693784 | stream.readUnsignedByte();
            i_28_ &= 4095;
            if (~i_28_ != -4096) {
               this.anIntArray2449[i_29_] = i_28_;
            } else {
               this.anIntArray2449[i_29_] = -1;
            }

            this.aByteArray2317[i_29_] = (byte)stream.readByte();
            if (~this.aByteArray2317[i_29_] != -1) {
               this.aBoolean2401 = true;
            }

            this.aByteArray2417[i_29_] = (byte)stream.readByte();
         }
      }

      this.aString2391 = stream.readString();
      i_29_ = stream.readUnsignedByte();
      int i_31_ = i_29_ & 15;
      int i_33_;
      if (~i_31_ < -1) {
      ...
      i_33_ = i_29_ >> -686838332;
      int defaultHash;
      if (~i_33_ < -1) {
         defaultHash = stream.readUnsignedByte();
         this.anIntArray2315 = new int[1 + defaultHash];

         for(int i_35_ = 0; i_35_ < this.anIntArray2315.length; ++i_35_) {
            this.anIntArray2315[i_35_] = -1;
         }
   ...
   public void decodeNoscriptsFormat(InputStream stream) {
      ...
      if (~i_1_ < -1) {
         ...
         for(i_5_ = 0; ~i_1_ < ~i_5_; ++i_5_) {
            i_14_ = stream.readUnsignedShort();
            this.anIntArrayArray2327[i_5_] = new int[i_14_];

            for(i_13_ = 0; ~i_14_ < ~i_13_; ++i_13_) {
      ...
      if (~this.type == -3) {
         ...
         for(i_11_ = 0; i_11_ < 5; ++i_11_) {
            ...
            if (~string.length() < -1) {
               this.aStringArray2363[i_11_] = string;
               i_5_ |= 1 << 23 + i_11_;
            }
         }
      }
      ...
      if (~this.type == -8) {
         ...
         for(i_13_ = 0; i_13_ < 5; ++i_13_) {
            String string = stream.readString();
            if (string.length() > 0) {
               this.aStringArray2363[i_13_] = string;
               i_5_ |= 1 << i_13_ + 23;
            }
         }
      }
      ...
      if (this.anInt2324 == 2 || ~this.type == -3) {
         ...
         i_14_ = 63 & stream.readUnsignedShort();
